...
Pooling and caching parameters for the `payara-ejb-jar.xml` file are described in "xref:technical-documentation/payara-server-documentation/application-deployment/elements-of-deployment-descriptors.adoc#bean-cache[bean-cache]" in the Payara Server Application Deployment section.
...
image:ejb/set-ejb-timer-persistence.png[alt="Set EJB Persistence to Data Grid",width=600px]
...
For more information about `glassfish-ejb-jar.xml`/`payara-ejb-jar.xml`, see "xref:technical-documentation/payara-server-documentation/application-deployment/deployment-descriptor-files.adoc#the-payara-ejb-jar.xml-file[The payara-ejb-jar.xml File]" in the Payara Server Application Deployment section.
...
For more information about `payara-ejb-jar.xml`, see "xref:technical-documentation/payara-server-documentation/application-deployment/deployment-descriptor-files.adoc#the-payara-ejb-jar.xml-file[The payara-ejb-jar.xml File]" in the Payara Server Application Deployment section.
...
For further information on these elements, refer to "xref:technical-documentation/payara-server-documentation/application-deployment/deployment-descriptor-files.adoc#the-payara-ejb-jar.xml-file[The payara-ejb-jar.xml File]" in the Payara Server Application Deployment section.
