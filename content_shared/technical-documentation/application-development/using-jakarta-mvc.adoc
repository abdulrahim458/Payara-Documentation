= Using Jakarta MVC
:page-description: Use Jakarta MVC in Azul Payara — build server-side MVC web applications using the Jakarta MVC specification with Payara Server and Payara Micro.
:ordinal: 25
...
public class AppController {
    ...
    public String sayHello() {
        ...
        models.put("platform", "Jakarta EE 11 on Azul Payara Community 7");
...
public class AppController {
    ...
    public String salute() {
        ...
        salutation.setPlatform("Jakarta EE 11 on Payara 7 Community");
