...
:page-description: Develop CDI components in Azul Payara — use Jakarta Contexts and Dependency Injection with Payara-specific extensions including remote CDI events and data grid integration.
:ordinal: 4

This section lists additional available enhancements to the CDI implementation shipped in Azul Payara.
