...
For more information about this element, see "xref:technical-documentation/payara-server-documentation/application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app]" in the Payara Server Application Deployment section.
