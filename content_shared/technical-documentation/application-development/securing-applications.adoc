...
+
image:security/common-name-as-principal-name.png[alt="Common Name As Principal Name Setting",width=600px]
...
+
image:security/default-certificate-expiration-validation.png[alt="Certificate Expiration Validation Setting",width=600px]
+
IMPORTANT: After setting the value of the property, make sure that you **restart the server instance** for the changes to take effect.
