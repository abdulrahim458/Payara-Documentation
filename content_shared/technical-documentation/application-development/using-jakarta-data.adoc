= Using Jakarta Data
:page-description: Use Jakarta Data in Azul Payara — define repository interfaces for data access using the Jakarta Data API with Payara's integrated Jakarta Persistence provider.
:ordinal: 26
