...
For the full details, see the xref:../../microprofile/opentelemetry-and-opentracing.adoc#opentelemetry-and-opentracing[OpenTelemetry support] in the Payara Platform Application Development section.

[#opentracing-support]
== Opentracing Support

In-line with Payara Platform's support for xref:../../microprofile/opentracing.adoc[MicroProfile OpenTracing], there's added support for http://opentracing.io/[OpenTracing.io^] code instrumentation.
