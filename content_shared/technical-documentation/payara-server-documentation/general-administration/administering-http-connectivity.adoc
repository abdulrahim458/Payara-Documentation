...
For more information about clusters, see the xref:technical-documentation/payara-server-documentation/high-availability/index.adoc[Payara Server High Availability section].
...
Use the xref:technical-documentation/payara-server-documentation/command-reference/set.adoc[`set`] subcommand to set the value of the `session-cookie-http-only` and `session-cookie-secure` virtual server attributes.
