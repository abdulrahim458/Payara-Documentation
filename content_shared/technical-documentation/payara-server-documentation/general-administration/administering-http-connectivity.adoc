...
:page-description: Administer HTTP connectivity in Azul Payara Server — configure HTTP listeners, virtual servers, network protocols, thread pools, and SSL/TLS settings.
:ordinal: 16
...
image::http/network-listener-config.png[Configuration Page Location,width=600px]
...
. Create an HTTP network listener by using the xref:../command-reference/create-network-listener.adoc[`create-network-listener`] subcommand or the xref:../command-reference/create-http-listener.adoc[`create-http-listener`] subcommand.
...
+
Remote subcommands require a running server.
. Delete SSL from an HTTP listener by using the xref:../command-reference/delete-ssl.adoc[`delete-ssl`] subcommand.
. To apply your changes, restart Payara Server.
+
See xref:administering-domains.adoc#to-restart-a-domain[To Restart a Domain].
...
+
Remote subcommands require a running server.
. Create a protocol by using the xref:../command-reference/create-protocol.adoc[`create-protocol`]
+
...
image::http/virtual-server-config.png[Configuration Page Location,width=600px]
