...
:page-description: Administer concurrent resources in Azul Payara Server — configure ManagedExecutorService, ManagedScheduledExecutorService, and ContextService for Jakarta Concurrency.
:ordinal: 17
...
. Create a context service by using the xref:../command-reference/create-context-service.adoc[`create-context-service`] subcommand.
...
. List context service resources by using the xref:../command-reference/list-context-services.adoc[`list-context-services`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the context service resources by using the xref:../command-reference/list-context-services.adoc[`list-context-services`] subcommand.
...
. Delete the context service by using the xref:../command-reference/delete-context-service.adoc[`delete-context-service`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Create a managed thread factory by using the xref:../command-reference/create-managed-thread-factory.adoc[`create-managed-thread-factory`] subcommand.
. If necessary, notify users that the new resource has been created.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List managed thread factory resources by using the xref:../command-reference/list-managed-thread-factories.adoc[`list-managed-thread-factories`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the managed thread factory resources by using the xref:../command-reference/list-managed-thread-factories.adoc[`list-managed-thread-factories`] subcommand.
...
. Delete the managed thread factory by using the xref:../command-reference/delete-managed-thread-factory.adoc[`delete-managed-thread-factory`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Create a managed executor service by using the xref:../command-reference/create-managed-executor-service.adoc[`create-managed-executor-service`] subcommand.
. If necessary, notify users that the new resource has been created.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List managed executor service resources by using the xref:../command-reference/list-managed-executor-services.adoc[`list-managed-executor-services`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the managed executor service resources by using the xref:../command-reference/list-managed-executor-services.adoc[`list-managed-executor-services`] subcommand.
...
. Delete the managed executor service by using the xref:../command-reference/delete-managed-executor-service.adoc[`delete-managed-executor-service`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Create a managed scheduled executor service by using the xref:../command-reference/create-managed-executor-service.adoc[`create-managed-scheduled-executor-service`] subcommand.
. If necessary, notify users that the new resource has been created.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List managed scheduled executor service resources by using the xref:../command-reference/list-managed-scheduled-executor-services.adoc[`list-managed-scheduled-executor-services`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the managed scheduled executor service resources by using the xref:../command-reference/list-managed-scheduled-executor-services.adoc[`list-managed-scheduled-executor-services`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the managed scheduled executor service resources by using the xref:../command-reference/list-managed-scheduled-executor-services.adoc[`list-managed-scheduled-executor-service`] subcommand.
. If necessary, notify users that the managed scheduled executor service is being deleted.
. Delete the managed scheduled executor service by using the xref:../command-reference/delete-managed-scheduled-executor-service.adoc[`delete-managed-scheduled-executor-service`]
subcommand.
