...
image:notification-service/log/log-admin-console-configuration.png[alt="Log Notifier Configuration",width=600px]
...
+
image:notification-service/jms/prepare-jms-destination.png[alt="Create JMS Queue",width=600px]
+
...
+
image:notification-service/jms/jms-admin-console-configuration.png[alt="Configure JMS Notifier in Admin Console",width=600px]
+
...
image:notification-service/event-bus/event-bus-admin-console-configuration.png[alt="Event Bus Configuration",width=600px]
...
image:notification-service/cdi-event-bus/cdi-event-bus-notif-config.png[alt="CDI Event Bus Configuration",width=600px]
...
IMPORTANT: For an application to use the `Inbound` annotation and `EventbusMessage` class, it will have to define the xref:technical-documentation/public-api/index.adoc[Payara Public API] as a project dependency.
...
image:jmx-monitoring-service/jmx-log-frequency.png[alt="JMX Log Frequency",width=600px]
...
image:jmx-monitoring-service/jmx-add-notifiers.png[alt="Add JMX Notifiers",width=600px]
