...
----
[2013-04-12T08:08:30.154-0700] [Payara Server {version}] [INFO] [AS-WEB-GLUE-00172] [jakarta.enterprise.web] [tid: _ThreadID=217 _ThreadName=admin-listener(21)]
...
* ProductName-Version represents the current version of Payara Server. For example: `Payara Server {version}`
...
[source, log, subs=attributes+]
----
[#|2013-04-18T09:27:44.315-0700|INFO|Payara Server {version}|jakarta.enterprise.web.core| _ThreadID=15;_ThreadName=RunLevelControllerThread-1366302462682;_TimeMillis=1366302464315;_LevelValue=800;_MessageID=AS-WEB-CORE-00306;| Setting JAAS app name glassfish-web|#]
----
