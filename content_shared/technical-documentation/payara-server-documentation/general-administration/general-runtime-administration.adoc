...
For more information, see xref:general-runtime-administration.adoc#to-start-a-multimode-session[To Start a Multimode Session].
...
This example runs the xref:technical-documentation/payara-server-documentation/command-reference/list-applications.adoc[`list-applications`] subcommand in single mode.
...
This help information is also available in the xref:../command-reference/asadmin.adoc[Payara Server Command Reference Manual].
...
To display the available subcommands, use the xref:../command-reference/list-commands.adoc[`list-commands`] subcommand. Local subcommands are displayed before remote subcommands. If the server is not running, only local subcommands are displayed.
...
* Use the xref:technical-documentation/payara-server-documentation/command-reference/multimode.adoc[`multimode`] subcommand.
...
. Run the xref:../command-reference/multimode.adoc[`multimode`] subcommand, specifying the file that you created.
+
...
* xref:../command-reference/delete-domain.adoc[`delete-domain`]
* xref:../command-reference/list-commands.adoc[`list-commands`]
* xref:../command-reference/multimode.adoc[`multimode`]
...
* xref:../command-reference/attach.adoc[`attach`]
* xref:../command-reference/configure-managed-jobs.adoc[`configure-managed-jobs`]
* xref:../command-reference/list-jobs.adoc[`list-jobs`]
...
. Create system properties by using the xref:technical-documentation/payara-server-documentation/command-reference/create-system-properties.adoc[`create-system-properties`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List system properties by using the xref:technical-documentation/payara-server-documentation/command-reference/list-system-properties.adoc[`list-system-properties`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the existing system properties by using the xref:technical-documentation/payara-server-documentation/command-reference/list-system-properties.adoc[`list-system-properties`] subcommand.
. Delete the system property by using the xref:technical-documentation/payara-server-documentation/command-reference/delete-system-property.adoc[`delete-system-property`] subcommand.
...
This option specifies whether scanning for Jakarta Faces content during application deployment is enabled. When enabled, if Faces content is detected, it forces an attempt to initialise CDI and Weld, even if bean discovery is set to "none".
+
A similar property can be set as a property `deploy` command. See xref:../command-reference/deploy.adoc#deploy[deploy] for details.
+
...
*`fish.payara.ready-after-applications`*:
This option determines when the server is marked as "ready".
+
When enabled: The server is marked as ready after all post-boot configuration has been applied and all previously deployed applications have been loaded.
+
When disabled: the server is marked as ready after all `InstanceLifecycleListener` components and services have processed the `server_startup` event, but before post-boot configuration is applied and previously deployed applications are loaded.
+
Defaults to `true`.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Add the default configuration of a module to `domain.xml` by using xref:technical-documentation/payara-server-documentation/command-reference/create-jdbc-resource.adoc[`create-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Remove the configuration of a module from `domain.xml` by using the xref:technical-documentation/payara-server-documentation/command-reference/create-jdbc-resource.adoc[`delete-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Display the current active configuration of a module by using the xref:technical-documentation/payara-server-documentation/command-reference/create-jdbc-resource.adoc[`get-active-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Add resources from an XML file by using the xref:technical-documentation/payara-server-documentation/command-reference/add-resources.adoc[`add-resources`] subcommand. Information about properties for the subcommand is included in this help page.
. Restart Payara Server. See xref:administering-domains.adoc#to-restart-a-domain[To Restart a Domain].
...
. Ensure that the server is running. Remote subcommands require a running server.
. Display the version by using the xref:technical-documentation/payara-server-documentation/command-reference/version.adoc[`version`] subcommand.
...
----
asadmin> version
Version = Payara Server {release-id} #badassfish (build 00)
...
. Ensure that the server is running. Remote subcommands require a running server.
. List applications by using the xref:technical-documentation/payara-server-documentation/command-reference/list-applications.adoc[`list-applications`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List containers by using the xref:technical-documentation/payara-server-documentation/command-reference/list-containers.adoc[`list-containers`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List modules by using the xref:technical-documentation/payara-server-documentation/command-reference/list-modules.adoc[`list-modules`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List subcommands by using the xref:technical-documentation/payara-server-documentation/command-reference/list-commands.adoc[`list-commands`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List timers by using the xref:technical-documentation/payara-server-documentation/command-reference/list-timers.adoc[`list-timers`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Show component status by using the xref:technical-documentation/payara-server-documentation/command-reference/show-component-status.adoc[`show-component-status`] subcommand.
