...
:page-description: General runtime administration of Azul Payara Server — starting, stopping, and restarting the server, managing the DAS, and common runtime configuration tasks.
:ordinal: 1
...
This example runs the xref:../command-reference/list-applications.adoc[`list-applications`] subcommand in single mode.
...
* Use the xref:../command-reference/multimode.adoc[`multimode`] subcommand.
...
. Create system properties by using the xref:../command-reference/create-system-properties.adoc[`create-system-properties`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List system properties by using the xref:../command-reference/list-system-properties.adoc[`list-system-properties`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the existing system properties by using the xref:../command-reference/list-system-properties.adoc[`list-system-properties`] subcommand.
. Delete the system property by using the xref:../command-reference/delete-system-property.adoc[`delete-system-property`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Add the default configuration of a module to `domain.xml` by using xref:../command-reference/create-jdbc-resource.adoc[`create-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Remove the configuration of a module from `domain.xml` by using the xref:../command-reference/create-jdbc-resource.adoc[`delete-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Display the current active configuration of a module by using the xref:../command-reference/create-jdbc-resource.adoc[`get-active-module-config`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Add resources from an XML file by using the xref:../command-reference/add-resources.adoc[`add-resources`] subcommand. Information about properties for the subcommand is included in this help page.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Display the version by using the xref:../command-reference/version.adoc[`version`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List applications by using the xref:../command-reference/list-applications.adoc[`list-applications`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List containers by using the xref:../command-reference/list-containers.adoc[`list-containers`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List modules by using the xref:../command-reference/list-modules.adoc[`list-modules`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List subcommands by using the xref:../command-reference/list-commands.adoc[`list-commands`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List timers by using the xref:../command-reference/list-timers.adoc[`list-timers`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Show component status by using the xref:../command-reference/show-component-status.adoc[`show-component-status`] subcommand.
