...
xref:technical-documentation/payara-server-documentation/general-administration/index.adoc#configuration-changes-that-require-restart[Configuration Changes That Require Restart].
...
image:connection-pools/connection_pools_1.png[alt="New JDBC Connection Pool",width=600px]
...
image:connection-pools/connection_pools_2.png[alt="Connection pool properties",width=600px]
...
image:connection-pools/connection_pools_3.png[alt="Connection Pool sizes in the admin console",width=600px]
...
image:connection-pools/connection_pools_4.png[alt="Connection validation configuration in Admin console",width=600px]
...
image:connection-pools/connection_pools_5.png[alt="Leak Detection setting in Admin console",width=600px]
...
image:advanced-jdbc/logjdbccall.png[alt="Enabling SQL Tracing in the administration console",width=600px]
...
image:advanced-jdbc/activate-sql-statements.png[alt="Activate JDBC Connection pool monitoring with administration console",width=600px]
...
image:advanced-jdbc/slowsqllogging.png[alt="Slow SQL Logging settings in the administration console",width=600px]
...
image:advanced-jdbc/sqltracelistener.png[alt="Enabling SQL Tracing in the administration console",width=600px]
