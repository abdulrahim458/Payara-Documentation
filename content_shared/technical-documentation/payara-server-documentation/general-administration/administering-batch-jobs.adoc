...
:page-description: Administer batch jobs in Azul Payara Server — manage Jakarta Batch job executions, monitor job status, and configure the batch runtime using asadmin commands.
:ordinal: 13
...
. List batch jobs by using the xref:../command-reference/list-jdbc-resources.adoc[list-batch-jobs] subcommand.
...
. List batch job executions by using the xref:../command-reference/list-batch-job-executions.adoc[list-batch-job-executions] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Display the configuration of the batch runtime by using the xref:../command-reference/list-batch-runtime-configuration.adoc[list-batch-runtime-configuration] subcommand.
...
.  Ensure that the server is running. +
Remote subcommands require a running server.
.  Configure the batch runtime by using the xref:../command-reference/set-batch-runtime-configuration.adoc[set-batch-runtime-configuration] subcommand.
