...
MicroProfile Configuration variables must be declared in one of the Payara Platform xref:../../microprofile/config/index.adoc#config-sources[supported configuration sources].
