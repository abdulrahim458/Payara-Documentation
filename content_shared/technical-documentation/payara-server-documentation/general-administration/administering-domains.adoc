...
"xref:../high-availability/administering-payara-server-instances.adoc#administering-payara-server-instances[Administering Payara Server Instances]" in
...
For more information about virtual servers, see xref:administering-http-connectivity.adoc#administering-virtual-servers[Administering Virtual Servers].
...
see xref:../security-guide/administering-system-security.adoc#to-change-an-administration-password[To Change an Administration Password] in Payara Server Security Guide.
...
For more information, see xref:administering-domains.adoc#to-create-a-domain[To Create a Domain].
...
* xref:administering-domains.adoc#to-create-a-domain[`To Create a Domain`]
...
asadmin list-domains
----
. Log in to the domain by using the xref:subcommands-for-the-asadmin-cli.adoc#domain-subcommands[`login`] command.
...
information about passwords, see xref:../security-guide/administering-system-security.adoc#administering-passwords[Administering Passwords] in Payara Server Security Guide.
...
If needed, see xref:administering-domains.adoc#to-stop-a-domain[To Stop a Domain].
...
xref:administering-domains.adoc#to-list-domains[To List Domains]. +
...
as described in xref:administering-domains.adoc#to-stop-a-domain[To Stop a Domain].
...
xref:administering-domains.adoc#to-back-up-a-domain[To Back Up a Domain]. You can automatically maintain a
...
xref:administering-domains.adoc#to-migrate-the-das[To Migrate the DAS].
...
See xref:../high-availability/enabling-centralized-administration-of-server-instances.adoc#enabling-centralized-administration-of-payara-server-instances[Enabling Centralized Administration of Payara Server Instances] in the Payara Server High Availability section for instructions.
