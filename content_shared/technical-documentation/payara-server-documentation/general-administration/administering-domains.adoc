...
You can verify that a name is not already in use by using the xref:technical-documentation/payara-server-documentation/command-reference/list-domains.adoc[`list-domains`] subcommand
. Create a domain by using the xref:technical-documentation/payara-server-documentation/command-reference/create-domain.adoc[`create-domain`] subcommand. +
...
xref:technical-documentation/payara-server-documentation/command-reference/create-domain.adoc[`create-domain`] subcommand.
. Before starting the domain, verify that the domain's `domain.xml` file is valid. +
Use the xref:technical-documentation/payara-server-documentation/command-reference/verify-domain-xml.adoc[`verify-domain-xml`] subcommand for this purpose. +
...
List domains by using the xref:technical-documentation/payara-server-documentation/command-reference/list-domains.adoc[`list-domains`] subcommand.
...
. Delete the domain by using the xref:technical-documentation/payara-server-documentation/command-reference/delete-domain.adoc[`delete-domain`] subcommand.
...
Start a domain by using the xref:technical-documentation/payara-server-documentation/command-reference/start-domain.adoc[`start-domain`] subcommand.
...
server. For more controlled situations, you can use the xref:technical-documentation/payara-server-documentation/command-reference/restart-domain.adoc[`restart-domain`] subcommand.


. If necessary, notify users that you are going to stop the domain.
. Stop the domain by using the xref:technical-documentation/payara-server-documentation/command-reference/stop-domain.adoc[`stop-domain`] subcommand.
...
If the server will not restart, use the xref:technical-documentation/payara-server-documentation/command-reference/stop-domain.adoc[`stop-domain`]
subcommand followed by the xref:technical-documentation/payara-server-documentation/command-reference/start-domain.adoc[`start-domain`] subcommand.

. Ensure that the server is running. +
Remote subcommands require a running server.
. Restart the domain by using the xref:technical-documentation/payara-server-documentation/command-reference/restart-domain.adoc[`restart-domain`] subcommand.
...
. Create the service by using the xref:technical-documentation/payara-server-documentation/command-reference/create-service.adoc[`create-service`] subcommand.
...
Use the xref:technical-documentation/payara-server-documentation/command-reference/create-jvm-options.adoc[`create-jvm-options`] subcommand for this purpose.
+
[source,shell]
----
...
. Back up the domain by using the xref:technical-documentation/payara-server-documentation/command-reference/backup-domain.adoc[`backup-domain`] subcommand.
...
To determine whether the domain is running, use the xref:technical-documentation/payara-server-documentation/command-reference/list-domains.adoc[`list-domains`] subcommand, as described in
xref:administering-domains.adoc#to-list-domains[To List Domains]. +
To stop the domain, use the xref:technical-documentation/payara-server-documentation/command-reference/stop-domain.adoc[`stop-domain`] subcommand
as described in xref:administering-domains.adoc#to-stop-a-domain[To Stop a Domain].
. Restore backup files for a domain by using the xref:technical-documentation/payara-server-documentation/command-reference/restore-domain.adoc[`restore-domain`] subcommand.
...
NOTE: You must maintain a backup of the DAS from the first host using the xref:technical-documentation/payara-server-documentation/command-reference/backup-domain.adoc[`backup-domain`] subcommand as described in
...
. Start the domain on `newdashost` by using the xref:technical-documentation/payara-server-documentation/command-reference/start-domain.adoc[`start-domain`] subcommand. +
For example:
+
[source,shell]
----
...
. Ensure that the server is running. +
Remote subcommands require a running server.
. Display uptime by using the xref:technical-documentation/payara-server-documentation/command-reference/uptime.adoc[`uptime`] subcommand.
...
xref:technical-documentation/payara-server-documentation/command-reference/create-domain.adoc[`create-domain`] subcommand when the domain is created.
...
Use the xref:technical-documentation/payara-server-documentation/command-reference/set.adoc[`set`] subcommand for this purpose.
+
[source,shell]
----
$ asadmin set
...
behavior of the domain, see the xref:technical-documentation/payara-server-documentation/command-reference/stop-domain.adoc[`stop-domain`] help page.
...
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for controlling the
behavior of the domain, see the xref:technical-documentation/payara-server-documentation/command-reference/start-domain.adoc[`start-domain`] help page.
