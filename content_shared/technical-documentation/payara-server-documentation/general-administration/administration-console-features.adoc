...
image:recorder/recorder-config.png[alt="Asadmin Recorder configuration",width=600px]
...
image:admin-console/environment-warning.png[alt="Payara Server Environment Warning",width=600px]
