...
:page-description: Azul Payara Server Administration Console — web-based GUI for managing domains, clusters, deployed applications, JDBC resources, and server configuration.
:ordinal: 4
...
* xref:../command-reference/enable-asadmin-recorder.adoc#enable-asadmin-recorder[`enable-asadmin-recorder`]
* xref:../command-reference/disable-asadmin-recorder.adoc#disable-asadmin-recorder[`disable-asadmin-recorder`]
* xref:../command-reference/set-asadmin-recorder-configuration.adoc#set-asadmin-recorder-configuration[`set-asadmin-recorder-configuration`]
...
image:recorder/recorder-config.png[alt="Asadmin Recorder configuration",width=100%]
...
In addition to using the admin console, you can configure the asadmin recorder service using the `set-asadmin-recorder-configuration` command. See xref:../command-reference/set-asadmin-recorder-configuration.adoc#set-asadmin-recorder-configuration[`set-asadmin-recorder-configuration`]

[#running-the-generated-scripts]
=== Running the Generated Scripts

Documentation on running asadmin scripts can be found in xref:general-runtime-administration.adoc#to-run-a-set-of-asadmin-subcommands-from-a-file[this section].
...
* xref:../command-reference/get-asadmin-recorder-configuration.adoc#get-asadmin-recorder-configuration[`get-asadmin-recorder-configuration`]
* xref:../command-reference/set-asadmin-recorder-configuration.adoc#set-asadmin-recorder-configuration[`set-asadmin-recorder-configuration`]
* xref:../command-reference/enable-asadmin-recorder.adoc#enable-asadmin-recorder[`enable-asadmin-recorder`]
* xref:../command-reference/disable-asadmin-recorder.adoc#disable-asadmin-recorder[`disable-asadmin-recorder`]
* xref:../command-reference/asadmin-recorder-enabled.adoc#asadmin-recorder-enabled[`asadmin-recorder-enabled`]
...
The auditing service will relay these events to the xref:administering-the-notification-service.adoc[Notification Service]. In this manner, administrators can be alerted of suspicious activity as soon as possible.
...
image:admin-console/admin-audit-menu.png[alt="Admin Audit Service in Web Console",width=600px]

Once enabled, actions in the admin console that have a corresponding `asadmin` command will be sent to the xref:administering-the-notification-service.adoc[Notification service].
...
image:request-tracing/select-notifiers.png[alt="Activate Notifiers in the Admin Console",width=600px]
...
* xref:../command-reference/set-admin-audit-configuration.adoc#set-admin-audit-configuration[`set-admin-audit-configuration`]
* xref:../command-reference/get-admin-audit-configuration.adoc#get-admin-audit-configuration[`get-admin-audit-configuration`]
...
image:admin-console/environment-warning.png[alt="Payara Server Environment Warning",width=100%]
...
* xref:../command-reference/set-environment-warning-configuration.adoc#set-environment-warning-configuration[`set-environment-warning-configuration`]
* xref:../command-reference/get-environment-warning-configuration.adoc#get-environment-warning-configuration[`get-environment-warning-configuration`]
