...
:page-description: Administer JNDI in Azul Payara Server — configure the Java Naming and Directory Interface service, custom resources, and JNDI bindings for Jakarta EE applications.
:ordinal: 21
...
. Create a custom resource by using the xref:../command-reference/create-custom-resource.adoc[`create-custom-resource`] subcommand. +
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the custom resources by using the xref:../command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
...
. List the custom resources by using the xref:../command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
. Use the xref:../command-reference/set.adoc[`set`] subcommand to modify a custom JNDI resource.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the custom resources by using the xref:../command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
. Delete a custom resource by using the xref:../command-reference/delete-custom-resource.adoc[`delete-custom-resource`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Register an external JNDI resource by using the xref:../command-reference/create-jndi-resource.adoc[`create-jndi-resource`] subcommand. +
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the existing JNDI resources by using the xref:../command-reference/list-jndi-resources.adoc#list-jndi-resources[`list-jndi-resources`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the JNDI entries for a configuration by using the xref:../command-reference/list-jndi-entries.adoc[`list-jndi-entries`] subcommand.
...
. List the existing JNDI resources by using the xref:../command-reference/list-jndi-resources.adoc#list-jndi-resources[`list-jndi-resources`] subcommand.
. Use the xref:../command-reference/set.adoc[`set`] subcommand to modify an external JNDI resource.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Remove an external JNDI entry by using the xref:../command-reference/delete-jndi-resource.adoc[`delete-jndi-resource`] subcommand.
