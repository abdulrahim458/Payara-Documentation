...
* xref:technical-documentation/payara-server-documentation/general-administration/administering-the-jndi-service.adoc#administering-custom-jndi-resources[Administering Custom JNDI Resources]
* xref:technical-documentation/payara-server-documentation/general-administration/administering-the-jndi-service.adoc#administering-external-jndi-resources[Administering External JNDI Resources]
...
. Create a custom resource by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/create-custom-resource.adoc[`create-custom-resource`] subcommand. +
Information on properties for the subcommand is contained in this help page. Restart Payara Server. See xref:technical-documentation/payara-server-documentation/general-administration/administering-domains.adoc#to-restart-a-domain[To Restart a Domain].
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the custom resources by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
...
. List the custom resources by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
. Use the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/set.adoc[`set`] subcommand to modify a custom JNDI resource.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the custom resources by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-custom-resources.adoc[`list-custom-resources`] subcommand.
. Delete a custom resource by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/delete-custom-resource.adoc[`delete-custom-resource`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Register an external JNDI resource by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/create-jndi-resource.adoc[`create-jndi-resource`] subcommand. +
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the existing JNDI resources by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-jndi-resources.adoc#list-jndi-resources[`list-jndi-resources`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the JNDI entries for a configuration by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-jndi-entries.adoc[`list-jndi-entries`] subcommand.
...
. List the existing JNDI resources by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/list-jndi-resources.adoc#list-jndi-resources[`list-jndi-resources`] subcommand.
. Use the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/set.adoc[`set`] subcommand to modify an external JNDI resource.
...
. Ensure that the server is running. Remote subcommands require a running server.
. Remove an external JNDI entry by using the xref:ROOT:technical-documentation/payara-server-documentation/command-reference/delete-jndi-resource.adoc[`delete-jndi-resource`] subcommand.
