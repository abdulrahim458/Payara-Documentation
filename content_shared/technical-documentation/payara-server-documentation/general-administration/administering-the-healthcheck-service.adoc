...
image:healthcheck/admin-console-configuration.png[alt="HealthCheck Configuration in the Admin Console",width=600px]
...
image:healthcheck/cpu-usage-checker-configuration.png[alt="CPU Usage Checker Configuration in the Admin Console",width=600px]
...
image:healthcheck/hogging-threads-checker-configuration.png[alt="Hogging Threads Checker Configuration in the Admin Console",width=600px]
...
image:healthcheck/stuck-threads-checker-configuration.png[alt="Stuck Threads Checker Configuration in the Admin Console",width=600px]
