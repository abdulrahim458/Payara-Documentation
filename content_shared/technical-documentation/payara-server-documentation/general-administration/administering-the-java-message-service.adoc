...
* *`type`*: The JMS host type the service is to use. Available choices are `EMBEDDED`, `LOCAL` and `REMOTE`. See xref:technical-documentation/payara-server-documentation/general-administration/administering-the-java-message-service.adoc#about-jms-host-types[About JMS Host Types] for more information.
...
Some properties require server restart. See xref:technical-documentation/payara-server-documentation/general-administration/index.adoc[Configuration Changes That Require Restart]. If your server needs to be restarted, see xref:technical-documentation/payara-server-documentation/general-administration/administering-domains.adoc#to-restart-a-domain[To Restart a Domain].
...
image:administration/activemq-1.png[alt="ActiveMQ Console",width=600px]
...
image:administration/activemq-2.png[alt="Payara Admin Console - JMS Connector Connection Pool 1",width=600px]

image:administration/activemq-3.png[alt="Payara Admin Console - JMS Connector Connection Pool 2",width=600px]
...
image:administration/activemq-4.png[alt="Payara Admin Console - JMS Connector Resource",width=600px]
...
image:administration/activemq-5.png[alt="Payara Admin Console - JMS mapping",width=600px]
...
image:administration/activemq-6.png[alt="ActiveMQ Console - Consumer",width=600px]

We can test the MDB by sending a message using the ActiveMQ console.

image:administration/activemq-7.png[alt="ActiveMQ Console - Sending a message",width=600px]

Once you have sent the message we can check the server log, the message will be printed out:

image:administration/activemq-8.png[alt="Payara Server Log",width=600px]
