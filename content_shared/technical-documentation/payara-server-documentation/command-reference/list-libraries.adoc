...
*`--type`*:
  ...
  `war`;;
    Lists the library files for the war-packaged class loader directory, `domain-dir/lib/warlibs` +
  For more information about these directories, see xref:../../application-development/class-loaders.adoc#classloading[Class Loaders] in the Payara Server Application section.
