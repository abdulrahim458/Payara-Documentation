...
* xref:restart-domains.adoc#restart-domains[`restart-domains`],
* xref:start-domain.adoc#start-domain[`start-domain`],
* xref:start-domains.adoc#start-domains[`start-domains`],
* xref:stop-domains.adoc#stop-domains[`stop-domains`],
* xref:stop-all-domains.adoc#stop-all-domains[`stop-all-domains`]
