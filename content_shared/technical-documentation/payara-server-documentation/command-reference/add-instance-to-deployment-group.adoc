...
This command will only work with standalone instances (see xref:../high-availability/administering-payara-server-instances.adoc#types-of-payara-server-instances[here] for more information).
