...
The default value is `true`.
  ...
  `securePagesWithPragma`;;
    ...
    Internet Explorer. +
    You can set this property for a specific web application. For details, see xref:../application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app] in Payara Server Application Deployment section.
  `contextXmlDefault`;;
    ...
    about the `context.xml` file, see xref:../../application-development/developing-web-applications.adoc#using-a-context.xml-file[Using a context.xml File] in the Payara Server Application Development section and The Context Container (`http://tomcat.apache.org/tomcat-5.5-doc/config/context.html`).
...
You can set this property for a specific web application. For
    details, see xref:../application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app] in Payara Server Application Deployment section.
