...
*`--property`*:
  ...
  `allowLinking`;;
    ...
    setting by using the property `allowLinking` under the `payara-web-app` element in the `payara-web.xml` file:
+
[source,xml]
----
<payara-web-app>
...
IMPORTANT: sun-web.xml is deprecated and support will be removed in a future release.
...
The default value is `true`.
  ...
  `securePagesWithPragma`;;
    ...
    Internet Explorer. +
    You can set this property for a specific web application. For details, see xref:technical-documentation/payara-server-documentation/application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app] in Payara Server Application Deployment section.
  `contextXmlDefault`;;
    ...
    about the `context.xml` file, see xref:technical-documentation/application-development/developing-web-applications.adoc#using-a-context.xml-file[Using a context.xml File] in the Payara Server Application Development section and The Context Container (`http://tomcat.apache.org/tomcat-5.5-doc/config/context.html`).
...
You can set this property for a specific web application. For
    details, see xref:technical-documentation/payara-server-documentation/application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app] in Payara Server Application Deployment section.
...
You can set this property for a specific web application. For  details, see xref:technical-documentation/payara-server-documentation/application-deployment/elements-of-deployment-descriptors.adoc#payara-web-app[payara-web-app] in Payara Server Application Deployment section.
  ...
  `cacheTTL`;;
    Specifies the time to live (TTL), in milliseconds, for the virtual server cache used when serving files. Defaults to 5000.
*`--target`*:
...
* xref:technical-documentation/payara-server-documentation/command-reference/delete-virtual-server.adoc#delete-virtual-server[`delete-virtual-server`],
