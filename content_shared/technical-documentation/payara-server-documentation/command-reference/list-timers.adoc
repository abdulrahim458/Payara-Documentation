...
* xref:migrate-timers.adoc#migrate-timers[`migrate-timers`]
...
* xref:../../application-development/using-jakarta-enterprise-beans-technology.adoc#ejb-timer-service[EJB Timer Service] in the Payara Server Application Development section
