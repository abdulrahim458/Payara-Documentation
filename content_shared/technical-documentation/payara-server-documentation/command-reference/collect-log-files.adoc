...
Created Zip file under /space/gfv3/v3setup/payara7/glassfish/domains/domain1/\
...
* xref:../general-administration/administering-the-logging-service.adoc[Administering the Logging Service] in Payara Server General Administration section
