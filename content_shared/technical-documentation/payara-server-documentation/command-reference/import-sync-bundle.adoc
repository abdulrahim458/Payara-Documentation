...
This example imports the configuration for the clustered instance `ymli2` on the node `sj02` from the archive file `/export/payara7/glassfish/domains/domain1/sync/ymlcluster-sync-bundle.zip`.
...
/export/payara7/glassfish/domains/domain1/sync/ymlcluster-sync-bundle.zip
