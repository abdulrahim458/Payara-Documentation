...
*`--droptables`*:
  ...
  determines whether or not tables are dropped. Default value is true. This parameter is deprecated and will be removed in Payara 7.
*`--target`*:
...
*name*:
  ...
  application versions, see xref:technical-documentation/payara-server-documentation/application-deployment/index.adoc#module-and-application-versions[Module and Application
