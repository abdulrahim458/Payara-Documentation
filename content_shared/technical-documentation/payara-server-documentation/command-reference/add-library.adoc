...
xref:../../application-development/class-loaders.adoc#class-loaders[Class Loaders] in the Payara Server Application Development section.
...
* xref:../../application-development/class-loaders.adoc[Class Loaders]
