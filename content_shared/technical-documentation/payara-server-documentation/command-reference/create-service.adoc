...
Server Directory: C:\payara7\glassfish\domains\domain1
Configuration file for Windows Services Wrapper: C:\payara7\glassfish\domains\domain1\bin\domain1Service.xml
The service can be controlled using the Windows Services Manager or you can use the
Windows Services Wrapper instead:
Start Command:  C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe  start
Stop Command:   C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe  stop
Restart Command:  C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe  restart
Uninstall Command:  C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe  uninstall
Install Command:  C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe  install
Status Command: C:\payara7\glassfish\domains\domain1\bin\domain1Service.exe status
...
For your convenience this message has also been saved to this file: C:\payara7\glassfish\domains\domain1\PlatformServices.log
...
* xref:delete-service.adoc#_delete-service[`_delete-service`],
