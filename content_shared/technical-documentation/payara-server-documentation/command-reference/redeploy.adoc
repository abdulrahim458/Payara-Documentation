...
*`--name`*:
  ...
  (`.`) characters. For more information about module and application versions, see xref:../application-deployment/index.adoc#module-and-application-versions[Module and Application Versions] in
...
*`--properties` or `--property`*:
  ...
  about usage, see the related example in the xref:deploy.adoc#deploy[`deploy`] help page.
