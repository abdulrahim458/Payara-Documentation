...
If the subcommand specifies an option that already exists, the command does not re-create it.
...
* xref:create-jvm-option.adoc#create-jvm-option[`create-jvm-option`],
