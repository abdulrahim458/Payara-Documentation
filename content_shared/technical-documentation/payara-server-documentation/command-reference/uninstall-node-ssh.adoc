...
NOTE: This subcommand is equivalent to the xref:uninstall-node.adoc#uninstall-node[`uninstall-node`]
subcommand.
...
*`--installdir`*:
  The absolute path to the parent of the base installation directory where the Payara Server software is installed on each host, for example, `/export/payara7/`. +
...
The software is uninstalled even if a user-defined node resides on the host. The entire content of the `/export/payara7` directory is removed.

Some lines of output are omitted from this example for readability.

[source,shell]
----
asadmin> uninstall-node-ssh --force --installdir /export/payara7 sj02.example.com
Successfully connected to gfuser@sj02.example.com using keyfile /home/gfuser
/.ssh/id_rsa
Force removing file /export/payara7/mq/lib/help/en/add_overrides.htm
Force removing file /export/payara7/mq/lib/help/en/add_connfact.htm
...
Force removing directory /export/payara7/glassfish/lib/appclient
Force removing directory /export/payara7/glassfish/lib
Force removing directory /export/payara7/glassfish
Command uninstall-node-ssh executed successfully.
----
