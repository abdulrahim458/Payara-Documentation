...
The `export-sync-bundle` subcommand exports the configuration data of a cluster or standalone instance to an archive file. The archive file can then be used with the xref:technical-documentation/payara-server-documentation/command-reference/import-sync-bundle.adoc#import-sync-bundle[`import-sync-bundle`] subcommand to restore the configuration data.
...
Sync bundle: /export/payara7/glassfish/domains/domain1/sync/
...
* xref:technical-documentation/payara-server-documentation/command-reference/import-sync-bundle.adoc#import-sync-bundle[`import-sync-bundle`]
