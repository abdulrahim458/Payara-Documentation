...
* xref:../general-administration/administering-transactions.adoc#administering-transactions[Administering Transactions]" in Payara Server General Administration section,
