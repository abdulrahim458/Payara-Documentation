...
*component-name*:
  ...
  application versions, see xref:../application-deployment/index.adoc#module-and-application-versions[Module and Application Versions] in Payara Server Application Deployment section.
