...
*`--checkEncrypted`*:
This option helps check if encryption of data stored in the xref:../high-availability/administering-the-domain-data-grid.adoc[Domain Data Grid] store is enabled or disabled.
