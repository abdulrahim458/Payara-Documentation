...
* xref:../general-administration/administering-database-connectivity.adoc#administering-database-connectivity[Administering Database Connectivity] in Payara Server General Administration section
