...
"xref:../general-administration/administering-database-connectivity.adoc#administering-database-connectivity[Administering Database Connectivity]" in the Payara Server General Administration section
