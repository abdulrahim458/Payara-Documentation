...
*`--property`*:
  ...
  Additionally, you can specify `connector-connection-pool` attributes as connector resource properties. For a list of these attributes, see "xref:../application-deployment/elements-of-deployment-descriptors.adoc#connector-connection-pool[connector-connection-pool]" in Payara Server Application Deployment section. +
