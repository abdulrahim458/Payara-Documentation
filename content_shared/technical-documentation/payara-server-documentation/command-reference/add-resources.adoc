...
The xml-file-name operand is the path to the XML file that contains the resources to be created. The `DOCTYPE` must be specified as `https://docs.azul.com/payara/schemas/payara-resources_1_8.dtd` in the `resources.xml` file.
...
<!DOCTYPE resources PUBLIC
  ...
  "https://docs.azul.com/payara/schemas/payara-resources_1_8.dtd">
<resources>
