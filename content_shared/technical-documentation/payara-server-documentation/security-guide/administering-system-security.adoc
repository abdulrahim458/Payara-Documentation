...
Password aliases can also be accessed using MicroProfile Config, as detailed xref:technical-documentation/microprofile/config/index.adoc[here].
...
IMPORTANT: Audit Modules are deprecated and will be removed in Payara 7.
...
+
image:security/jacc-providers.png[alt="Configured JACC Providers",width=600px]
+
...
IMPORTANT: To access this API, you will need to add a dependency to the xref:technical-documentation/public-api/index.adoc[Payara Public API] first.
