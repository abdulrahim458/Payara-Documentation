...
:page-description: Administer Payara Server instances — create, start, stop, and manage standalone and clustered server instances within a Payara Server domain.
:ordinal: 6
...
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for configuring the instance, see the xref:../command-reference/create-instance.adoc[`create-instance`] help page.
...
* xref:../command-reference/create-instance.adoc#create-instance[`create-instance`]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/list-instances.adoc[`list-instances`] subcommand.
+
[source,shell]
----
...
If this instance must be deleted, use the xref:../command-reference/change-master-broker.adoc[`change-master-broker`] subcommand first to assign the master broker to a different instance.
...
. Run the xref:../command-reference/delete-instance.adoc[`delete-instance`] subcommand.
+
[source,shell]
----
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/start-cluster.adoc[`start-cluster`] subcommand.
+
[source,shell]
----
...
* xref:../command-reference/start-cluster.adoc[`start-cluster`]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/stop-cluster.adoc[`stop-cluster`] subcommand.
+
[source,shell]
----
...
xref:../command-reference/stop-cluster.adoc[`stop-cluster`]
...
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for controlling the behavior of the instance, see the xref:../command-reference/start-instance.adoc[`start-instance`] help page.
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/stop-instance.adoc[`stop-instance`] subcommand.
...
xref:../command-reference/stop-instance.adoc[`stop-instance`]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/restart-instance.adoc[`restart-instance`] subcommand.
+
[source,shell]
----
...
* xref:../command-reference/restart-instance.adoc#restart-instance[`restart-instance`(1)]
...
* xref:administering-payara-server-nodes.adoc#to-create-an-ssh-node[To Create an `SSH` Node]
* xref:administering-payara-server-nodes.adoc#to-create-a-config-node[To Create a `CONFIG` Node]
* xref:../command-reference/create-local-instance.adoc[`create-local-instance`]
...
If this instance must be deleted, use the xref:../command-reference/change-master-broker.adoc[`change-master-broker`] subcommand to assign the master broker to a different instance first.
...
*instance-name*:
The name of the instance that you are deleting.
. Run the xref:../command-reference/delete-local-instance.adoc[`delete-local-instance`] subcommand.
+
[source,shell]
----
...
* xref:administering-payara-server-instances.adoc#to-start-an-individual-instance-centrally[To Stop an Individual Instance Centrally]
* xref:administering-payara-server-instances.adoc#to-stop-an-individual-instance-locally[To Stop an Individual Instance Locally]
* xref:../command-reference/change-master-broker.adoc[`change-master-broker`]
* xref:../command-reference/delete-local-instance.adoc[`delete-local-instance`]
* xref:../command-reference/list-instances.adoc[`list-instances`]
...
For information about all the options for controlling the behavior of the instance, see the xref:../command-reference/start-local-instance.adoc[`start-local-instance`] help page.
...
. Log in to the host that is represented by the node where the instance resides.
. Run the xref:../command-reference/stop-local-instance.adoc[`stop-local-instance`] subcommand.
+
[source,shell]
----
...
xref:../command-reference/stop-local-instance.adoc[`stop-local-instance`]
...
xref:../command-reference/restart-local-instance.adoc[`restart-local-instance`]
...
+
For more information, see the xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`] help
  page.
+
...
xref:../command-reference/deploy.adoc[`deploy`]
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for exporting the configuration data, see the xref:../command-reference/export-sync-bundle.adoc[`export-sync-bundle`] help page.
+
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for importing the configuration data, see the xref:../command-reference/import-sync-bundle.adoc[`import-sync-bundle`] help page.
+
[source,shell]
----
...
xref:../command-reference/list-timers.adoc[`list-timers`],
xref:../command-reference/migrate-timers.adoc[`migrate-timers`],
xref:../command-reference/list-instances.adoc[`list-instances`],
xref:../command-reference/stop-instance.adoc[`stop-instance`]
