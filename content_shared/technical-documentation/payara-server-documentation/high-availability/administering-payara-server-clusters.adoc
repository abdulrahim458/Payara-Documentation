...
For information about Payara Server instances, see xref:administering-payara-server-instances.adoc#administering-payara-server-instances[Administering Payara Server Instances].
...
* GMS cluster settings — These are determined during cluster creation. For more information about these settings, see xref:administering-payara-server-clusters.adoc#to-create-a-cluster[To Create a Cluster].
...
For the steps to specify these settings, see xref:administering-payara-server-clusters.adoc#to-preconfigure-nondefault-gms-configuration-settings[To Preconfigure Nondefault GMS Configuration Settings] and xref:administering-payara-server-clusters.adoc#to-change-gms-settings-after-cluster-creation[To Change GMS Settings After Cluster Creation].
...
. Create a configuration using the xref:technical-documentation/payara-server-documentation/command-reference/copy-config.adoc[`copy-config`] subcommand. For example:
+
[source,shell]
----
asadmin> copy-config default-config mycfg
----
For more information, see xref:administering-named-configurations.adoc#to-create-a-named-configuration[To Create a Named Configuration].
...
----
For a complete list of the dotted names for these settings, see xref:administering-payara-server-clusters.adoc#dotted-names-for-gms-settings[Dotted Names for GMS Settings].
...
----
You can also set GMS cluster settings during this step. For more information, see xref:administering-payara-server-clusters.adoc#to-create-a-cluster[To Create a Cluster].
...
To avoid the need to restart the DAS and the cluster, configure GMS configuration settings before cluster creation as explained in xref:administering-payara-server-clusters.adoc#to-preconfigure-nondefault-gms-configuration-settings[To Preconfigure Nondefault GMS Configuration Settings].

To avoid the need to restart the DAS and the cluster, configure the GMS cluster settings during cluster creation as explained in xref:administering-payara-server-clusters.adoc#to-create-a-cluster[To Create a Cluster].
...
. Use the xref:technical-documentation/payara-server-documentation/command-reference/get.adoc[`get`] subcommand to determine the settings to change. For example:
+
[source,shell]
----
asadmin> get "configs.config.mycfg.group-management-service.*"
...
----
For a complete list of the dotted names for these settings, see xref:administering-payara-server-clusters.adoc#dotted-names-for-gms-settings[Dotted Names for GMS Settings].
. Use the xref:technical-documentation/payara-server-documentation/command-reference/set.adoc[`set`] subcommand to change the settings. For example:
+
[source,shell]
----
...
. Ensure that the DAS and cluster are running. Remote subcommands require a running server.
. Check whether server instances in a cluster are running by using the xref:technical-documentation/payara-server-documentation/command-reference/list-instances.adoc[`list-instances`] subcommand.
...
For more information about Message Queue clusters, see xref:configuring-jms-high-availability.adoc#using-message-queue-broker-clusters-with-payara-server[Using Message Queue Broker Clusters With Payara Server].

*Before You Begin*

If the cluster is to reference an existing named configuration, ensure that the configuration exists. For more information, see xref:administering-named-configurations.adoc#to-create-a-named-configuration[To Create a Named Configuration].
...
For more information, see xref:administering-payara-server-clusters.adoc#to-preconfigure-nondefault-gms-configuration-settings[To Preconfigure Nondefault GMS Configuration Settings].
...
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for configuring the cluster, see the xref:technical-documentation/payara-server-documentation/command-reference/create-cluster.adoc[`create-cluster`] help page.
...
* xref:administering-payara-server-instances.adoc#to-create-an-instance-centrally[To Create an Instance Centrally]
* xref:administering-payara-server-instances.adoc#to-create-an-instance-locally[To Create an Instance Locally]

*See Also*

* xref:administering-named-configurations.adoc#to-create-a-named-configuration[To Create a Named Configuration]
* xref:administering-payara-server-clusters.adoc#to-preconfigure-nondefault-gms-configuration-settings[To Preconfigure Nondefault GMS Configuration Settings]
* xref:configuring-jms-high-availability.adoc#using-message-queue-broker-clusters-with-payara-server[Using Message Queue Broker Clusters With Payara Server]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:technical-documentation/payara-server-documentation/command-reference/list-clusters.adoc[`list-clusters`] subcommand.
+
[source,shell]
----
...
* The cluster that you are deleting is stopped. For information about how to stop a cluster, see xref:administering-payara-server-instances.adoc#to-stop-a-cluster[To Stop a Cluster].
...
** xref:administering-payara-server-instances.adoc#to-delete-an-instance-centrally[To Delete an Instance Centrally]
** xref:administering-payara-server-instances.adoc#to-delete-an-instance-locally[To Delete an Instance Locally]
...
*cluster-name*:
  The name of the cluster that you are deleting.
. Run the xref:technical-documentation/payara-server-documentation/command-reference/delete-cluster.adoc[`delete-cluster`] subcommand.
+
[source,shell]
----
...
* xref:administering-payara-server-instances.adoc#to-stop-a-cluster[To Stop a Cluster]
* xref:administering-payara-server-instances.adoc#to-delete-an-instance-centrally[To Delete an Instance Centrally]
* xref:administering-payara-server-instances.adoc#to-delete-an-instance-locally[To Delete an Instance Locally]
