...
:page-description: Administer named configurations in Azul Payara Server — manage shared configurations applied to server instances and clusters for consistent settings across a domain.
:ordinal: 7
...
For more information, see xref:administering-payara-server-instances.adoc#types-of-payara-server-instances[Types of Payara Server Instances].
...
* xref:administering-payara-server-clusters.adoc#to-create-a-cluster[To Create a Cluster]
...
For information about how to copy a configuration, see xref:administering-named-configurations.adoc#to-create-a-named-configuration[To Create a Named Configuration].
...
For information about all the options for configuring the named configuration, see the xref:../command-reference/copy-config.adoc#copy-config[`copy-config`] help page.
+
[source,shell]
----
...
* xref:administering-payara-server-instances.adoc#to-create-an-instance-centrally[To Create an Instance Centrally]
* xref:administering-payara-server-instances.adoc#to-create-an-instance-locally[To Create an Instance Locally]
* xref:../command-reference/copy-config.adoc#copy-config[`copy-config`]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/list-configs.adoc[`list-configs`] subcommand.
+
[source,shell]
----
...
xref:../command-reference/list-configs.adoc[`list-configs`]
...
. Run the xref:../command-reference/delete-config.adoc[`delete-config`] subcommand.
+
[source,shell]
----
...
* xref:administering-payara-server-clusters.adoc#to-delete-a-cluster[To Delete a Cluster]
* xref:../command-reference/delete-config.adoc#delete-config[`delete-config`]
* xref:../command-reference/list-clusters.adoc#list-clusters[`list-clusters`]
* xref:../command-reference/list-instances.adoc#list-instances[`list-instances`]
...
You can create additional system properties for a configuration either by specifying the `--systemproperties` option of the xref:../command-reference/copy-config.adoc[`copy-config`] subcommand or by using the xref:../command-reference/create-system-properties.adoc[`create-system-properties`] subcommand.
...
*property-name*:
  The name of the property that you are modifying. For a list of available properties, see xref:administering-named-configurations.adoc#properties-for-port-numbers-in-a-named-configuration[Properties for Port Numbers in a Named Configuration].
...
* xref:../command-reference/get.adoc[`get` command]
* xref:../command-reference/set.adoc[`set` command]
...
*port-property*:
  The name of the property that corresponds to the port number that you are modifying. For a list of available properties, see xref:administering-named-configurations.adoc#properties-for-port-numbers-in-a-named-configuration[Properties for Port Numbers in a Named Configuration].
