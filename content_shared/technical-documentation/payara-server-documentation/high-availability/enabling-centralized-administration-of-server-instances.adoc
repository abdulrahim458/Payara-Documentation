...
:page-description: Enable centralized administration of Payara Server instances — configure the DAS to manage remote server instances over SSH or the config node for central control.
:ordinal: 1
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for setting up an SSH key, see the xref:../command-reference/setup-ssh.adoc#setup-ssh[`setup-ssh`(1)] help page.
+
[source,shell]
----
...
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-the-mks-toolkit-on-windows[Setting Up the MKS Toolkit on Windows]
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-ssh-on-unix-and-linux-systems[Setting Up SSH on UNIX and Linux Systems]
* xref:../command-reference/setup-ssh.adoc#setup-ssh[`setup-ssh`(1)]
...
To use the encrypted key file, Payara Server requires the passphrase with which the key file was encrypted. To provide this passphrase securely to Payara Server, create a Payara Server password alias to represent the passphrase and store this alias in a password file that is passed to the xref:../command-reference/asadmin.adoc#asadmin-1m[`asadmin`] utility.
...
+
Use the xref:../command-reference/setup-ssh.adoc[`setup-ssh`] `asadmin` subcommand for this purpose.
[source,shell]
----
...
.. Run the xref:../command-reference/create-password-alias.adoc[`create-password-alias`] `asadmin` subcommand.
+
[source,shell]
----
...
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-the-mks-toolkit-on-windows[Setting Up the MKS Toolkit on Windows]
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-ssh-on-unix-and-linux-systems[Setting Up SSH on UNIX and Linux Systems]
* xref:../command-reference/asadmin.adoc#asadmin-1m[`asadmin`(1M)]
* xref:../command-reference/create-password-alias.adoc#create-password-alias[`create-password-alias`(1)]
* xref:../command-reference/setup-ssh.adoc#setup-ssh[`setup-ssh`(1)]
...
To use SSH to log in to a remote host, Payara Server requires the SSH user's password. To provide this password securely to Payara Server, create a Payara Server password alias to represent the password and store this alias in a password file that is passed to the xref:../command-reference/asadmin.adoc#asadmin-1m[`asadmin`] utility.
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for creating a password alias, see the xref:../command-reference/create-password-alias.adoc#create-password-alias[`create-password-alias`(1)] help page.
+
[source,shell]
----
asadmin> create-password-alias alias-name
...
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-the-mks-toolkit-on-windows[Setting Up the MKS Toolkit on Windows]
* xref:enabling-centralized-administration-of-server-instances.adoc#setting-up-ssh-on-unix-and-linux-systems[Setting Up SSH on UNIX and Linux Systems]
* xref:../command-reference/asadmin.adoc[`asadmin`(1M)]
* xref:../command-reference/create-password-alias.adoc#create-password-alias[`create-password-alias`(1)]
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for copying an installation of Payara Server software, see the link xref:../command-reference/install-node-ssh.adoc#install-node-ssh[`install-node-ssh`(1)] help page.
+
[source,shell]
----
...
* xref:../command-reference/install-node-ssh.adoc#install-node-ssh[`install-node-ssh`(1)]
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for removing Payara Server software, see the xref:../command-reference/uninstall-node-ssh.adoc#uninstall-node-ssh[`uninstall-node-ssh`(1)] help page.
...
* xref:../command-reference/uninstall-node-ssh.adoc#uninstall-node-ssh[`uninstall-node-ssh`(1)]
