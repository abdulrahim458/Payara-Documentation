...
:page-description: Administer Payara Server nodes — create and configure SSH or config nodes for deploying server instances across remote hosts in a Payara domain.
:ordinal: 2
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for configuring the node, see the xref:../command-reference/create-node-ssh.adoc[`create-node-ssh`] help page.
+
If you are using password authentication for the SSH user, you must specify a password file through the `--passwordfile` option of the xref:../command-reference/asadmin.adoc[`asadmin`] utility. For more information about SSH user authentication, see link:Technical Documentation/Payara Server Documentation/High Availability/ssh-setup.adoc#setting-up-ssh-user-authentication[Setting Up SSH User Authentication].
+
[source,shell]
----
...
xref:../command-reference/create-node-ssh.adoc[`create-node-ssh`]
...
NOTE: To obtain information about all existing nodes in a domain, use the xref:../command-reference/list-nodes.adoc[`list-nodes`] subcommand.

. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/list-nodes-ssh.adoc[`list-nodes-ssh`] subcommand.
+
[source,shell]
----
...
* xref:../command-reference/list-nodes.adoc[`list-nodes`]
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for testing the node, see the xref:../command-reference/ping-node-ssh.adoc[`ping-node-ssh`] help page.
+
[source,shell]
----
...
xref:../command-reference/ping-node-ssh.adoc[`ping-node-ssh`]
...
asadmin> list-nodes-ssh --long=true
----
. Run the xref:../command-reference/delete-node-ssh.adoc[`delete-node-ssh`] subcommand.
+
[source,shell]
----
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for configuring the node, see the xref:../command-reference/create-node-config.adoc[`create-node-config`] help page.
+
[source,shell]
----
...
xref:../command-reference/create-node-config.adoc[`create-node-config`]
...
. Ensure that the DAS is running. Remote subcommands require a running server.
. Run the xref:../command-reference/list-nodes-config.adoc[`list-nodes-config`] subcommand.
+
[source,shell]
----
...
* xref:../command-reference/list-nodes.adoc[`list-nodes`]
* xref:../command-reference/list-nodes-config.adoc[`list-nodes-config`]
...
----
+
. Run the xref:../command-reference/delete-node-config.adoc[`delete-node-config`] subcommand.
+
[source,shell]
----
...
* xref:administering-payara-server-instances.adoc#to-delete-an-instance-locally[To Delete an Instance Locally]
* xref:../command-reference/delete-node-config.adoc[`delete-node-config`]
* xref:../command-reference/list-nodes-config.adoc[`list-nodes-config`]
...
+
*options*:
  Options of the `update-node-ssh` subcommand for changing the node's configuration data. For information about these options, see the xref:../command-reference/update-node-ssh.adoc[`update-node-ssh`] help page.
*node-name*:
...
----
*options*:
  Options of the `update-node-config` subcommand for changing the node's configuration data. For information about these options, see the xref:../command-reference/update-node-config.adoc[`update-node-config`] help page.
*node-name*:
