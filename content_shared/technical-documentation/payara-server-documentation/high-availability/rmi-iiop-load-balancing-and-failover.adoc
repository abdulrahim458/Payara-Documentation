...
+
For more information about the `glassfish-ejb-jar.xml` deployment descriptor file, refer to "xref:technical-documentation/payara-server-documentation/application-deployment/deployment-descriptor-files.adoc#the-payara-ejb-jar.xml-file[The glassfish-ejb-jar.xml File]" in the Payara Server Application Deployment section.
+
