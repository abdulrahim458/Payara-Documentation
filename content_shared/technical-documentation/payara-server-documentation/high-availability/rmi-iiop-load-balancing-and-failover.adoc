...
+
This utility produces an `appclient.jar` file. For more information on `package-appclient`, see xref:technical-documentation/payara-server-documentation/command-reference/package-appclient.adoc#package-appclient[`package-appclient`].
...
+
For a list of the path variables to update, see xref:technical-documentation/payara-server-documentation/command-reference/package-appclient.adoc[`package-appclient`].
