...
|Data Grid Discovery Mode | See xref:administering-the-domain-data-grid.adoc#domain-discovery-mode[Discovery Modes]
|====
...
|Enabled | See xref:administering-the-domain-data-grid.adoc#enabling-and-disabling-the-data-grid[Disabling Data Grid] for detailed information
