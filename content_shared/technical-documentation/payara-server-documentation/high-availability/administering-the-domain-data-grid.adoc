...
image:domain-datagrid/discovery-mode.png[alt="Domain Discovery Mode",width=600px]
...
image:hazelcast/hazelcast-admin-console-view-cluster-members-from-domain.png[alt="Domain Cluster Members",width=600px]
