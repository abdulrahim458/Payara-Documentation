...
+
For information about how to disable these features, see the xref:technical-documentation/payara-server-documentation/application-deployment/index.adoc[Payara Server Application Deployment section].
* Payara Server does not support High Availability Database (HA-DB) configurations. Instead, use in-memory replication, as described in xref:technical-documentation/payara-server-documentation/high-availability/index.adoc#high-availability-session-persistence[High Availability Session Persistence].
