...
* The web application must be deployed using the `deploy` subcommand with the `--availabilityenabled` option set to `true`. For more information on these subcommands, see xref:technical-documentation/payara-server-documentation/command-reference/deploy.adoc#deploy[`deploy`].
...
+
For more information, see xref:technical-documentation/payara-server-documentation/command-reference/deploy.adoc[`deploy`].
