...
:page-description: Use gRPC in Azul Payara Server — configure and implement gRPC services, define Protocol Buffer schemas, and expose gRPC endpoints from Payara Server applications.

WARNING: The gRPC extension has not yet been updated to support Azul Payara {pageSiteEditionCapitalised} {payaraVersionMajor}
...
image::grpc/grpc-stubs-folders.png[Stubs folders,width=600px]
...
image::grpc/deploy-gui-tool.png[Admin Console,width=100%]
