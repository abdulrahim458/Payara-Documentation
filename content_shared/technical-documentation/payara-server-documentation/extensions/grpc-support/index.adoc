= Grpc
:page-description: gRPC support in Azul Payara Server — overview of the gRPC server extension enabling gRPC service endpoints alongside standard Jakarta EE endpoints in Payara Server.
