...
:page-description: Elements of Azul Payara deployment descriptors — complete reference for all XML elements supported in Payara-specific deployment descriptor files.
:ordinal: 4

This appendix describes the elements of the Azul Payara deployment descriptors.
...
xref:elements-of-deployment-descriptors.adoc#mdb-resource-adapter[`mdb-resource-adapter`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#description[`description`]
|zero or one
|Specifies a text description of the activation configuration.

a| xref:elements-of-deployment-descriptors.adoc#activation-config-property[`activation-config-property`]
|one or more
...
xref:elements-of-deployment-descriptors.adoc#activation-config[`activation-config`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#activation-config-property-name[`activation-config-property-name`]
|only one
|Specifies the name of an activation configuration property.

a| xref:elements-of-deployment-descriptors.adoc#activation-config-property-value[`activation-config-property-value`]
|only one
...
xref:elements-of-deployment-descriptors.adoc#activation-config-property[`activation-config-property`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#resources[`resources`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#property-with-attributes[`property` (with attributes)]
|zero or more
...
a|`res-adapter`
|none
a|Specifies the name of the inbound resource
adapter.
...
xref:elements-of-deployment-descriptors.adoc#ior-security-config[`ior-security-config`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a|xref:elements-of-deployment-descriptors.adoc#auth-method[`auth-method`]
|only one
a|Specifies the authentication method. The only supported value is `USERNAME_PASSWORD`.

a| xref:elements-of-deployment-descriptors.adoc#realm[`realm`]
|only one
|Specifies the realm in which the user is authenticated.

a| xref:elements-of-deployment-descriptors.adoc#required[`required`]
|only one
a|Specifies whether the authentication method specified in the `auth-method` element must be used for client authentication.
...
xref:elements-of-deployment-descriptors.adoc#payara-application[``payara-application`] (`glassfish-application.xml` (deprecated) and `payara-application.xml``)
...
If the parent element is  xref:elements-of-deployment-descriptors.adoc#as-context[`as-context`], the only supported value is `USERNAME_PASSWORD`.

If the parent element is  xref:elements-of-deployment-descriptors.adoc#login-config[`login-config`], specifies the authentication mechanism for the web service endpoint.
...
xref:elements-of-deployment-descriptors.adoc#login-config[`login-config`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`),
xref:elements-of-deployment-descriptors.adoc#as-context[`as-context`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
For more information about how to define realms, see "xref:../../application-development/securing-applications.adoc#realm-configuration[Realm Configuration]" in the Payara Server Application Development section.

[#superelements-8]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#client-container[`client-container`] (`sun-acc.xml`)
...
See "xref:../../application-development/securing-applications.adoc#realm-configuration[Realm Configuration]" in the Payara Server Application Development section.
...
xref:elements-of-deployment-descriptors.adoc#security-map[`security-map`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`)
...
xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#max-cache-size[`max-cache-size`]
|zero or one
|Specifies the maximum number of beans allowable in cache.

a| xref:elements-of-deployment-descriptors.adoc#cache-idle-timeout-in-seconds[`cache-idle-timeout-in-seconds`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#removal-timeout-in-seconds[`removal-timeout-in-seconds`]
|zero or one
a|Specifies the amount of time a bean remains before being removed. If `removal-timeout-in-seconds` is less than `idle-timeout`, the bean is removed without being passivated.

a| xref:elements-of-deployment-descriptors.adoc#resize-quantity[`resize-quantity`]
|zero or one
a|Specifies the number of beans to be created if the pool is empty (subject to the `max-pool-size` limit). Values are from 0 to MAX_INTEGER.

a| xref:elements-of-deployment-descriptors.adoc#victim-selection-policy[`victim-selection-policy`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#steady-pool-size[`steady-pool-size`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#max-pool-size[`max-pool-size`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#pool-idle-timeout-in-seconds[`pool-idle-timeout-in-seconds`]
|zero or one
...
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`]
|zero or more
|Specifies a custom class that implements the CacheHelper interface.

a| xref:elements-of-deployment-descriptors.adoc#default-helper[`default-helper`]
|zero or one
a|Allows you to change the properties of the default, built-in  xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`] class.

a| xref:elements-of-deployment-descriptors.adoc#property-with-attributes[`property` (with attributes)]
|zero or more
|Specifies a cache property, which has a name and a value.

a| xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`]
|zero or more
...
a|`30`
a|(optional) Specifies the maximum amount of time in seconds that an entry can remain in the cache after it is created or refreshed. Can be overridden by a xref:elements-of-deployment-descriptors.adoc#timeout[`timeout`] element.
...
a|`cacheClassName`
a|`com.sun.appserv.web.cache.LruCache`
|Specifies the fully qualified name of the class that implements the cache functionality. See xref:elements-of-deployment-descriptors.adoc#cache-class-names[Cache Class Names] for possible values.

a|`MultiLRUSegmentSize`
a|`4096`
a|Specifies the number of entries in a segment of the cache table that should have its own LRU (least recently used) list. Applicable only if `cacheClassName` is set to `com.sun.appserv.web.cache.MultiLruCache`.

a|`MaxSize`
a|unlimited; `Long.MAX_VALUE`
a|Specifies an upper bound on the cache memory size in bytes (KB or MB units). Example values are `32 KB` or `2 MB`. Applicable only if `cacheClassName` is set to `com.sun.appserv.web.cache.BoundedMultiLruCache`.
...
a|`com.sun.appserv.web.cache.BaseCache`
|An unbounded cache suitable if the maximum number of entries is known.

a|`com.sun.appserv.web.cache.MultiLruCache`
a|A cache suitable for a large number of entries (>4096). Uses the `MultiLRUSegmentSize` property.

a|`com.sun.appserv.web.cache.BoundedMultiLruCache`
a|A cache suitable for limiting the cache size by memory rather than number of entries. Uses the `MaxSize` property.
...
xref:elements-of-deployment-descriptors.adoc#cache[`cache`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
[cols=1,1,1,1,1,1,1,2,6",options="header"]
|===
|Element |Required |Description
...
a|`name`
a|`default`
a|Specifies a unique name for the helper class, which is referenced in the  xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`] element.
...
Specifies the `name` of the  xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`] used by the parent xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`] element.

[#superelements-14]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
xref:elements-of-deployment-descriptors.adoc#bean-cache[`bean-cache`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#servlet-name[`servlet-name`]
a|requires one `servlet-name` or `url-pattern`
|Contains the name of a servlet.

a| xref:elements-of-deployment-descriptors.adoc#url-pattern[`url-pattern`]
a|requires one `servlet-name` or `url-pattern`
|Contains a servlet URL pattern for which caching is enabled.

a| xref:elements-of-deployment-descriptors.adoc#cache-helper-ref[`cache-helper-ref`]
a|required if `dispatcher`, `timeout`, `refresh-field`, `http-method`, `key-field`, and `constraint-field` are not used
a|Contains the `name` of the  xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`] used by the parent `cache-mapping` element.

a|  xref:elements-of-deployment-descriptors.adoc#dispatcher[`dispatcher`]
a|zero or one if `cache-helper-ref` is not used
a|Contains a comma-separated list of `RequestDispatcher` methods for which caching is enabled.

a| xref:elements-of-deployment-descriptors.adoc#timeout[`timeout`]
a|zero or one if `cache-helper-ref` is not used
a|Contains the xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`] specific maximum amount of time in seconds that an entry can remain in the cache after it is created or refreshed.

a| xref:elements-of-deployment-descriptors.adoc#refresh-field[`refresh-field`]
a|zero or one if `cache-helper-ref` is not used
|Specifies a field that gives the application component a programmatic way to refresh a cached entry.

a| xref:elements-of-deployment-descriptors.adoc#http-method[`http-method`]
a|zero or more if `cache-helper-ref` is not used
|Contains an HTTP method that is eligible for caching.

a| xref:elements-of-deployment-descriptors.adoc#key-field[`key-field`]
a|zero or more if `cache-helper-ref` is not used
|Specifies a component of the key used to look up and extract cache entries.

a| xref:elements-of-deployment-descriptors.adoc#constraint-field[`constraint-field`]
a|zero or more if `cache-helper-ref` is not used
a|Specifies a cacheability constraint for the given `url-pattern` or `servlet-name`.
...
xref:elements-of-deployment-descriptors.adoc#port-info[`port-info`], xref:elements-of-deployment-descriptors.adoc#service-ref[`service-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml``)
...
a| xref:elements-of-deployment-descriptors.adoc#name[`name`]
|only one
|Specifies the name of the entity.

a| xref:elements-of-deployment-descriptors.adoc#value[`value`]
|only one
...
xref:elements-of-deployment-descriptors.adoc#sas-context[`sas-context`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#security[`security`] (`sun-acc.xml`)
...
Specifies that the stateful session bean state is checkpointed, or persisted, after the specified methods are executed. The `availability-enabled` attribute of the parent  xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] element must be set to `true`.
...
a| xref:elements-of-deployment-descriptors.adoc#method[`method`]
|one or more
...
a|`extra-class-path`
|null
a| (optional) Specifies a colon or semicolon separated list of additional classpaths for this web module. Paths can be absolute or relative to the web module's root, for example:
[source,text]
----
...
a|`dynamic-reload-interval`
| +
a|(optional) Not implemented. Included
...
a|`ignoreHiddenJarFiles`
a|`false`
a|If `true`, specifies that all JAR and ZIP files in the `WEB-INF/lib` directory that start with a period (`.`) are ignored by the class loader.
...
For more information about how class delegation can be configured on Payara Server, see the xref:../../application-development/class-loaders.adoc#enhanced-classloading[Enhanced Class loading] section.
...
See xref:deployment-descriptor-files.adoc#the-sun-acc.xml-file[The sun-acc.xml File].
...
a| xref:elements-of-deployment-descriptors.adoc#target-server[`target-server`]
|one or more
a|
...
a| xref:elements-of-deployment-descriptors.adoc#auth-realm[`auth-realm`]
|zero or one
a|Specifies the optional configuration for JAAS
authentication realm.

a| xref:elements-of-deployment-descriptors.adoc#client-credential[`client-credential`]
|zero or one
|Specifies the default client credential that is sent to the server.

a| xref:elements-of-deployment-descriptors.adoc#log-service[`log-service`]
|zero or one
|Specifies the default log file and the severity level of the message.

a| xref:elements-of-deployment-descriptors.adoc#message-security-config[`message-security-config`]
|zero or more
...
a|`send-password`
a|`true`
a|If `true`, specifies that client
...
Describes whether this bean should be a xref:../../public-api/clustered-singleton.adoc[Clustered Singleton]. Can be applied only to singleton EJBs.
...
xref:elements-of-deployment-descriptors.adoc#payara-application[`payara-application`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-ejb-jar[`payara-ejb-jar`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#transport-config[`transport-config`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#security-map[`security-map`]
|zero or more
...
a|`name`
|none
a|Specifies the name of the connection pool. A xref:elements-of-deployment-descriptors.adoc#connector-resource[`connector-resource`] element's `pool-name` attribute refers to this `name`.

a|`resource-adapter-name`
|none
a|Specifies the name of the deployed connector module or application. If no name is specified during deployment, the name of the `.rar` file is used.
If the resource adapter is embedded in an application, then it is `app_name#rar_name`.

a|`connection-definition-name`
|none
a|Specifies a unique name, identifying a resource adapter's `connection-definition` element in the `ra.xml` file.
...
a|`max-wait-time-in-millis`
a|`60000`
a|(optional) Specifies the amount of time, in milliseconds, that the caller is willing to wait for a connection.
If `0`, the caller is blocked indefinitely until a resource is available or an error occurs.

a|`pool-resize-quantity`
a|`2`
a|
...
a|`fail-all-connections`
a|`false`
a|(optional) If `true`, closes all connections in the pool if a single validation check fails.
...
a|`is-connection-validation-required`
a|`false`
...
a|`validate-atmost-once-period-in-seconds`
a|`0`
...
a|`connection-leak-timeout-in-seconds`
a|`0`
a|Detects potential
...
a|`connection-leak-reclaim`
a|`false`
a|If `true`, the pool will reclaim a connection after `connection-leak-timeout-in-seconds` occurs.

a|`connection-creation-retry-attempts`
a|`0`
|Specifies the number of attempts to create a new connection.

a|`connection-creation-retry-interval-in-seconds`
a|`10`
a|Specifies the time interval between attempts to create a connection when `connection-creation-retry-attempts` is greater than `0`.

a|`lazy-connection-enlistment`
a|`false`
a|If `true`, a connection is not enlisted in a transaction until it is used. If `false`, any connection object available to a transaction is enlisted in the transaction.

a|`lazy-connection-association`
a|`false`
a|If `true`, a physical connection is not associated with a logical connection until it is used.
If `false`, a physical connection is associated with a logical connection even before it is used.

a|`associate-with-thread`
a|`false`
a|
...
a|`AddressList`
|none
a|Specifies a list of host/port combinations of the
...
a|`UserName`
a|`guest`
a|Specifies the user name for connecting to the
Message Queue software. For JMS resources of the Type `jakarta.jms.TopicConnectionFactory` or `jakarta.jms.QueueConnectionFactory`.

a|`Password`
a|`guest`
a|Specifies the password for connecting to the
Message Queue software. For JMS resources of the Type `jakarta.jms.TopicConnectionFactory` or `jakarta.jms.QueueConnectionFactory`.

a|`ReconnectAttempts`
a|`6`
a|Specifies the number of attempts to connect (or reconnect) for each address in the `imqAddressList` before the client runtime moves on to try the next address in the list.
...
a|`ReconnectInterval`
a|`30000`
a|Specifies the interval between reconnect
...
a|`AddressListIterations`
a|`-1`
a|Specifies the number of times the client
...
a|`pool-name`
|none
a|Specifies the `name` of the associated
xref:elements-of-deployment-descriptors.adoc#connector-connection-pool[`connector-connection-pool`].
...
Specifies a cacheability constraint for the given xref:elements-of-deployment-descriptors.adoc#url-pattern[`url-pattern`] or xref:elements-of-deployment-descriptors.adoc#servlet-name[`servlet-name`].
...
a| xref:elements-of-deployment-descriptors.adoc#constraint-field-value[`constraint-field-value`]
|zero or more
...
a|`scope`
a|`request.parameter`
a|(optional) Specifies the scope from which
...
a|`cache-on-match`
a|`true`
a|(optional) If `true`, caches the response if
matching succeeds. Overrides the same attribute in a
xref:elements-of-deployment-descriptors.adoc#constraint-field-value[`constraint-field-value`] subelement.

a|`cache-on-match-failure`
a|`false`
a|(optional) If `true`, caches the
...
xref:elements-of-deployment-descriptors.adoc#constraint-field[`constraint-field`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a|`cache-on-match`
a|`true`
a|(optional) If `true`, caches the response if matching succeeds.

a|`cache-on-match-failure`
a|`false`
a|(optional) If `true`, caches the response if matching fails.
...
If none is specified, a default is generated; see xref:elements-of-deployment-descriptors.adoc#java-web-start-access[`java-web-start-access`].
...
xref:elements-of-deployment-descriptors.adoc#web[`web`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`),
xref:elements-of-deployment-descriptors.adoc#java-web-start-access[`java-web-start-access`] (`glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
xref:elements-of-deployment-descriptors.adoc#session-config[`session-config`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a|Specifies the pathname that is set when the cookie is created. The
...
a|`cookieMaxAgeSeconds`
|none
a|Specifies the expiration time (in seconds)
...
For details, see xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`].

a|`cookieHttpOnly`
|none
a|Specifies that the cookie is marked HTTP only. Allowed values are `true` or `false`.

a|`cookieSameSite`
|none
a|Users can set up the link:https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie#samesitesamesite-value[`SameSite`^] Cookie attribute for the corresponding web application. Can be one of `Strict`, `Lax` or `None`. For example:
...
a|`factory-class`
|none
a|Specifies the fully qualified name of the
...
a|`enabled`
a|`true`
a|(optional) Determines whether this resource is
enabled at runtime.
...
xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
Passes property values to the built-in `default` xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`] class.
...
a|`cacheKeyGeneratorAttrName`
a|Uses the built-in `default`
xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`] key generation, which concatenates the
servlet path with xref:elements-of-deployment-descriptors.adoc#key-field[`key-field`] values, if any. |The caching
...
helper. See "xref:../../application-development/developing-web-applications.adoc#the-cachekeygenerator-interface[The CacheKeyGenerator Interface]" in the Payara Server Application Development section.
...
xref:elements-of-deployment-descriptors.adoc#resource-ref[`resource-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`,
`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`);
xref:elements-of-deployment-descriptors.adoc#mdb-connection-factory[`mdb-connection-factory`]
(`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#name[`name`]
|only one
a|Specifies the default resource principal name used to sign
on to a resource manager.

a| xref:elements-of-deployment-descriptors.adoc#password[`password`]
|only one
...
xref:elements-of-deployment-descriptors.adoc#property-with-attributes[`property` (with attributes)], xref:elements-of-deployment-descriptors.adoc#valve[`valve`]
(`glassfish-web.xml` (deprecated) and `payara-web.xml`); xref:elements-of-deployment-descriptors.adoc#activation-config[`activation-config`],
xref:elements-of-deployment-descriptors.adoc#method[`method`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`);
xref:elements-of-deployment-descriptors.adoc#target-server[`target-server`] (`sun-acc.xml`);
xref:elements-of-deployment-descriptors.adoc#admin-object-resource[`admin-object-resource`],
xref:elements-of-deployment-descriptors.adoc#connector-connection-pool[`connector-connection-pool`],
xref:elements-of-deployment-descriptors.adoc#connector-resource[`connector-resource`], xref:elements-of-deployment-descriptors.adoc#custom-resource[`custom-resource`],
xref:elements-of-deployment-descriptors.adoc#external-jndi-resource[`external-jndi-resource`],
xref:elements-of-deployment-descriptors.adoc#jdbc-connection-pool[`jdbc-connection-pool`], xref:jdbc-resource[`jdbc-resource`],
xref:elements-of-deployment-descriptors.adoc#mail-resource[`mail-resource`], xref:elements-of-deployment-descriptors.adoc#property-with-attributes[`property` (with attributes)],
xref:elements-of-deployment-descriptors.adoc#resource-adapter-config[`resource-adapter-config`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`)
...
`checkpoint-at-end-of-method`
* Entity beans: `commit-option`, `bean-cache`, `bean-pool`,
...
xref:elements-of-deployment-descriptors.adoc#enterprise-beans[`enterprise-beans`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#ejb-name[`ejb-name`]
|only one
a|Matches the `ejb-name` in the corresponding `ejb-jar.xml` file.

a| xref:elements-of-deployment-descriptors.adoc#jndi-name[`jndi-name`]
|zero or more
a|Specifies the absolute `jndi-name`.

a| xref:elements-of-deployment-descriptors.adoc#ejb-ref[`ejb-ref`]
|zero or more
a|Maps the absolute JNDI name to the `ejb-ref` element in the corresponding Jakarta EE XML file.

a| xref:elements-of-deployment-descriptors.adoc#resource-ref[`resource-ref`]
|zero or more
a|Maps the absolute JNDI name to the `resource-ref` in the corresponding Jakarta EE XML file.

a| xref:elements-of-deployment-descriptors.adoc#resource-env-ref[`resource-env-ref`]
|zero or more
a|Maps the absolute JNDI name to the `resource-env-ref` in the corresponding Jakarta EE XML file.

a|xref:elements-of-deployment-descriptors.adoc#service-ref[`service-ref`]
|zero or more
|Specifies runtime settings for a web service reference.

a| xref:elements-of-deployment-descriptors.adoc#message-destination-ref[`message-destination-ref`]
|zero or more
|Specifies the name of a physical message destination.

a| xref:elements-of-deployment-descriptors.adoc#pass-by-reference[`pass-by-reference`]
|zero or one
a|Specifies the passing method used by an enterprise bean
calling a remote interface method in another bean that is colocated
within the same process.

a| xref:elements-of-deployment-descriptors.adoc#principal[`principal`]
|zero or one
a|Specifies the principal (user) name in an enterprise bean that has the `run-as` role specified.

a| xref:elements-of-deployment-descriptors.adoc#mdb-connection-factory[`mdb-connection-factory`]
|zero or one
|Specifies the connection factory associated with a message-driven bean.

a| xref:elements-of-deployment-descriptors.adoc#jms-durable-subscription-name[`jms-durable-subscription-name`]
|zero or one
|Specifies the durable subscription associated with a message-driven bean.

a| xref:elements-of-deployment-descriptors.adoc#jms-max-messages-load[`jms-max-messages-load`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#ior-security-config[`ior-security-config`]
|zero or one
|Specifies the security information for the IOR.

a| xref:elements-of-deployment-descriptors.adoc#is-read-only-bean[`is-read-only-bean`]
|zero or one
|Specifies that this entity bean is read-only.

a| xref:elements-of-deployment-descriptors.adoc#refresh-period-in-seconds[`refresh-period-in-seconds`]
|zero or one
|Specifies the rate at which a read-only-bean must be refreshed from the data source.

a| xref:elements-of-deployment-descriptors.adoc#commit-option[`commit-option`]
|zero or one
|Has valid values of B or C. Default value is B.

a| xref:elements-of-deployment-descriptors.adoc#cmt-timeout-in-seconds[`cmt-timeout-in-seconds`]
|zero or one
|Overrides the Transaction Timeout setting of the Transaction Service for an individual bean.

a| xref:elements-of-deployment-descriptors.adoc#use-thread-pool-id[`use-thread-pool-id`]
|zero or one
|Specifies the thread pool from which threads are selected for remote invocations of this bean.

a| xref:elements-of-deployment-descriptors.adoc#gen-classes[`gen-classes`]
|zero or one
|Specifies all the generated class names for a bean.

a| xref:elements-of-deployment-descriptors.adoc#bean-pool[`bean-pool`]
|zero or one
|Specifies the bean pool properties. Used for stateless session beans, entity beans, and message-driven beans.

a| xref:elements-of-deployment-descriptors.adoc#bean-cache[`bean-cache`]
|zero or one
|Specifies the bean cache properties. Used only for stateful session beans and entity beans.

a| xref:elements-of-deployment-descriptors.adoc#mdb-resource-adapter[`mdb-resource-adapter`]
|zero or one
|Specifies runtime configuration information for a message-driven bean.

a| xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`]
|zero or more
|Specifies information about a web service endpoint.

a| xref:elements-of-deployment-descriptors.adoc#flush-at-end-of-method[`flush-at-end-of-method`]
|zero or one
|Specifies the methods that force a database flush after execution. Used for entity beans.

a| xref:elements-of-deployment-descriptors.adoc#checkpoint-at-end-of-method[`checkpoint-at-end-of-method`]
|zero or one
a|Specifies that the stateful session bean state is checkpointed, or persisted, after the specified methods are executed.
The `availability-enabled` attribute must be set to `true`.

a| xref:elements-of-deployment-descriptors.adoc#per-request-load-balancing[`per-request-load-balancing`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#clustered-attach-postconstruct[`clustered-attach-postconstruct`]
|zero or one
a|Used for clustered singletons. Defines whether the bean's `@PostConstruct` event is called each time it is created on different nodes.

a| xref:elements-of-deployment-descriptors.adoc#clustered-bean[`clustered-bean`]
|zero or one
|Defines whether the bean is treated as a clustered singleton.

a| xref:elements-of-deployment-descriptors.adoc#clustered-detach-predestroy[`clustered-detach-predestroy`]
|zero or one
a|Used for clustered singletons. Defines whether the bean's `@PreDestroy` event is called when the bean is destroyed on a node while available on another.

a| xref:elements-of-deployment-descriptors.adoc#clustered-key-name[`clustered-key-name`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#clustered-lock-type[`clustered-lock-type`]
|zero or one
...
a|`false`
a|(optional) If set to `true`, and if availability is enabled in the EJB container, high-availability features apply to this bean if it is a stateful session bean.
...
In the `payara-ejb-jar.xml` file, matches the `ejb-name` in the corresponding `ejb-jar.xml` file. The name must be unique among the names of the enterprise beans in the same EJB JAR file.
...
xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`], xref:elements-of-deployment-descriptors.adoc#method[`method`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`),
xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-application-client[`payara-application-client`] (`glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#ejb-ref-name[`ejb-ref-name`]
|only one
a|Specifies the `ejb-ref-name` in the corresponding Jakarta EE deployment descriptor file `ejb-ref` entry.

a| xref:elements-of-deployment-descriptors.adoc#jndi-name[`jndi-name`]
|only one
a|Specifies the absolute `jndi-name` of a resource.
...
xref:elements-of-deployment-descriptors.adoc#ejb-ref[`ejb-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
In the `payara-application.xml` deployment descriptor for an EAR file, the property `enable-implicit-cdi` can be set to `false` to achieve the same goal for all modules inside the EAR assembly. The default value is `true`, in line with the default value for WAR files.
...
IMPORTANT: When implicit CDI is configured by using either the `enable-implicit-cdi` property in the `payara-application.xml` or the attribute `bean-discovery-mode="none"` from the `beans.xml` file in a WAR, the admin console checkbox _is always ignored_.

[#superelements-225]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#payara-application[`payara-application`]
...
a| xref:elements-of-deployment-descriptors.adoc#unique-id[`unique-id`]
|zero or one
a|Specifies a unique system identifier. This data is
automatically generated and updated at deployment/redeployment. Do not
specify or edit this value.

a| xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`]
|zero or more
a|Defines runtime properties for a single enterprise bean
within the application.

a| xref:elements-of-deployment-descriptors.adoc#message-destination[`message-destination`]
|zero or more
|Specifies the name of a logical message destination.

a| xref:elements-of-deployment-descriptors.adoc#webservice-description[`webservice-description`]
|zero or more
|Specifies a name and optional publish location for a web service.

a| xref:elements-of-deployment-descriptors.adoc#property-with-subelements[`property` (with subelements)]
|zero or more
|Specifies a property or a variable.
...
a|`jndi-lookup-name`
|none
a|Specifies the JNDI lookup name for the
resource.
...
a| xref:elements-of-deployment-descriptors.adoc#remote-impl[`remote-impl`]
|zero or one
a|Specifies the fully-qualified class name of the generated `EJBObject` impl class.

a| xref:elements-of-deployment-descriptors.adoc#local-impl[`local-impl`]
|zero or one
a|Specifies the fully-qualified class name of the generated `EJBLocalObject` impl class.

a| xref:elements-of-deployment-descriptors.adoc#remote-home-impl[`remote-home-impl`]
|zero or one
a|Specifies the fully-qualified class name of the generated `EJBHome` impl class.

a| xref:elements-of-deployment-descriptors.adoc#local-home-impl[`local-home-impl`]
|zero or one
a|Specifies the fully-qualified class name of the generated `EJBLocalHome` impl class.
...
Defines the Payara Server specific configuration for an application. This is the root element; there can only be one `payara-application` element in a `payara-application.xml` file. See xref:deployment-descriptor-files.adoc#the-payara-application.xml-file[The payara-application.xml File].
...
The following table describes subelements for the `payara-application` element.

.`payara-application` Subelements
[cols="3,2,6",options="header"]
|===
|Element |Required |Description

a| xref:elements-of-deployment-descriptors.adoc#web[`web`]
|zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#security-role-mapping[`security-role-mapping`]
|zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#ejb-ref[`ejb-ref`]
|zero or more
a| Maps the absolute JNDI name to the `ejb-ref` in the
...
a| xref:elements-of-deployment-descriptors.adoc#resource-env-ref[`resource-env-ref`]
|zero or more
a|Maps the absolute JNDI name to the `resource-env-ref` in
...
a| xref:elements-of-deployment-descriptors.adoc#archive-name[`archive-name`]
|zero or one
|Specifies the name of the archive file.

a| xref:elements-of-deployment-descriptors.adoc#compatibility[`compatibility`]
|zero or one
|Specifies the Payara Server release with which to be backward compatible in terms of JAR visibility requirements for applications.

a| xref:elements-of-deployment-descriptors.adoc#keep-state[`keep-state`]
|zero or one
|Retains web sessions, stateful session bean instances, and persistently created EJB timers across redeployments.

a| xref:elements-of-deployment-descriptors.adoc#version-identifier[`version-identifier`]
|zero or one
|Contains version information for an application.

a| xref:elements-of-deployment-descriptors.adoc#classloading-delegate[`classloading-delegate`]
|zero or one
|Configures classloading delegation for the enterprise application.

a| xref:elements-of-deployment-descriptors.adoc#enable-implicit-cdi[`enable-implicit-cdi`]
|zero or one
|Enables implicit CDI bean scanning for the enterprise archive.

a| xref:elements-of-deployment-descriptors.adoc#scanning-exclude-and-scanning-include[`scanning-include`]
|zero or one
|Includes third party JAR files for CDI scanning using pattern matching.

a| xref:elements-of-deployment-descriptors.adoc#scanning-exclude-and-scanning-include[`scanning-exclude`]
|zero or one
|Excludes third party JAR files for CDI scanning using pattern matching.

a| xref:elements-of-deployment-descriptors.adoc#whitelist-package[`whitelist-package`]
|zero or one
|Marks packages to be whitelisted for extreme classloading isolation.

|===

[#properties-payara-application]
=== Properties

The following table describes properties for the `payara-application` element.

.`payara-application` Properties
[cols="3,2,6",options="header"]
|===
|Property |Default |Description
...
WARNING: When set using this property, this configuration will ALWAYS take effect and if set in the `payara-web.xml` or `payara-ejb-jar.xml` deployment descriptors, it will be ignored.
...
`payara-application-client` element in a `payara-application-client.xml` file. See xref:deployment-descriptor-files.adoc#the-payara-application-client.xml-file[The payara-application-client.xml file].
...
The following table describes subelements for the `payara-application-client` element.

.`payara-application-client` subelements
[cols="3,2,6",options="header"]
|===
|Element |Required |Description
...
a|  xref:elements-of-deployment-descriptors.adoc#ejb-ref[`ejb-ref`]
|zero or more
a|Maps the absolute JNDI name to the `ejb-ref` in the corresponding Jakarta EE XML file.
...
a| xref:elements-of-deployment-descriptors.adoc#java-web-start-access[`java-web-start-access`]
|zero or one
...
This is the root element; there can only be one `payara-ejb-jar` element in a `payara-ejb-jar.xml` file.
...
The following table describes subelements for the ``payara-ejb-jar` element.

.``payara-ejb-jar` Subelements
[cols="3,2,6",options="header"]
|===
|Element |Required |Description
...
a| xref:elements-of-deployment-descriptors.adoc#enterprise-beans[`enterprise-beans`]
|only one
...
a| xref:elements-of-deployment-descriptors.adoc#disable-nonportable-jndi-names[`disable-nonportable-jndi-names`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#webservice-default-login-config[`webservice-default-login-config`]
|zero or one
...
Defines Payara Server specific configuration for a web module. This is the root element; there can only be one `glassfish-web-app`/`payara-web-app` element in a `glassfish-web.xml` (deprecated)/`payara-web.xml` file.

See xref:deployment-descriptor-files.adoc#the-payara-web.xml-file[The glassfish-web.xml and payara-web.xml Files].
...
a| xref:elements-of-deployment-descriptors.adoc#context-root[`context-root`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#servlet[`servlet`]
|zero or more
a|Specifies a principal name for a servlet, which is used for the `run-as` role defined in `web.xml`.

a| xref:elements-of-deployment-descriptors.adoc#idempotent-url-pattern[`idempotent-url-pattern`]
|zero or more
|Specifies a URL pattern for idempotent requests.

a| xref:elements-of-deployment-descriptors.adoc#session-config[`session-config`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#resource-ref[`resource-ref`]
|zero or more
a|Maps the absolute JNDI name to the `resource-ref` in the
corresponding Jakarta EE XML file.
...
a| xref:elements-of-deployment-descriptors.adoc#cache[`cache`]
|zero or one
|Configures caching for web application components.

a| xref:elements-of-deployment-descriptors.adoc#class-loader[`class-loader`]
|zero or one
|Specifies class loader configuration information.

a| xref:elements-of-deployment-descriptors.adoc#jsp-config[`jsp-config`]
|zero or one
|Specifies JSP configuration information.

a| xref:elements-of-deployment-descriptors.adoc#parameter-encoding[`parameter-encoding`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#valve[`valve`]
|zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#jaxrs-roles-allowed-enabled[`jaxrs-roles-allowed-enabled`]
|zero or one
a|Configures out of the box support for the `@RolesAllowed` annotation in a web application.
...
a|`httpservlet-security-provider`
|none
a|(optional) Specifies the `HttpServlet` message layer provider that the web container's servlet `auth-constraint` processing calls.
...
For details, see xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`(1)].

CAUTION: Setting this property to `true` on Windows systems exposes JSP source code.

a|`alternatedocroot_n`
|none
a|
...
You can set this property for all the web applications on a specific virtual server. For details, see xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`].
...
virtual server. For details, see xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`].

a|`crossContextAllowed`
a|`true`
a|If `true`, allows this web application to access the contexts of other web applications using the `ServletContext.getContext()` method.

a|`relativeRedirectAllowed`
a|`false`
a|If `true`, allows this web application to send a relative URL to the client using `HttpServletResponse.sendRedirect()`, and instructs the web container not to translate any relative URLs to fully qualified ones.

a|`reuseSessionID`
a|`false`
a|If `true`, sessions generated for this web application use the session ID specified in the request.

a|`securePagesWithPragma`
a|`true`
a| Set this property to `false` to ensure that for this web application file downloads using SSL work properly in Internet Explorer.

You can set this property for all the web applications on a specific
virtual server. For details, see xref:../command-reference/create-virtual-server.adoc[`create-virtual-server`(1)].

a|`singleThreadedServletPoolSize`
a|`5`
a|Specifies the maximum number of servlet instances allocated for each `SingleThreadModel` servlet in the web application.

a|`tempdir`
a| `domain-dir/generated/app-name`

or

`domain-dir/generated/module-name`
a|Specifies a temporary directory for use by this web module. This value
...
a|`useResponseCTForHeaders`
a|`false`
a|If `true`, response headers are encoded using the response's charset instead of the default (UTF-8).
...
a|[.breakable]`container-initializer-enabled`
a|`true`
a|This property configures whether to enable or disable the calling of `ServletContainerInitializer` component classes defined in JAR files bundled inside a WAR assembly.
...
a|`cacheTTL`
a|`5000`
a|This property sets the time to live (TTL), in milliseconds, for the virtual server cache used when serving files.

It can also be applied to all web applications on a specific virtual server.
When set at the application level, this property overrides the virtual server configuration.
...
xref:elements-of-deployment-descriptors.adoc#work-security-map[`work-security-map`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`)
...
xref:elements-of-deployment-descriptors.adoc#security-role-mapping[`security-role-mapping`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`, `glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a|`no-of-retries`
a|`-1`
a|(optional) Specifies the number of times the load balancer retries an idempotent request. A value of `-1` indicates infinite retries.
...
a| xref:elements-of-deployment-descriptors.adoc#transport-config[`transport-config`]
|zero or one
|Specifies the security information for transport.

a| xref:elements-of-deployment-descriptors.adoc#as-context[`as-context`]
|zero or one
a|Specifies the authentication mechanism used to authenticate the client. If specified, it is `USERNAME_PASSWORD`.

a| xref:elements-of-deployment-descriptors.adoc#sas-context[`sas-context`]
|zero or one
...
xref:elements-of-deployment-descriptors.adoc#message[`message`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-applcation-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#method-name[`method-name`]
|only one
|Specifies a method name.

a| xref:elements-of-deployment-descriptors.adoc#method-params[`method-params`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#context-root[`context-root`]
|zero or one
a| Contains the context root for the Java Web Start enabled application client module. If none is specified, a default is generated. +
...
a| xref:elements-of-deployment-descriptors.adoc#eligible[`eligible`]
|zero or one
a|Specifies whether the application client module is eligible to be Java Web Start enabled. Allowed values are `true` (the default) and `false`.

a| xref:elements-of-deployment-descriptors.adoc#vendor[`vendor`]
|zero or one
a|Specifies the name of the vendor as it appears in Java Web Start download and launch screens. The default value is `Application Client`.

a| xref:elements-of-deployment-descriptors.adoc#jnlp-doc[`jnlp-doc`]
|zero or one
...
Azul Payara both support using the `@RolesAllowed` annotation out of the box to secure JAX-RS resources. In some cases this may clash with existing code that interprets the same annotation using custom code.
...
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`glassfish-web-app or payara-web-app`] (`glassfish-web-app.xml`)
...
a|`name`
|none
a|Specifies the name of the connection pool. A xref:jdbc-resource[`jdbc-resource`] element's `pool-name` attribute refers to this `name`.
...
a|`res-type`
|none
a|(optional) Specifies the interface the data source class implements.
...
a|`max-wait-time-in-millis`
a|`60000`
a|(optional) Specifies the amount of time, in milliseconds, that the caller is willing to wait for a connection. If `0`, the caller is blocked indefinitely until a resource is available or an error occurs.

a|`pool-resize-quantity`
a|`2`
a| (optional) Specifies the number of idle connections to be destroyed if the existing number of connections is above the `steady-pool-size` (subject to the `max-pool-size` limit).
...
a|`idle-timeout-in-seconds`
a|`300`
a| (optional) Specifies the maximum time that a connection can remain idle in the pool. After this amount of time, the pool can close this connection.
...
a|(optional) Specifies the transaction isolation level on the pooled database connections.
...
a|`is-isolation-level-guaranteed`
a|`true`
a|(optional) Applicable only when `transaction-isolation-level` is explicitly set.
...
a|`connection-validation-method`
a|`table`
a|
...
a|`validation-table-name`
|none
a|(optional) Specifies the table name to be used to perform a query to validate a connection. This parameter is mandatory if and only if `connection-validation-method` is set to `table`.

a|`validation-classname`
|none
a|(optional) Specifies the custom validation implementation class name. This parameter is mandatory if `connection-validation-method` is set to `custom-validation`.
...
a|`non-transactional-connections`
a|`false`
a|(optional) If `true`, non-transactional connections can be made to the JDBC connection pool.
These connections are not automatically enlisted with the transaction manager.

a|`allow-non-component-callers`
a|`false`
a|(optional) If `true`, non-Java-EE components, such as servlet filters, and third party persistence managers, can use this JDBC connection pool.
...
a|`validate-atmost-once-period-in-seconds`
a|`0`
a| (optional) Specifies the time interval within which a connection is validated at most once. Minimizes the number of validation calls.
...
a|`connection-leak-timeout-in-seconds`
a|`0`
a|(optional) Detects potential connection leaks by the application.
...
a|`connection-leak-reclaim`
a|`false`
a|(optional) If `true`, the pool will reclaim a connection after `connection-leak-timeout-in-seconds` occurs.
...
a|`connection-creation-retry-interval-in-seconds`
a|`10`
a|(optional) Specifies the time interval between attempts to create a connection when `connection-creation-retry-attempts` is greater than `0`.

a|`statement-leak-timeout-in-seconds`
a|`0`
a|(optional) Detects potential statement leaks by the application.
...
a|`statement-leak-reclaim`
a|`false`
a|(optional) If `true`, the reclaim of a statement after `statement-leak-timeout-in-seconds` occurs.

a|`statement-timeout-in-seconds`
a|`-1`
a| (optional) Sets the query timeout property of a statement to enable termination of abnormally long running queries. The default value of `-1` disables this feature.
...
a|`lazy-connection-enlistment`
a|`false`
a|(optional) If `true`, a connection is not enlisted in a transaction until it is used.
If `false`, any connection object available to a transaction is enlisted in the transaction.

a|`lazy-connection-association`
a|`false`
a|(optional) If `true`, a physical connection is not associated with a logical connection until it is used.
If `false`, a physical connection is associated with a logical connection even before it is used.

a|`associate-with-thread`
a|`false`
a| (optional) Specifies whether connections are associated with the thread to enable the thread to reuse the connections. If `true`, allows connections to be saved as `ThreadLocal` in the calling thread.
...
a|`max-connection-usage-count`
a|`0`
a|(optional) Specifies the number of times a connections is reused by the pool, after which it is closed. A zero value disables this feature.
...
a|`sql-trace-listeners`
|none
a|(optional) Specifies that SQL statements executed by applications need to be traced. Helps administrators analyze the statements.
...
a|`statement-cache-size`
a|`0`
a|(optional) Specifies the number of statements to be cached using the `lru` (Least Recently Used) caching mechanism. The default value of `0` disables statement caching.
...
a|`wrap-jdbc-objects`
a|`true`
a|(optional) If `true`, wrapped JDBC objects are returned for `Statement`, `PreparedStatement`, `CallableStatement`, `ResultSet`, and `DatabaseMetaData`.
...
a|`dynamic-reconfiguration-wait-timeout-in-seconds`
|none
a| Specifies the timeout for dynamic reconfiguration of the pool.
...
a|`number-of-top-queries-to-report`
a|`10`
a| Specifies the number of most frequently used queries to display. For example, the default value of `10` displays the top ten queries. +
...
a|`time-to-keep-queries-in-minutes`
a|`5`
a| Specifies the time to retain queries in a cache before they are purged. +
...
a|`description`
|none
a|(optional) Specifies a text description of this
element.

a|`pool-name`
|none
a|Specifies the `name` of the associated xref:elements-of-deployment-descriptors.adoc#jdbc-connection-pool[`jdbc-connection-pool`].

a|`object-type`
a|`user`
a| (optional) Defines the type of the resource. Allowed values are:
...
This information is alternatively specified within the xref:elements-of-deployment-descriptors.adoc#activation-config[`activation-config`] subelement of the xref:elements-of-deployment-descriptors.adoc#mdb-resource-adapter[`mdb-resource-adapter`] element.
For more information about JMS resources, see "xref:../../application-development/using-jakarta-messaging.adoc[Using the Jakarta Messaging]" in the Payara Server Application Development section.

[#superelements-92]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#ejb-ref[`ejb-ref`], xref:elements-of-deployment-descriptors.adoc#message-destination[`message-destination`],
xref:elements-of-deployment-descriptors.adoc#resource-env-ref[`resource-env-ref`], xref:elements-of-deployment-descriptors.adoc#resource-ref[`resource-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`,
`glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`); xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`], xref:elements-of-deployment-descriptors.adoc#mdb-connection-factory[`mdb-connection-factory`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
For information about the allowed contents of a custom JNLP file, see "xref:../../application-development/developing-java-clients.adoc#developing-java-clients[Developing Java Clients]" in the Payara Server Application Development section.
...
a|`checkInterval`
a|`0`
a|If `development` is set to `false` and `checkInterval` is greater than zero, background compilations are enabled. The `checkInterval` is the time in seconds between checks to see if a JSP file needs to be recompiled.

a|`classdebuginfo`
a|`true`
a|Specifies whether the generated Java servlets are compiled with the debug option set (`-g` for `javac`).
...
a|`compiler`
a|`javac`
a| Specifies the compiler Ant uses to compile JSP files. See the Ant
documentation for more information: https://ant.apache.org/manual/index.html

a|`compilerSourceVM`
|Depends on Payara Server's Java runtime
a| Specifies the JDK release with which source compatibility of the generated servlets is provided. Same as the `-source` release option of `javac`.

a|`compilerTargetVM`
|Depends on Payara Server's Java runtime
a| Specifies the Virtual Machine for the Java platform (JVM software) version for which the servlet class files are generated. Same as the `-target` release option of `javac`.

a|`defaultBufferNone`
a|`false`
a|If `true`, the default for the `buffer` attribute of the `page` directive is `none`.

a|`development`
a|`true`
a|If set to `true`, enables development mode, which allows JSP files to be checked for modification.
Specify the frequency at which JSPs are checked using the `modificationTestInterval` property.

a|`dumpSmap`
a|`false`
a|If set to `true`, dumps SMAP information for JSR 45 debugging to a file. Set to `false` if `suppressSmap` is `true`.

a|`enablePooling`
a|`true`
a|If set to `true`, tag handler pooling is enabled.

a|`enableTldValidation`
a|`false`
a|If set to `true`, all Tag Library Descriptor (TLD) files referenced by the web application are validated against their underlying schema or DTD file.

a|`errorOnUseBeanInvalidClassAttribute`
a|`false`
a|If set to `true`, issues an error when the value of the `class` attribute in a `useBean` action is not a valid bean class.
...
a|`genStrAsByteArray`
a|`true`
a|If `true`, text strings are generated as bytes (encoded with the page encoding), if the page is not buffered.

a|`genStrAsCharArray`
a|`false`
a|If set to `true`, generates text strings as `char` arrays, which improves performance in some cases.

a|`httpMethods`
a|`*` for all methods
a|Specifies a comma separated list of HTTP methods supported by the `JspServlet`.

a|`ieClassId`
a|`clsid:8AD9C840-044E-11D1-B3E9-00805F499D93`
a|Specifies the Java plug-in COM class ID for Internet Explorer. Used by the `<jsp:plugin>` tags.

a|`ignoreJspFragmentErrors`
a|`false`
a|If set to `true`, instructs the compiler to ignore any JSP precompilation errors pertaining to statically included JSP segments that, despite not being top level JSP files, use the `.jsp` or `.jspx` extension (instead of the recommended `.jspf`).

a|`initialCapacity`
a|`32`
a|Specifies the initial capacity of the `HashMap` that maps JSP files to their corresponding servlets.

a|`javaEncoding`
a|`UTF8`
a| Specifies the encoding for the generated Java servlet. This encoding is passed to the Java compiler that is used to compile the servlet as well. By default, the web container tries to use `UTF8`. If that fails, it tries to use the `javaEncoding` value.
For encodings, see: `https://docs.oracle.com/javase/8/docs/technotes/guides/intl/encoding.doc.html`

a|`keepgenerated`
a|`true` with JDK 5 and before and for `jspc`, otherwise `false`
a|If set to `true`, keeps the generated Java files. If `false`, deletes the Java files.

a|`mappedfile`
a|`true`
a|If set to `true`, generates static content with one print statement per input line, to ease debugging.

a|`modificationTestInterval`
a|`0`
a|Specifies the frequency in seconds at which JSPs are checked for modification. A value of `0` causes the JSP to be checked on every access. Used only if `development` is set to `true`.

a|`reload-interval`
a|`0`
a|Specifies the frequency in seconds at which JSP files are checked for modifications.
...
a|`saveBytecode`
a|`true` for `jspc`, otherwise `false`
a|If `true`, generated byte code is saved to `.class` files.
...
a|`suppressSmap`
a|`false`
a|If set to `true`, generation of SMAP information for JSR 45 debugging is suppressed.

a|`trimSpaces`
a|`false`
a|If set to `true`, trims white spaces in template text between actions or directives.

a|`usePrecompiled`
a|`false`
a| If set to `true`, an accessed JSP file is not compiled. Its precompiled servlet class is used instead.
...
If set to `true`, retains web sessions, stateful session bean instances, and persistently created EJB timers across redeployments. The `--keepstate` option of the xref:../command-reference/redeploy.adoc[`redeploy`] subcommand takes precedence. The default for both is `false`.
...
For web applications, this feature is applicable only if in the `payara-web.xml` file the `persistence-type` attribute of the xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] element is `file`.
...
xref:elements-of-deployment-descriptors.adoc#payara-application[`payara-application`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`payara-web.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-ejb-jar[``payara-ejb-jar`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a|`scope`
a|`request.parameter`
a|(optional) Specifies the scope from which the input parameter is retrieved. Allowed values are `context.attribute`, `request.header`, `request.parameter`, `request.cookie`, `session.id`, and `session.attribute`.
...
xref:elements-of-deployment-descriptors.adoc#gen-classes[`gen-classes`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#service-qname[`service-qname`],xref:elements-of-deployment-descriptors.adoc#wsdl-port[`wsdl-port`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a|`log-file`
a|`your-ACC-dir/logs/client.log`
...
a|`store-protocol`
a|`imap`
a|(optional) Specifies the storage protocol service, which connects to a mail server, retrieves messages, and saves messages in folder(s). Allowed values are `imap`, `pop3`, `imaps`, and `pop3s` .

a|`store-protocol- class`
a|`org.eclipse.angus.mail.imap.IMAPStore`
a| (optional) Specifies the service provider implementation class for storage. Allowed values are:
...
a|`smtp`
a|(optional) Specifies the transport protocol service, which sends messages. Allowed values are `smtp` and `smtps`.

a|`transport-protocol-class`
a|`org.eclipse.angus.mail.smtp.SMTPTransport`
a| (optional) Specifies the service provider implementation class for transport. Allowed values are:
...
xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a|`maxSessions`
a|`-1`
a| Specifies the maximum number of sessions that are permitted in the cache, or `-1` for no limit. After this, an attempt to create a new session causes an `IllegalStateException` to be thrown. +

If the `persistence-type` attribute of the parent xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] element is `file`, the session manager passivates sessions to the persistent store when this maximum is reached.
a|`sessionFilename`
|empty string
a| Specifies the absolute or relative path to the directory in which the session state is preserved between application restarts, if preserving the state is possible.
...
xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] element is `memory`.

a|`persistenceFrequency`
a|`web-method`
a| Specifies how often the session state is stored. Allowed values are as follows:
...
+
Applicable only if the `persistence-type` attribute of the parent xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] element is `hazelcast`.
...
xref:elements-of-deployment-descriptors.adoc#bean-pool[`bean-pool`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#default-resource-principal[`default-resource-principal`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#resource-adapter-mid[`resource-adapter-mid`]
|zero or one
|Specifies a resource adapter module ID.

a| xref:elements-of-deployment-descriptors.adoc#activation-config[`activation-config`]
|one or more
...
xref:elements-of-deployment-descriptors.adoc#message-security[`message-security`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#java-method[`java-method`]
|zero or one
|Specifies the methods or operations to which message security requirements apply.

a| xref:elements-of-deployment-descriptors.adoc#operation-name[`operation-name`]
|zero or one
...
a|xref:elements-of-deployment-descriptors.adoc#message-destination-name[`message-destination-name`]
|only one
...
a|xref:elements-of-deployment-descriptors.adoc#jndi-name[`jndi-name`]
|only one
a|Specifies the `jndi-name` of the associated entity.
...
xref:elements-of-deployment-descriptors.adoc#message-destination[`message-destination`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#message-destination-ref-name[`message-destination-ref-name`]
|only one
...
xref:elements-of-deployment-descriptors.adoc#message-destination-ref[`message-destination-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
* If the grandparent element is xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`], these requirements pertain to request and response messages of the endpoint.
* If the grandparent element is xref:elements-of-deployment-descriptors.adoc#port-info[`port-info`], these requirements pertain to the port of the referenced service.

[#superelements-120]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#message-security-binding[`message-security-binding`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#message[`message`]
|one or more
|Specifies the methods or operations to which message security requirements apply.

a| xref:elements-of-deployment-descriptors.adoc#request-protection[`request-protection`]
|zero or one
|Defines the authentication policy requirements of the application's request processing.

a| xref:elements-of-deployment-descriptors.adoc#response-protection[`response-protection`]
|zero or one
...
Specifies a custom authentication provider binding for a parent xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`] or xref:elements-of-deployment-descriptors.adoc#port-info[`port-info`] element in one or both of these ways:
...
xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`], xref:elements-of-deployment-descriptors.adoc#port-info[`port-info`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#message-security[`message-security`]
|zero or more
|Specifies message security requirements.
...
a|`auth-layer`
|none
a|Specifies the message layer at which authentication is performed. The value must be `SOAP`.

a|`provider-id`
|none
a| (optional) Specifies the authentication provider used to satisfy application-specific message security requirements. +
...
a| xref:elements-of-deployment-descriptors.adoc#provider-config[`provider-config`]
|one or more
...
xref:elements-of-deployment-descriptors.adoc#checkpoint-at-end-of-method[`checkpoint-at-end-of-method`],
xref:elements-of-deployment-descriptors.adoc#flush-at-end-of-method[`flush-at-end-of-method`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#method-intf[`method-intf`]
|zero or one
...
xref:elements-of-deployment-descriptors.adoc#java-method[`java-method`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`); xref:elements-of-deployment-descriptors.adoc#method[`method`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#method-params[`method-params`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
xref:elements-of-deployment-descriptors.adoc#java-method[`java-method`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`);
xref:elements-of-deployment-descriptors.adoc#method[`method`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#method-param[`method-param`]
|zero or more
|Specifies the fully qualified Java type name of a method parameter.
...
xref:elements-of-deployment-descriptors.adoc#call-property[`call-property`], xref:elements-of-deployment-descriptors.adoc#default-resource-principal[`default-resource-principal`], xref:elements-of-deployment-descriptors.adoc#stub-property[`stub-property`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`); xref:elements-of-deployment-descriptors.adoc#enterprise-beans[`enterprise-beans`], xref:elements-of-deployment-descriptors.adoc#principal[`principal`], xref:elements-of-deployment-descriptors.adoc#property-with-subelements[`property` (with subelements)] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#message[`message`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
If both the xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] and xref:elements-of-deployment-descriptors.adoc#locale-charset-info[`locale-charset-info`] elements have `parameter-encoding` subelements, the subelement of `payara-web-app` takes precedence.
For encodings, see `https://docs.oracle.com/javase/8/docs/technotes/guides/intl/encoding.doc.html`.

[#superelements-134]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#locale-charset-info[`locale-charset-info`], xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a|`form-hint-field`
|none
a|(optional) The name of the hidden field in the form. This field specifies the character encoding the web container uses for `request.getParameter` and `request.getReader` calls when the charset is not set in the request's `content-type` header.
...
The setting of this element in the `payara-application.xml` file applies to all EJB modules in the application. For an individually deployed EJB module, you can set the same element in the `payara-ejb-jar.xml` file.
If `pass-by-reference` is used at both the bean and application level, the bean level takes precedence.

[#superelements-135]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#payara-application[`payara-application`] (`payara-application.xml`),
xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#default-resource-principal[`default-resource-principal`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
xref:elements-of-deployment-descriptors.adoc#service-ref[`service-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#service-endpoint-interface[`service-endpoint-interface`]
|zero or one
a|Specifies the web service reference name relative to `java:comp/env`.

a| xref:elements-of-deployment-descriptors.adoc#wsdl-port[`wsdl-port`]
|zero or one
|Specifies the WSDL port.

a| xref:elements-of-deployment-descriptors.adoc#stub-property[`stub-property`]
|zero or more
a|Specifies JAX-RPC property values that are set on a `javax.xml.rpc.Stub` object before it is returned to the web service client.

a| xref:elements-of-deployment-descriptors.adoc#call-property[`call-property`]
|zero or more
a|Specifies JAX-RPC property values that are set on a `javax.xml.rpc.Call` object before it is returned to the web service client.

a| xref:elements-of-deployment-descriptors.adoc#message-security-binding[`message-security-binding`]
|zero or one
...
xref:elements-of-deployment-descriptors.adoc#security-role-mapping[`security-role-mapping`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`, `glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`), xref:elements-of-deployment-descriptors.adoc#servlet[`servlet`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a|`class-name`
a|`com.sun.enterprise.deployment.PrincipalImpl`
...
xref:elements-of-deployment-descriptors.adoc#cache[`cache`], xref:elements-of-deployment-descriptors.adoc#cache-helper[`cache-helper`],
xref:elements-of-deployment-descriptors.adoc#class-loader[`class-loader`], xref:elements-of-deployment-descriptors.adoc#cookie-properties[`cookie-properties`],
xref:elements-of-deployment-descriptors.adoc#default-helper[`default-helper`], xref:elements-of-deployment-descriptors.adoc#manager-properties[`manager-properties`],
xref:elements-of-deployment-descriptors.adoc#session-properties[`session-properties`], xref:elements-of-deployment-descriptors.adoc#store-properties[`store-properties`],
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`], xref:elements-of-deployment-descriptors.adoc#valve[`valve`],
xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`);
xref:elements-of-deployment-descriptors.adoc#auth-realm[`auth-realm`], xref:elements-of-deployment-descriptors.adoc#client-container[`client-container`],
xref:elements-of-deployment-descriptors.adoc#client-credential[`client-credential`], xref:elements-of-deployment-descriptors.adoc#log-service[`log-service`],
xref:elements-of-deployment-descriptors.adoc#provider-config[`provider-config`] (`sun-acc.xml`);
xref:elements-of-deployment-descriptors.adoc#admin-object-resource[`admin-object-resource`],
xref:elements-of-deployment-descriptors.adoc#connector-connection-pool[`connector-connection-pool`],
xref:elements-of-deployment-descriptors.adoc#connector-resource[`connector-resource`], xref:elements-of-deployment-descriptors.adoc#custom-resource[`custom-resource`],
xref:elements-of-deployment-descriptors.adoc#external-jndi-resource[`external-jndi-resource`],
xref:elements-of-deployment-descriptors.adoc#jdbc-connection-pool[`jdbc-connection-pool`], xref:jdbc-resource[`jdbc-resource`],
xref:elements-of-deployment-descriptors.adoc#mail-resource[`mail-resource`], xref:elements-of-deployment-descriptors.adoc#resource-adapter-config[`resource-adapter-config`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
xref:elements-of-deployment-descriptors.adoc#enterprise-beans[`enterprise-beans`],
xref:elements-of-deployment-descriptors.adoc#webservice-endpoint[`webservice-endpoint`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#message-security-config[`message-security-config`] (`sun-acc.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#request-policy[`request-policy`]
|zero or one
|Defines the authentication policy requirements of the authentication provider's request processing.

a| xref:elements-of-deployment-descriptors.adoc#response-policy[`response-policy`]
|zero or one
...
a|`provider-type`
|none
a|Specifies whether the provider is a `client`, `server`, or `client-server` authentication provider.

a|`class-name`
|none
a|Specifies the Jakarta implementation class of the provider. Client authentication providers must implement the com.sun.enterprise.security.jauth.ClientAuthModule interface.
...
For more information about realms, see "xref:../../application-development/securing-applications.adoc#realm-configuration[Realm Configuration]" in the Payara Server Application Development section.

[#superelements-155]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#payara-application[`payara-application`] (`glassfish-application.xml` (deprecated) and `payara-application.xml`), xref:elements-of-deployment-descriptors.adoc#as-context[`as-context`],  xref:elements-of-deployment-descriptors.adoc#login-config[`login-config`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a|`scope`
a|`request.parameter`
a|(optional) Specifies the scope from which the input parameter is retrieved. Allowed values are
...
For related information, see  xref:elements-of-deployment-descriptors.adoc#cache-idle-timeout-in-seconds[`cache-idle-timeout-in-seconds`].
...
a|`auth-source`
|none
a|Specifies the type of required authentication, either `sender` (user name and password) or `content` (digital signature).

a|`auth-recipient`
|none
a|Specifies whether recipient authentication occurs before or after content authentication. Allowed values are `before-content` and `after-content`.
...
xref:elements-of-deployment-descriptors.adoc#auth-method[`auth-method`] element must be used for client authentication. The value is `true` or `false` (the default).
...
xref:elements-of-deployment-descriptors.adoc#resource-ref[`resource-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml`)
...
* Created, if a request arrives when the pool has less than xref:elements-of-deployment-descriptors.adoc#steady-pool-size[`steady-pool-size`] quantity of beans (applies to pools only
for creation). If the pool has more than `steady-pool-size` minus xref:elements-of-deployment-descriptors.adoc#resize-quantity[`resize-quantity`] of beans, then `resize-quantity` is still created.
* Removed, when the xref:elements-of-deployment-descriptors.adoc#pool-idle-timeout-in-seconds[`pool-idle-timeout-in-seconds`] timer
expires and a cleaner thread removes any unused instances.

** For caches, when xref:elements-of-deployment-descriptors.adoc#max-cache-size[`max-cache-size`] is reached, `resize-quantity` beans are selected for passivation using the
xref:elements-of-deployment-descriptors.adoc#victim-selection-policy[`victim-selection-policy`]. In addition, the xref:elements-of-deployment-descriptors.adoc#cache-idle-timeout-in-seconds[`cache-idle-timeout-in-seconds`] or
xref:elements-of-deployment-descriptors.adoc#removal-timeout-in-seconds[`removal-timeout-in-seconds`] timers passivate beans from the cache.

** For pools, when the xref:elements-of-deployment-descriptors.adoc#max-pool-size[`max-pool-size`] is reached, `resize-quantity` beans are selected for removal.
In addition, the xref:elements-of-deployment-descriptors.adoc#pool-idle-timeout-in-seconds[`pool-idle-timeout-in-seconds`] timer removes beans until `steady-pool-size` is reached.
...
xref:elements-of-deployment-descriptors.adoc#bean-cache[`bean-cache`], xref:elements-of-deployment-descriptors.adoc#bean-pool[`bean-pool`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a|`name`
|none
a|(optional) Not used. See `resource-adapter-name`.
...
a|`resource-adapter-name`
|none
a|Specifies the name of a deployed connector module or application. If the resource adapter is embedded in an application, then it is `app_name#rar_name`.
...
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`),
xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`),
xref:elements-of-deployment-descriptors.adoc#payara-application-client[``payara-application-client`] (`glassfish-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#resource-env-ref-name[`resource-env-ref-name`]
|only one
a|Specifies the `res-ref-name` in the corresponding Jakarta EE deployment descriptor file `resource-env-ref` entry.
...
xref:elements-of-deployment-descriptors.adoc#resource-env-ref[`resource-env-ref`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#res-ref-name[`res-ref-name`]
|only one
a|Specifies the `res-ref-name` in the corresponding Jakarta EE deployment descriptor file `resource-ref` entry.
...
See xref:deployment-descriptor-files.adoc#the-payara-resources.xml-file[The glassfish-resources.xml and payara-resources Files].
...
a| xref:elements-of-deployment-descriptors.adoc#custom-resource[`custom-resource`]
|zero or more
|Defines a custom resource.

a| xref:elements-of-deployment-descriptors.adoc#external-jndi-resource[`external-jndi-resource`]
|zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#mail-resource[`mail-resource`]
|zero or more
|Defines a Jakarta Mail resource.

a| xref:elements-of-deployment-descriptors.adoc#admin-object-resource[`admin-object-resource`]
|zero or more
|Defines an administered object for an inbound resource adapter.

a| xref:elements-of-deployment-descriptors.adoc#connector-resource[`connector-resource`]
|zero or more
|Defines a connector (resource adapter) resource.

a| xref:elements-of-deployment-descriptors.adoc#resource-adapter-config[`resource-adapter-config`]
|zero or more
|Defines a resource adapter configuration.

a| xref:elements-of-deployment-descriptors.adoc#jdbc-connection-pool[`jdbc-connection-pool`]
|zero or more
|Defines the properties that are required for creating a JDBC connection pool.

a| xref:elements-of-deployment-descriptors.adoc#connector-connection-pool[`connector-connection-pool`]
|zero or more
|Defines the properties that are required for creating a connector connection pool.

a| xref:elements-of-deployment-descriptors.adoc#work-security-map[`work-security-map`]
|zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#caller-propagation[`caller-propagation`]
|only one
|Specifies whether the target accepts propagated caller identities. The values are NONE, SUPPORTED, or REQUIRED.
...
Both the `payara-application.xml` and the `payara-web.xml` files support the following directives:
...
a| xref:elements-of-deployment-descriptors.adoc#ssl[`ssl`]
|only one
|Specifies the SSL processing parameters.

a| xref:elements-of-deployment-descriptors.adoc#cert-db[`cert-db`]
|only one
...
This is different from a xref:elements-of-deployment-descriptors.adoc#work-security-map[`work-security-map`], which maps a principal associated with an incoming work instance to a principal in the Payara Server's security domain.

[#superelements-180]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#connector-connection-pool[`connector-connection-pool`] (`glassfish-resources.xml` (deprecated) and `payara-resources.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#user-group[`user-group`]
|one or more
|Contains the group to which the principal belongs.

a| xref:elements-of-deployment-descriptors.adoc#backend-principal[`backend-principal`]
|only one
...
Maps roles to users or groups in the currently active realm. See "xref:../../application-development/securing-applications.adoc#realm-configuration[Realm Configuration]" in the Payara Server Application Development section.
...
a| xref:elements-of-deployment-descriptors.adoc#role-name[`role-name`]
|only one
a|Contains the `role-name` in the `security-role` element of the corresponding Jakarta EE deployment descriptor file.

a| xref:elements-of-deployment-descriptors.adoc#principal-name[`principal-name`]
a|one or more if no `group-name`, otherwise zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#group-name[`group-name`]
a|one or more if no `principal-name`, otherwise zero or more
...
a| xref:elements-of-deployment-descriptors.adoc#namespaceuri[`namespaceURI`]
|only one
|Specifies the namespace URI.

a| xref:elements-of-deployment-descriptors.adoc#localpart[`localpart`]
|only one
|Specifies the local part of a QNAME.
...
a| xref:elements-of-deployment-descriptors.adoc#service-ref-name[`service-ref-name`]
|only one
a|Specifies the web service reference name relative to `java:comp/env`.

a| xref:elements-of-deployment-descriptors.adoc#port-info[`port-info`]
|zero or more
|Specifies information for a port within a web service reference.

a| xref:elements-of-deployment-descriptors.adoc#call-property[`call-property`]
|zero or more
a|Specifies JAX-RPC property values that can be set on a `javax.xml.rpc.Call` object before it is returned to the web service client.

a| xref:elements-of-deployment-descriptors.adoc#wsdl-override[`wsdl-override`]
|zero or one
|Specifies a valid URL pointing to a final WSDL document.

a| xref:elements-of-deployment-descriptors.adoc#service-impl-class[`service-impl-class`]
|zero or one
|Specifies the name of the generated service implementation class.

a| xref:elements-of-deployment-descriptors.adoc#service-qname[`service-qname`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#servlet-name[`servlet-name`]
|only one
a|Contains the name of a servlet, which is matched to a `servlet-name` in `web.xml`.
...
xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`], xref:elements-of-deployment-descriptors.adoc#servlet[`servlet`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`]
|zero or one
|Specifies session manager configuration information.

a| xref:elements-of-deployment-descriptors.adoc#session-properties[`session-properties`]
|zero or one
|Specifies session properties.

a| xref:elements-of-deployment-descriptors.adoc#cookie-properties[`cookie-properties`]
|zero or one
|Specifies session cookie properties.
...
a| xref:elements-of-deployment-descriptors.adoc#manager-properties[`manager-properties`]
|zero or one
|Specifies session manager properties.

a| xref:elements-of-deployment-descriptors.adoc#store-properties[`store-properties`]
|zero or one
...
a|`persistence-type`
a|`memory`
a| (optional) Specifies the session persistence mechanism. Allowed values are `memory`, `file`, and `hazelcast`.
...
a|`timeoutSeconds`
a|`1800`
a| Specifies the default maximum inactive interval (in seconds) for all sessions created in this web module. If set to `0` or less, sessions in this web module never expire. +
...
a|`enableCookies`
a|`true`
a|Uses cookies for session tracking if set to `true`.

a|`enableURLRewriting`
a|`true`
a|Enables URL rewriting. This provides session tracking via URL rewriting when the browser does not accept cookies. You must also use an `encodeURL` or `encodeRedirectURL` call in the servlet or JSP.
...
a|`cert-nickname`
a|`s1as`
a|(optional) The nickname of the server certificate in the certificate database or the PKCS#11 token.
...
a|`ssl2-ciphers`
|none
a|(optional) A comma-separated list of the SSL2 ciphers to be used.
...
a|`ssl3-tls-ciphers`
|none
a|(optional) A comma-separated list of the SSL3 and/or TLS ciphers to be used.
...
a|`directory`
a|`domain-dir/generated/jsp/app-name/module-name_war`
a| Specifies the absolute or relative pathname of the directory into which individual session files are written.
A relative path is relative to the temporary work directory for this web module. +

Applicable only if the `persistence-type` attribute of the parent xref:elements-of-deployment-descriptors.adoc#session-manager[`session-manager`] element is `file`.

a|`persistenceScope`
a|`session`
a| Specifies how much of the session state is stored. Allowed values are as follows:
...
a|  xref:elements-of-deployment-descriptors.adoc#security[`security`]
|zero or one
...
a|`port`
|none
a| Specifies the naming service port number of the server to which this client attaches. +
...
Specifies the xref:elements-of-deployment-descriptors.adoc#cache-mapping[`cache-mapping`] specific maximum amount of time in seconds that an entry can remain in the cache after it is created or refreshed.
If not specified, the default is the value of the `timeout` attribute of the xref:elements-of-deployment-descriptors.adoc#cache[`cache`] element.
...
a|`name`
|none
a|Specifies the timeout input parameter, whose value is interpreted in seconds. The field's type must be `java.lang.Long` or `java.lang.Integer`.

a|`scope`
a|`request.attribute`
a|(optional) Specifies the scope from which the input parameter is retrieved.
...
a| xref:elements-of-deployment-descriptors.adoc#integrity[`integrity`]
|only one
|Specifies if the target supports integrity-protected messages. The values are NONE, SUPPORTED, or REQUIRED.

a| xref:elements-of-deployment-descriptors.adoc#confidentiality[`confidentiality`]
|only one
|Specifies if the target supports privacy-protected messages. The values are NONE, SUPPORTED, or REQUIRED.

a| xref:elements-of-deployment-descriptors.adoc#establish-trust-in-target[`establish-trust-in-target`]
|only one
|Specifies if the target is capable of authenticating to a client. The values are NONE, SUPPORTED, or REQUIRED.

a| xref:elements-of-deployment-descriptors.adoc#establish-trust-in-client[`establish-trust-in-client`]
|only one
...
xref:elements-of-deployment-descriptors.adoc#call-property[`call-property`], xref:elements-of-deployment-descriptors.adoc#stub-property[`stub-property`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`, `glassfish-application-client.xml` (deprecated) and `payara-application-client.xml``); xref:elements-of-deployment-descriptors.adoc#property-with-subelements[`property` (with subelements)] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
Specifies a custom valve for this web application. You can define a valve for all the web applications on a specific virtual server. For details, see xref:../command-reference/create-virtual-server.adoc#create-virtual-server[`create-virtual-server`].
...
a|`class-name`
|none
a|Specifies the fully qualified class name of the valve. The valve class must implement the `org.apache.catalina.Valve` interface from Tomcat or previous Payara Server releases, or the `org.glassfish.web.valve.GlassFishValve` interface from the current Payara Server release.
...
Contains version information for an application or module. For more information about application versioning, see xref:../../../index.adoc#module-and-application-versions[Module and Application Versions].
...
a| xref:elements-of-deployment-descriptors.adoc#web-uri[`web-uri`]
|only one
...
When declaring a secured Web Service based on an EJB using the `payara-ejb-jar.xml` deployment descriptor, it's necessary to define the login configuration (authentication method, security realm name, etc.) for each EJB Web Service that is secured inside the assembly.
...
<!DOCTYPE payara-ejb-jar PUBLIC "-//Payara.fish//DTD Payara Application Server 7 EJB 4.0 Revision 1//EN" "https://raw.githubusercontent.com/payara/Payara/refs/heads/main/appserver/deployment/dtds/src/main/resources/glassfish/lib/dtds/payara7-ejb-jar_4_0-1.dtd">
<payara-ejb-jar>
    <enterprise-beans>
        <ejb>
...
a| xref:elements-of-deployment-descriptors.adoc#webservice-description-name[`webservice-description-name`]
|only one
|Specifies a unique name for the web service within a web or EJB module.

a| xref:elements-of-deployment-descriptors.adoc#wsdl-publish-location[`wsdl-publish-location`]
|zero or one
...
xref:elements-of-deployment-descriptors.adoc#webservice-description[`webservice-description`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
xref:elements-of-deployment-descriptors.adoc#servlet[`servlet`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`), xref:elements-of-deployment-descriptors.adoc#ejb[`ejb`] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
...
a| xref:elements-of-deployment-descriptors.adoc#port-component-name[`port-component-name`]
|only one
|Specifies a unique name for a port component within a web or EJB module.

a| xref:elements-of-deployment-descriptors.adoc#endpoint-address-uri[`endpoint-address-uri`]
|zero or one
|Specifies the automatically generated endpoint address.

a| xref:elements-of-deployment-descriptors.adoc#login-config[`login-config`]
|zero or one
...
a| xref:elements-of-deployment-descriptors.adoc#transport-guarantee[`transport-guarantee`]
|zero or one
a|Specifies that the communication between client and server is `NONE`, `INTEGRAL`, or `CONFIDENTIAL`.

a| xref:elements-of-deployment-descriptors.adoc#service-qname[`service-qname`]
|zero or one
|Specifies the WSDL service element that is being referenced.

a| xref:elements-of-deployment-descriptors.adoc#tie-class[`tie-class`]
|zero or one
|Specifies the automatically generated name of a tie implementation class for a port component.

a| xref:elements-of-deployment-descriptors.adoc#servlet-impl-class[`servlet-impl-class`]
|zero or one
|Specifies the automatically generated name of the generated servlet implementation class.

a| xref:elements-of-deployment-descriptors.adoc#debugging-enabled[`debugging-enabled`]
|zero or one
a|Specifies whether the debugging servlet is enabled for this web service endpoint. Allowed values are `true` and `false` (the default).

a| xref:elements-of-deployment-descriptors.adoc#property-with-attributes[`property` (with attributes)] (`glassfish-web.xml` (deprecated) and `payara-web.xml`) xref:elements-of-deployment-descriptors.adoc#property-with-subelements[`property` (with subelements)] (`glassfish-ejb-jar.xml` (deprecated) and `payara-ejb-jar.xml`)
|zero or more
|Specifies a property, which has a name and a value.
...
This element can be used to whitelist packages on xref:../../application-development/class-loaders.adoc#extreme-classloading-isolation[*extreme class loading isolation*].

Whitelisted packages are taken into account by the server when scanning libraries.

For more information about how extreme class loading isolation works on Payara Server, see the xref:../../application-development/class-loaders.adoc#enhanced-classloading[Enhanced Classloading] section.

[#superelements-219-1]
=== Superelements

xref:elements-of-deployment-descriptors.adoc#payara-application[``payara-application`] (`glassfish-application.xml` (deprecated) and `payara-application.xml``),
xref:elements-of-deployment-descriptors.adoc#payara-web-app[`glassfish-web-app` or `payara-web-app`] (`payara-web.xml`)
...
This is different from a xref:elements-of-deployment-descriptors.adoc#security-map[`security-map`], which maps the principal received during servlet or EJB authentication to the credentials accepted by the EIS.
...
a| xref:elements-of-deployment-descriptors.adoc#principal-map[`principal-map`]
|zero or more
|Maps an EIS principal to a principal defined in the Payara Server domain.

a| xref:elements-of-deployment-descriptors.adoc#group-map[`group-map`]
|zero or more
|Maps an EIS group to a group defined in the Payara Server domain.
