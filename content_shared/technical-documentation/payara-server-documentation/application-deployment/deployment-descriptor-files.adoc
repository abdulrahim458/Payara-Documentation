...
"https://gitlab.azulsystems.com/docs/payara/-/raw/main-7/content_shared/appendix/schemas/payara7-application_11-1.dtd">
<payara-application>
...
"https://gitlab.azulsystems.com/docs/payara/-/raw/main-7/content_shared/appendix/schemas/payara7-ejb-jar_4_0-1.dtd">
<payara-ejb-jar>
    <enterprise-beans>
        <ejb>
