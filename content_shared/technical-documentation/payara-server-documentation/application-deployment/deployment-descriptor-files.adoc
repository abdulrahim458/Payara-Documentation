...
:page-description: Payara deployment descriptor files — reference for payara-web.xml, payara-ejb-jar.xml, payara-application.xml, and other Payara-specific deployment descriptors.
:ordinal: 3

This appendix describes the element hierarchies in the Azul Payara deployment descriptors that are supported on top of the standard Jakarta EE deployment descriptors.

[#about-the-payara-platform-deployment-descriptors]
== About the Azul Payara Deployment Descriptors
...
.Azul Payara Deployment Descriptors and DTDs

[cols="3,3,4",options="header"]
|===
|Deployment Descriptor |DTD File |Description

a| `glassfish-application.xml` (deprecated)

`payara-application.xml`
a| `glassfish-application_6_0-1.dtd` (deprecated)

`payara6-application_10_0-0.dtd` (deprecated)

`payara-application_11_0-0.dtd` (deprecated)

`payara7-application_11_0-1.dtd`
...
`payara-web.xml`
a| `glassfish-web-app_3_0-1.dtd` (deprecated)

`payara-web-app_4.dtd` (deprecated)

`payara6-web-app_6_0-0.dtd` (deprecated)

`payara-web-app_6_1-0.dtd` (deprecated)

`payara7-web-app_6_1-1.dtd`

| Configures a web application (WAR file).

a| `glassfish-ejb-jar.xml` (deprecated)

`payara-ejb-jar.xml`
a| `glassfish-ejb-jar_3_1-1.dtd` (deprecated)

`payara6-ejb-jar_4_0-0.dtd` (deprecated)

`payara-ejb-jar_4_0-0.dtd` (deprecated)

`payara7-ejb-jar_4_0-1.dtd`
|Configures an enterprise bean (EJB JAR file).

a| `glassfish-application-client.xml` (deprecated)

`payara-application-client.xml`
a| `glassfish-application-client_6_0-1.dtd`

`payara6-application-client_10_0-0.dtd` (deprecated)

`payara-application-client_11_0-0.dtd` (deprecated)

`payara7-application-client_11_0-1.dtd`
...
a|[.breakable]`glassfish-resources_1_5.dtd` (deprecated)

`payara-resources_1_8.dtd`
| Configures application-scoped resources.

a| `sun-acc.xml` (deprecated)

`glassfish-acc.xml` (deprecated)

`payara-acc.xml`
a| `sun-application-client-container_1_2.dtd` (deprecated)

`glassfish-application-client-container_1_3.dtd` (deprecated)

`payara6-application-client-container_1_4-0.dtd` (deprecated)

`payara-application-client-container_1_4.dtd` (deprecated)

`payara7-application-client-container_1_4-1.dtd`
a| Configures the Application Client Container.
...
IMPORTANT: Deployment descriptors whose names start with the `glassfish-` prefix are referred as "original" deployment descriptor files from Eclipse GlassFish, since these files names and DTDs were created while supporting Eclipse GlassFish and their support has been inherited by Azul Payara.
...
Payara Application Server 7 Jakarta EE Application 11 Revision 1//EN"
"https://raw.githubusercontent.com/payara/Payara/refs/heads/main/appserver/deployment/dtds/src/main/resources/glassfish/lib/dtds/payara7-application_11-1.dtd">
<payara-application>
...
DTD Payara Application Server 7 EJB 4.0 Revision 1//EN"
"https://raw.githubusercontent.com/payara/Payara/refs/heads/main/appserver/deployment/dtds/src/main/resources/glassfish/lib/dtds/payara7-ejb-jar_4_0-1.dtd">
<payara-ejb-jar>
    <enterprise-beans>
        <ejb>
