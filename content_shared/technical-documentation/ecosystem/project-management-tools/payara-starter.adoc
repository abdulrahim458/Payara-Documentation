...
WARNING: Keep in mind that versions older than `11` are not supported in Payara Platform {release-id}
...
WARNING: For compatibility with the Payara Platform {release-id}, versions older than `10` are not supported.
