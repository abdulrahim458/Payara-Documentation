...
WARNING: Keep in mind that versions older than `11` are not supported in Payara Platform {version}
...
WARNING: For compatibility with the Payara Platform {version}, versions older than `10` are not supported.
