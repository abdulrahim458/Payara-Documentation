...
:page-description: Payara Micro Maven Archetype — generate a skeleton Jakarta EE project targeting Payara Micro with pre-configured pom.xml, MicroProfile dependencies, and deployment setup.
:ordinal: 3
