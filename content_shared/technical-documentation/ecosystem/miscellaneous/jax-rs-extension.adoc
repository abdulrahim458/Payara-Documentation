= JAX-RS Extension
:page-description: JAX-RS extension for Azul Payara — additional MVC and REST capabilities beyond the standard Jakarta RESTful Web Services API in Payara Server and Payara Micro.
