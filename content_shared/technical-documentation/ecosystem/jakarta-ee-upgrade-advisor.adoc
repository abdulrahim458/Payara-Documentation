...
:page-description: Jakarta EE Upgrade Advisor for Azul Payara — tool for analyzing Java EE 8 applications and recommending changes needed to migrate to Jakarta EE 10 namespace and APIs.
:ordinal: 4
