...
:page-description: AWS STS integration with the Amazon SQS Cloud Connector for Azul Payara — use AWS Security Token Service to assume roles for temporary SQS access credentials.
...
image::cloud-connectors/sqs-connector/sqs-role-policy.png[Amazon IAM Role Policy - Trust Relationship,width=100%]
