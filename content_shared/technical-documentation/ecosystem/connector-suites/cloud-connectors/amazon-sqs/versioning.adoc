...
:page-description: Amazon SQS Cloud Connector versioning for Azul Payara — version compatibility matrix between Payara Server releases and the SQS JCA connector artifact versions.
...
The `amazon-sqs-rar-0.8.0.rar` JCA adapter has to be deployed as shown in the xref:../index.adoc#Installing-a-connector[Installing a connector section] of the Cloud Connectors overview.
