...
The `amazon-sqs-rar-0.8.0.rar` JCA adapter has to be deployed as shown in the xref:technical-documentation/ecosystem/connector-suites/cloud-connectors/index.adoc#Installing-a-connector[Installing a connector section] of the Cloud Connectors overview.
