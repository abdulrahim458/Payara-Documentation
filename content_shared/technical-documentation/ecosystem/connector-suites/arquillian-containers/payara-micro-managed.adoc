...
:page-description: Payara Micro Managed Arquillian container adapter — run Jakarta EE integration tests with Arquillian by launching and managing a Payara Micro instance per test suite.
