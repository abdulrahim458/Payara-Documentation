...
:page-description: Payara VS Code Extension — manage Payara Server and Payara Micro from Visual Studio Code. Deploy Jakarta EE applications, hot deploy, and run MicroProfile projects.
...
image::vscode-extension/install-marketplace.png[Visual Studio Marketplace,width=100%]

[#vscode-tools]
== Azul Payara Tools

* xref:payara-server.adoc[Payara Server] - The Payara VS Code extension enables developers to easily configure Payara Server and manage applications from Visual Studio Code.


* xref:payara-micro.adoc[Payara Micro] - The Payara VS Code extension provides first-class support to create and run Payara Micro maven web applications from VS Code. Payara Micro is the microservices-ready version of the Payara Server.
