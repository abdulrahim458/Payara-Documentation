...
:page-description: Payara Server tools in VS Code — configure a Payara Server connection, deploy applications, manage deployments, and use hot deploy from Visual Studio Code.
:ordinal: 1
...
image::vscode-extension/payara-server/start-payara-server.png[Start Payara Server,width=100%]
...
image::vscode-extension/payara-server/deploy-application.png[Deploy application,width=100%]

Alternatively, an application can be deployed from the *Java Projects* interface:

image::vscode-extension/payara-server/java-projects-deploy.png[Deploy application,width=100%]
...
image::vscode-extension/payara-server/list-application.png[Open application homepage,width=100%]
...
image::hot-auto-deploy/vscode-deployment-settings.png[Deployment Settings,width=100%]
image::hot-auto-deploy/vscode-deployment-settings-options.png[Enable Hot Deploy,width=100%]
