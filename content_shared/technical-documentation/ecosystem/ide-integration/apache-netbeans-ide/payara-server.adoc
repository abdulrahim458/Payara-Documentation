...
:page-description: Payara Server tools in Apache NetBeans IDE — configure and manage a Payara Server instance, deploy Jakarta EE applications, and use hot deploy from NetBeans.
:ordinal: 1
...
image::apache-netbeans/payara-server/netbeans-add-server-payara6.png[Add Payara Server,align="center",width=600px]

Select Payara Server, choose a new name for the server and click Next.

image::apache-netbeans/payara-server/netbeans-server-type-payara6.png[Server name, align="center",width=600px]
...
image::apache-netbeans/payara-server/netbeans-select-directory-payara6.png[Select Payara Server Directory,align="center",width=600px]
...
image::apache-netbeans/payara-server/netbeans-configure-instance-payara6.png[Configure Payara Server,align="center",width=600px]
...
image::apache-netbeans/payara-server/netbeans-server-details-payara6.png[Server Details,align="center",width=600px]
...
image::apache-netbeans/payara-server/netbeans-project-server-payara6.png[Project Server,align="center",width=600px]
...
image::hot-auto-deploy/netbeans-autodeploy-1.png[Auto Deploy 1,width=100%]

*Deploy on Save* can be found in the Run submenu of the project properties.

image::hot-auto-deploy/netbeans-autodeploy-2.png[Auto Deploy 2,width=600px]
...
image::hot-auto-deploy/netbeans-hotdeploy.png[Hot Deploy,width=600px]
