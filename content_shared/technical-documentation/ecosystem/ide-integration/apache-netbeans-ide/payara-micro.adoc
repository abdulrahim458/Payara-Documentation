...
+
image::apache-netbeans/payara-micro/netbeans-new-project-payara6.png[New Payara Micro Maven Project,width=600px]
+
. Input the desired project name, project name, artifact id, group id and version.
+
image::apache-netbeans/payara-micro/netbeans-new-application-payara6.png[width=600px]
+
. Select the desired Payara Micro version. Make sure that Auto Bind HTTP is left unchecked.
+
image::apache-netbeans/payara-micro/netbeans-new-application-version-payara6.png[width=600px]
...
image::apache-netbeans/payara-micro/netbeans-app-running-payara6.png[width=100%]
...
image::hot-auto-deploy/netbeans-autodeploy-1-micro.png[Auto Deploy 1,width=100%]

*Deploy on Save* can be found in the Run submenu of the project properties.

image::hot-auto-deploy/netbeans-autodeploy-2-micro.png[Auto Deploy 2,width=100%]
...
image::hot-auto-deploy/netbeans-hotdeploy-micro.png[Hot Deploy Micro,width=100%]
