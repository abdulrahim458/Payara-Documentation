...
:page-description: Payara Server tools in IntelliJ IDEA — configure a Payara Server run configuration, deploy applications, and manage server instances from IntelliJ IDEA.
:ordinal: 1
...
image::intellij-plugin/payara-server/create-configuration.png[Create Configuration,width=100%]

In the *Run/Debug Configurations* dialog, click *+*, expand the *Payara Server* node, and select *Local*:

image::intellij-plugin/payara-server/create-local-server-configuration.png[Create Local Server configuration,width=100%]
...
image::intellij-plugin/payara-server/complete-run-configuration.png[Complete run configuration,width=100%]
...
image::intellij-plugin/payara-server/run-server.png[Start the Payara Server,width=600px]
...
image::intellij-plugin/payara-server/server-log.png[Payara Server log,width=100%]
...
image::intellij-plugin/payara-server/add-artifact.png[Add artifact,width=100%]
