...
:page-description: Payara Micro tools in IntelliJ IDEA — create and run Payara Micro run configurations with hot deploy and MicroProfile project support in IntelliJ IDEA.
:ordinal: 2
...
image::intellij-plugin/payara-micro/create-configuration.png[Create Configuration,width=100%]

In the *Run/Debug Configurations* dialog, click *+*, expand the *Payara Micro* node, and select *Maven* or *Gradle*:

image::intellij-plugin/payara-micro/create-local-micro-configuration.png[Create Micro Configuration,width=600px]
...
image::intellij-plugin/payara-micro/complete-micro-run-configuration.png[Complete Payara Micro Run Configuration,width=600px]
...
image::intellij-plugin/payara-micro/debug-log.png[Payara Micro debug log,width=100%]
...
image::intellij-plugin/payara-micro/debug-breakpoint.png[Payara Micro debug breakpoint hit,width=100%]
