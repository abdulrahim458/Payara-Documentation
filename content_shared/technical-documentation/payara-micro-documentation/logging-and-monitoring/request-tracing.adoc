...
The Request Tracing service works the same on Payara Micro and will trace the same events described in its xref:technical-documentation/application-development/using-request-tracing-in-applications.adoc#request-tracing[documentation].
