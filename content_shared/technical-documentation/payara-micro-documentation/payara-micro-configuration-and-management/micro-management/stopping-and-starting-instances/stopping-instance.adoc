...
:page-description: Stop a Payara Micro instance — gracefully shut down a running Payara Micro instance using command-line signals, API calls, or asadmin commands.
