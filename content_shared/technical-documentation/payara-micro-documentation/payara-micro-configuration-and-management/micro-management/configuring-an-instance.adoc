...
See xref:technical-documentation/payara-micro-documentation/payara-micro-configuration-and-management/micro-management/crac/crac-support.adoc[Payara Micro CRaC Support] for details.
