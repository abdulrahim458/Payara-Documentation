...
:page-description: Disable Phone Home in Payara Micro — turn off the anonymous usage reporting feature in Payara Micro using command-line flags or system properties.
...
* xref:../../../../payara-server-documentation/general-administration/index.adoc#phone-home[Phone Home in Payara Server]
