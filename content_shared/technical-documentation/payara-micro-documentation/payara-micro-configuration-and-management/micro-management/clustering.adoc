= Clustering
:page-description: Clustering Payara Micro instances — configure Hazelcast-based data grid clustering for session replication, distributed caching, and CDI remote events across Micro nodes.
:ordinal: 5
