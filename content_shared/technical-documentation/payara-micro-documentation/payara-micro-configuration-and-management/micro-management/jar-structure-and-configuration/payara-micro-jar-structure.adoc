...
:page-description: Payara Micro JAR structure — understand how the Payara Micro uber-JAR is organized, what it contains, and how to customize it for deployment.
:ordinal: 1
