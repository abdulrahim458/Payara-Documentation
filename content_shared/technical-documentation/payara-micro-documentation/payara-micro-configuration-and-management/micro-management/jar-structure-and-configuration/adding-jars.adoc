...
:page-description: Add third-party JARs to a Payara Micro instance — include additional libraries in the Payara Micro classpath using command-line options or by bundling them in the uber-JAR.
:ordinal: 2
...
This argument cannot be used when instance is started via xref:../stopping-and-starting-instances/starting-instance.adoc[root directory launcher]. 
