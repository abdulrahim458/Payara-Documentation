...
:page-description: Root configuration directory in Payara Micro — configure the Payara Micro root directory for domain.xml, keystores, deployed applications, and pre/post-boot scripts.
:ordinal: 3
