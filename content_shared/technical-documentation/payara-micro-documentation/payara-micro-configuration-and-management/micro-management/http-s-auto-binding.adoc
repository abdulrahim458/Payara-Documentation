...
:page-description: HTTP and HTTPS auto-binding in Payara Micro — configure automatic port selection and bind Payara Micro's HTTP/HTTPS listeners to available ports at startup.
:ordinal: 6
