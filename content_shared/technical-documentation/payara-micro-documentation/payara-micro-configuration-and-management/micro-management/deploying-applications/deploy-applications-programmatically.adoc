...
:page-description: Deploy applications programmatically to Payara Micro — use the PayaraMicro Java API to boot an instance, deploy archives, and manage application lifecycle in code.
:ordinal: 2
