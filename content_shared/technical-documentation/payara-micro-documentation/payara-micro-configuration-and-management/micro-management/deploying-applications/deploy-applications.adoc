...
:page-description: Deploy applications to Payara Micro — deploy WAR archives using the command line, asadmin commands, Maven plugin, or programmatically via the Payara Micro API.
:ordinal: 1
