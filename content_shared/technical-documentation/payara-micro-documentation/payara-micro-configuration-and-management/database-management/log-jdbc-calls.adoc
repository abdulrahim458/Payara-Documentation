...
:page-description: Log JDBC calls in Payara Micro — enable JDBC call logging to capture all SQL statements executed by Jakarta EE applications running on Payara Micro for debugging.
...
* xref:slow-sql-logger.adoc[Slow SQL Logging in Payara Micro]
* xref:sql-trace-listeners.adoc[SQL Trace Listeners in Payara Micro]
* xref:../../../payara-server-documentation/general-administration/administering-database-connectivity.adoc#sql-management-overview[SQL in Payara Server]
