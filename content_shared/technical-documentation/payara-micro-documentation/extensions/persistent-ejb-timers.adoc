...
:page-description: Persistent EJB timers in Payara Micro — configure database-backed persistent EJB timers in Payara Micro for reliable scheduled task execution across restarts.
