...
:page-description: JCA support in Payara Micro — deploy and use Jakarta Connectors (JCA) resource adapters in Payara Micro for connecting to external enterprise systems.
...
* xref:jca-support.adoc[User Guide: Using Payara Micro as a JMS Client]