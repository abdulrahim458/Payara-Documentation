= Payara Micro API
:page-description: Payara Micro API — programmatic API for bootstrapping and configuring Payara Micro instances, deploying applications, and interacting with the embedded server.
...
[cols="2,3,2,2,1,1",options="header",]
|===
...
a|[.breakable]`File getAlternateDomainXML()`
a|[.breakable]`PayaraMicro setAlternateDomainXML(File alternateDomainXML)`
a|`null`
a|`--domainConfig`

|Cluster Multicast Group
|Gets or sets the cluster multicast group for the instance.
a|[.breakable]`String getClusterMulticastGroup()`
a|[.breakable]`PayaraMicro setClusterMulticastGroup(String hzMulticastGroup)`
a|`null` (Default value of 224.2.2.4 set in default domain.xml is not read into instance variable)
a|`--mcAddress`

|Cluster Port
|Gets or sets the multicast cluster port.
a|`int getClusterPort()`
a|[.breakable]`PayaraMicro setClusterPort(int hzPort)`
...
a|[.breakable]`int getClusterStartPort()`
a|[.breakable]`PayaraMicro setClusterStartPort(int hzStartPort)`
...
a|`File getDeploymentDir()`
a|[.breakable]`PayaraMicro setDeploymentDir(File deploymentRoot)`
a|`null`
a|`--deploymentDir`
...
a|`int getHttpPort()`
a|[.breakable]`PayaraMicro setHttpPort(int httpPort)`
|-2147483648 (MIN_VALUE) (Default value of 8080 set in default domain.xml is not read into instance variable)
a|`--port`

|Instance Name
|Gets or sets the name of the instance.
a|`String getInstanceName()`
a|[.breakable]`PayaraMicro setInstanceName(String instanceName)`
|Generated Universally Unique Identifier.
a|`--name`

|Maximum HTTP Threads
|Gets or sets the maximum number of threads in the HTTP thread pool.
a|`int getMaxHttpThreads()`
a|[.breakable]`PayaraMicro setMaxHttpThreads(int maxHttpThreads)`
...
a|`int getMinHttpThreads()`
a|[.breakable]`PayaraMicro setMinHttpThreads(int minHttpThreads)`
|-2147483648 (MIN_VALUE) (Default value of 10 set in default domain.xml is not read into instance variable)
a|`--minHttpThreads`
...
a|`File getRootDir()`
a|[.breakable]`PayaraMicro setRootDir(File rootDir)`
a|`null`
a|`--rootDir`
...
a|`int getSslPort()`
a|[.breakable]`PayaraMicro setSslPort(int sslPort)`
...
a|`boolean isNoCluster()`
a|[.breakable]`PayaraMicro setNoCluster(boolean noCluster)`
|_false_
a|`--noCluster`

|HTTP Auto-Binding
|Enables or Disables auto-binding of the HTTP port for an instance.
a|[.breakable]`boolean getHttpAutoBind()`
a|[.breakable]`PayaraMicro setHttpAutoBind(boolean httpAutoBind)`
|_false_
a|`--autoBindHttp`

|HTTPS Auto-Binding
|Enables or Disables auto-binding of the HTTPS port for an instance.
a|`boolean getSslAutoBind()`
a|[.breakable]`PayaraMicro setSslAutoBind(boolean sslAutoBind)`
|_false_
a|`--autoBindSsl`

|Auto-Bind Range
|Sets the range for HTTP and HTTPS port auto-binding.
a|`int getAutoBindRange()`
a|[.breakable]`PayaraMicro setAutoBindRange(int autoBindRange)`
|5
a|`--autoBindRange`
...
a|[.breakable]`PayaraMicro addDeployment(String pathToWar)`
...
a|[.breakable]`PayaraMicro addDeploymentFile(File file)`
a|Adds the file associated with the `file` parameter to the list of files to be
...
|===
|Method |Description
a|[.breakable]`Map<InstanceDescriptor, Future<ClusterCommandResult>> run (String command, String... args )`
|Runs an asadmin command on all members of a Payara Micro Cluster.
a|[.breakable]`Map<InstanceDescriptor, Future<ClusterCommandResult>> run (Collection<InstanceDescriptor> members, String command, String... args )`
|Runs an asadmin command on specified members of a Payara Micro Cluster.
a|[.breakable]`<T extends Serializable> Map<InstanceDescriptor, Future<T>> run (Callable<T> callable)`
|Runs a Callable object on all members of a Payara Micro Cluster.
a|[.breakable]`<T extends Serializable> Map<InstanceDescriptor, Future<T>> run (Collection<InstanceDescriptor> members, Callable<T> callable)`
...
|===
|Method |Description
a|[.breakable]`Collection<InstanceDescriptor> getClusteredPayaras()`
|Returns a collection of instance descriptors for all the Payara Micros instances
in a cluster.
a|[.breakable]`Collection<String> getDeployedApplicationNames()`
|Returns the names of the deployed applications.
|`String getInstanceName()`
|Returns the instance name.
a|[.breakable]`InstanceDescriptor getLocalDescriptor()`
