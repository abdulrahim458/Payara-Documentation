...
It is possible to execute administration commands programmatically using the xref:technical-documentation/payara-micro-documentation/api/payara-micro-api/index.adoc[Payara Micro API], using the `PayaraMicroRuntime.run` method.
