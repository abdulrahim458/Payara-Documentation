...
= Payara Micro Documentation
:page-description: Azul Payara Micro documentation — configure, deploy, and manage Payara Micro instances: command-line options, clustering, database management, and Maven integration.
