...
The appropriate versions of APIs are provided by xref:../ecosystem/project-management-tools/maven-bom.adoc[Payara BOM artifact] matching the version of the Payara Platform distribution you are using.
