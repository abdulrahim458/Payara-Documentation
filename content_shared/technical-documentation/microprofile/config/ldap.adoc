...
image:microprofile/config/ldap/admin-console-example.png[alt="Payara Server Administration Console configuration route",width=600px]
...
image:microprofile/config/ldap/tesla-user.png[alt="Tesla User properties",width=600px]
...
image:microprofile/config/ldap/test-user.png[alt="Test User properties",width=600px]
