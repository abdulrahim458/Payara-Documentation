= LDAP Config Source
:page-description: LDAP Config Source for MicroProfile Config in Azul Payara — read MicroProfile configuration values from an LDAP directory server for centralized config management.
...
image:microprofile/config/ldap/admin-console-example.png[alt="Payara Server Administration Console configuration route",width=100%]
...
* xref:../../payara-server-documentation/command-reference/set-ldap-config-source-configuration.adoc#set-ldap-config-source-configuration[`set-ldap-config-source-configuration`].

* xref:../../payara-server-documentation/command-reference/get-ldap-config-source-configuration.adoc#get-ldap-config-source-configuration[`get-ldap-config-source-configuration`].
...
image:microprofile/config/ldap/tesla-user.png[alt="Tesla User properties",width=100%]
...
image:microprofile/config/ldap/test-user.png[alt="Test User properties",width=100%]
