= TOML Config Source
:page-description: TOML Config Source for MicroProfile Config in Azul Payara — read application configuration from TOML files as a MicroProfile Config source.
...
image:microprofile/config/toml/admin-console-example.png[alt="Payara Server Administration Console configuration route",width=100%]
...
* xref:../../payara-server-documentation/command-reference/set-toml-config-source-configuration.adoc#set-toml-config-source-configuration[`set-toml-config-source-configuration`]

* xref:../../payara-server-documentation/command-reference/get-toml-config-source-configuration.adoc#get-toml-config-source-configuration[`get-toml-config-source-configuration`]
...
* https://toml.io/en/[TOML Documentation^]
