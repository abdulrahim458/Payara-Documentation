...
+
You can find out more about our supported cloud config sources here: xref:technical-documentation/microprofile/config/cloud/index.adoc[Cloud Config Sources]
...
image:microprofile/config-ordinal.png[alt="Set Config Ordinal",width=600px]
...
image:microprofile/config-property.png[alt="Set Config Property",width=600px]
