...
:page-description: GCP Cloud Config Source for MicroProfile Config in Azul Payara — read configuration values from Google Cloud Platform Secret Manager.
...
image:microprofile/config/cloud/gcp/project-name.png[alt="GCP Project name",width=600px]
...
image:microprofile/config/cloud/gcp/service-accounts.png[alt="GCP Service Accounts",width=600px]

From here you can create a new service account. Skip this step if you already have a service account you want to use.

image:microprofile/config/cloud/gcp/new-service-account.png[alt="GCP new Service Account",width=100%]

After this you'll need to add roles to your service account

image:microprofile/config/cloud/gcp/service-account-roles.png[alt="GCP Service Account roles",width=100%]
...
image:microprofile/config/cloud/gcp/service-account-key.png[alt="GCP Service Account Access Key",width=100%]
...
image:microprofile/config/cloud/gcp/json-key-type.png[alt="JSON Access Key",width=100%]
...
image:microprofile/config/cloud/gcp/admin-console-config.png[alt="Payara Server Administration Console configuration route",width=100%]
...
* xref:../../../payara-server-documentation/command-reference/set-gcp-config-source-configuration.adoc#set-gcp-config-source-configuration[`set-gcp-config-source-configuration`]

* xref:../../../payara-server-documentation/command-reference/get-gcp-config-source-configuration.adoc#get-gcp-config-source-configuration[`get-gcp-config-source-configuration`]
