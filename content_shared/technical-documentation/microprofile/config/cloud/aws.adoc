...
:page-description: AWS Cloud Config Source for MicroProfile Config in Azul Payara — read configuration values from AWS Systems Manager Parameter Store or Secrets Manager.
...
image:microprofile/config/cloud/aws/new-secret.png[alt="AWS Secret Creation",width=100%]
...
image:microprofile/config/cloud/aws/secret-name.png[alt="AWS Secret Name",width=100%]
...
image:microprofile/config/cloud/aws/iam-users.png[alt="AWS IAM users",width=100%]

From here you can create a new IAM user. Skip this step if you already have an IAM user you want to use.

image:microprofile/config/cloud/aws/new-iam-user.png[alt="AWS new IAM user",width=100%]
...
image:microprofile/config/cloud/aws/iam-user-permissions.png[alt="AWS IAM user permissions",width=100%]
...
When you finish creating the IAM user, you'll be given an access key id and secret access key. These will need to be recorded, and passed to Payara Server as xref:../../../payara-server-documentation/security-guide/administering-system-security.adoc#administering-password-aliases[Password Aliases] `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` respectively.
...
image:microprofile/config/cloud/aws/region.png[alt="AWS region selection",width=600px]
...
To configure the `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` password aliases from the admin console, refer to the xref:../../../payara-server-documentation/security-guide/administering-system-security.adoc#administering-password-aliases[Password Aliases Admin Console configuration] guide.

To configure the config source from the admin console, go to `Configs` -> `your-config` -> `MicroProfile` -> `Config` -> `AWS Secrets`.

image:microprofile/config/cloud/aws/admin-console-config.png[alt="Payara Server Administration Console configuration route",width=100%]
...
To configure the `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` password aliases from the command line, refer to the xref:../../../payara-server-documentation/general-administration/subcommands-for-the-asadmin-cli.adoc[Password Aliases Asadmin configuration] guide.

To configure the AWS Secrets Cloud Config Source from the command line, use these commands:

* xref:../../../payara-server-documentation/command-reference/set-aws-config-source-configuration.adoc#set-aws-config-source-configuration[`set-aws-config-source-configuration`]

* xref:../../../payara-server-documentation/command-reference/get-aws-config-source-configuration.adoc#get-aws-config-source-configuration[`get-aws-config-source-configuration`]
