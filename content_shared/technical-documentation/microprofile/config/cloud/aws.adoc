...
image:microprofile/config/cloud/aws/new-secret.png[alt="AWS Secret Creation",width=600px]
...
image:microprofile/config/cloud/aws/secret-name.png[alt="AWS Secret Name",width=600px]
...
image:microprofile/config/cloud/aws/iam-users.png[alt="AWS IAM users",width=600px]

From here you can create a new IAM user. Skip this step if you already have an IAM user you want to use.

image:microprofile/config/cloud/aws/new-iam-user.png[alt="AWS new IAM user",width=600px]
...
image:microprofile/config/cloud/aws/iam-user-permissions.png[alt="AWS IAM user permissions",width=600px]
...
image:microprofile/config/cloud/aws/admin-console-config.png[alt="Payara Server Administration Console configuration route",width=600px]
...
To configure the `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` password aliases from the command line, refer to the xref:technical-documentation/payara-server-documentation/general-administration/subcommands-for-the-asadmin-cli.adoc[Password Aliases Asadmin configuration] guide.
