...
:page-description: DynamoDB Config Source for MicroProfile Config in Azul Payara — read application configuration from an Amazon DynamoDB table as a MicroProfile Config source.
...
image:microprofile/config/cloud/dynamodb/admin-console-config.png[alt="Payara Server Administration Console configuration route",width=600px]
...
To configure the `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` password aliases from the command line, refer to the xref:../../../payara-server-documentation/security-guide/administering-system-security.adoc#administering-password-aliases[Password Aliases Asadmin configuration] guide.

To configure the DynamoDB config source from the command line, use these commands:

* xref:../../../payara-server-documentation/command-reference/set-dynamodb-config-source-configuration.adoc#set-dynamodb-config-source-configuration[`set-dynamodb-config-source-configuration`].

* xref:../../../payara-server-documentation/command-reference/get-dynamodb-config-source-configuration.adoc#get-dynamodb-config-source-configuration[`get-dynamodb-config-source-configuration`].
...
image:microprofile/config/cloud/dynamodb/database-example.png[alt="Database Example",width=600px]
