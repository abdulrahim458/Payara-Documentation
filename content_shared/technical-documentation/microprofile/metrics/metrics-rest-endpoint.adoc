= REST Endpoint
:page-description: MicroProfile Metrics REST endpoint in Azul Payara — access application, base, and vendor metrics in JSON or OpenMetrics format from the /metrics endpoint.
