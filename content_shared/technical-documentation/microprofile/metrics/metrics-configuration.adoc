...
:page-description: MicroProfile Metrics configuration in Azul Payara — enable, configure, and expose application and server metrics via the MicroProfile Metrics REST endpoint.
...
image:microprofile/metrics.png[alt="Set Metrics Configuration",width=100%]
...
* xref:../../payara-server-documentation/command-reference/set-metrics-configuration.adoc#set-metrics-configuration[`set-metrics-configuration`]
* xref:../../payara-server-documentation/command-reference/get-metrics-configuration.adoc#get-metrics-configuration[`get-metrics-configuration`]
