...
Payara Platform {version} provides MicroProfile Telemetry  {mpTelemetryVersion}.
...
As of version {version} and in line with MicroProfile spec, support is only provided for Tracing aspects for the API.
