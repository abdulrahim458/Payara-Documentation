...
:page-description: Eclipse MicroProfile in Azul Payara — supported MicroProfile specifications including Config, Fault Tolerance, Health, JWT, Metrics, OpenAPI, OpenTelemetry, and REST Client.
...
This is supported by Azul Payara Community starting from releases *7.2025.1* onwards
