...
:page-description: MicroProfile Fault Tolerance in Azul Payara — implement Retry, Timeout, CircuitBreaker, Bulkhead, and Fallback patterns in Jakarta EE microservices.

Azul Payara {release-id} provides MicroProfile Fault Tolerance {mpFaultToleranceVersion}
...
In addition to the functionality https://github.com/eclipse/microprofile-fault-tolerance/blob/master/spec/src/main/asciidoc/microprofile-fault-tolerance-spec.asciidoc[detailed in the specification document^], Azul Payara has implemented additional features like:
...
image:microprofile/fault-tolerance.png[alt="Set Fault Tolerance Configuration",width=100%]
...
* xref:../payara-server-documentation/command-reference/set-fault-tolerance-configuration.adoc#set-fault-tolerance-configuration[`set-fault-tolerance-configuration`]

* xref:../payara-server-documentation/command-reference/get-fault-tolerance-configuration.adoc#get-fault-tolerance-configuration[`get-fault-tolerance-configuration`]
