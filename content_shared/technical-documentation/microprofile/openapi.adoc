...
The OpenAPI document generation process can be configured through the xref:technical-documentation/microprofile/config/index.adoc[Config API]. The following are the standard configuration properties as presented by the specification:
...
image:microprofile/openapi.png[alt="Set OpenAPI Configuration",width=600px]
