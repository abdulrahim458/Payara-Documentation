= OAuth2 Support
:page-description: OAuth2 support in Azul Payara — configure OAuth2 authentication and authorization using the Payara Public API and Jakarta Security HttpAuthenticationMechanism.
...
a| Must be in the form `"key=value"`.
...
* xref:../payara-server-documentation/security-guide/administering-system-security.adoc#administering-password-aliases[Password Aliases]
* xref:../payara-server-documentation/general-administration/configuration-variables-reference.adoc[Environment Variables / System Properties]
* xref:../microprofile/config/index.adoc[Config API]

[#see-also]
== See Also

* https://oauth.net/2/[OAuth v2 Official site^]
