...
:page-description: Azul Payara internal dependencies — bundled third-party libraries, version numbers, and licenses included in the Payara Server and Payara Micro distributions.
:ordinal: 3
