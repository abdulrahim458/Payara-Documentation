...
== Payara Server 6.6.0 Jakarta EE 10 Platform Certification Summary
...
+
https://docs.payara.fish/enterprise/docs/6.6.0/Jakarta%20EE%20Certification/6.6.0/6.6.0%20Platform%20TCK%20Results.html[6.6.0 Platform TCK Results]
