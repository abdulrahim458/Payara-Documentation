...
== Payara Server (Web Profile) 6.9.0 Jakarta EE 10 Web Profile Certification Summary
...
+
https://docs.payara.fish/enterprise/docs/6.9.0/Jakarta%20EE%20Certification/6.9.0/6.9.0%20Web%20TCK%20Results.html[6.9.0 Web TCK Results^]
