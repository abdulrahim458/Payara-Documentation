...
== Payara Server (Web Profile) 6.33.0 Jakarta EE 10 Web Profile Certification Summary
...
+
https://docs.payara.fish/enterprise/docs/6.33.0/Jakarta%20EE%20Certification/6.33.0/6.33.0%20Web%20TCK%20Results.html[6.33.0 Web TCK Results]
