...
== Payara Server 6.37.0 Jakarta EE 10 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.37.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.37.0/Jakarta%20EE%20Certification/6.37.0/6.37.0%20Platform%20TCK%20Results.html[6.37.0 Platform TCK Results]
...
```
Test results: passed: 24,624; failed: 0
```
