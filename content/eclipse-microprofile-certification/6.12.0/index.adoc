...
The following distributions of Payara 6.12.0 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.12.0/Server TCK Results.adoc[Payara Server 6.12.0]
* xref:eclipse-microprofile-certification/6.12.0/Server Web TCK Results.adoc[Payara Server 6.12.0 - Web profile]
