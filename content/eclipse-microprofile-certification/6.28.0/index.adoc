...
The following distributions of Payara 6.28.0 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.28.0/server-tck-results.adoc[Payara Server 6.28.0]
* xref:eclipse-microprofile-certification/6.28.0/server-web-tck-results.adoc[Payara Server 6.28.0 - Web Profile]
