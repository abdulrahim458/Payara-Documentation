...
image:payara-micro/enable-hazelcast-on-das.png[alt="Enable Hazelcast",width=600px]
...
image:payara-micro/micro-instances-on-das.png[alt="Micro Instances on DAS",width=600px]
...
image:payara-micro/sending-asadmin-command-from-the-das-to-micro.png[alt="Send commands from DAS",width=600px]
