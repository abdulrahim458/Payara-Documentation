...
+
image:deployment-groups/deployment-group-new.png[alt="Create New Deployment Group",width=600px]
+
...
+
image:deployment-groups/delete-deployment-group.png[alt="Delete a Deployment Group",width=600px]
...
+
image:deployment-groups/add-server-to-dg.png[alt="Add a Server to a Deployment Group",width=600px]
...
+
image:deployment-groups/remove-server-from-dg.png[alt="Remove a Server from a Deployment Group",width=600px]
...
image:deployment-groups/deploy-to-dg.png[alt="Deploy to a deployment group",width=600px]
