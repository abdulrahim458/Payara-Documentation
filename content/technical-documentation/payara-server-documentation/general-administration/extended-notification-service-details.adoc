...
IMPORTANT: Custom Notifiers are deprecated and are no longer supported in Payara 7 onwards.
...
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/email-notifier-core/2.0-enterprise/email-notifier-core-2.0-enterprise.jar[Email Notifier Core 2.0-enterprise^]
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/email-notifier-console-plugin/2.0-enterprise/email-notifier-console-plugin-2.0-enterprise.jar[Email Notifier Console Plugin 2.0-enterprise^]
...
* `JavaMail JNDI Name`: Sets the name of the Java Naming and Directory Interface (JNDI) of the configured `JavaMail` session. The parameter name is `--jndiName` in the asadmin command.
* `Target Address`: Sets the email address which will receive the email notifications. Currently only one address can be specified. The parameter name is `--recipient` in the asadmin command.

image:docs::notification-service/email/email-admin-console-configuration.png[alt=Email Notifier on Admin Console,width=600px]
...
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/snmp-notifier-core/2.0-enterprise/snmp-notifier-core-2.0-enterprise.jar[SNMP Notifier Core 2.0-enterprise^]
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/snmp-notifier-console-plugin/2.0-enterprise/snmp-notifier-console-plugin-2.0-enterprise.jar[SNMP Notifier Console Plugin 2.0-enterprise^]
* https://nexus.payara.fish/repository/payara-artifacts/fish/payara/server/core/packager/snmp4j-repackaged/3.7.5/snmp4j-repackaged-3.7.5.jar[Dependency: SNMP4J 3.7.5^]
...
* *SNMP Agent*: A specialized software that gathers data on the overall status of the managed component and exposes specific instructions over interfaces for its management. In our case, the SNMP Notifier acts as an SNMP agent.
* *SNMP Manager*: A server machine that runs a network management system, which is configured to monitor and manage all devices and services in a network by _"talking"_ to the agents and gathering all relevant information.
...
image:docs::notification-service/snmp/snmp-admin-console-configuration.png[alt="Notification Service in Admin Console",width=600px]
...
image:docs::notification-service/snmp/trap-ringer-pro-output.png[alt="SNMP Traps onTRinger",width=600px]
...
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/xmpp-notifier-core/2.0-enterprise/xmpp-notifier-core-2.0-enterprise.jar[XMPP Notifier Core 2.0-enterprise^]
* https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/xmpp-notifier-console-plugin/2.0-enterprise/xmpp-notifier-console-plugin-2.0-enterprise.jar[XMPP Notifier Console Plugin 2.0-enterprise^]

And these are the required dependencies for the core module to work correctly:

* https://repo1.maven.org/maven2/org/igniterealtime/smack/smack-core/4.3.4/smack-core-4.3.4.jar[Dependency: smack-core 4.3.4^]
* https://repo.maven.apache.org/maven2/org/igniterealtime/smack/smack-java7/4.3.4/smack-java7-4.3.4.jar[Dependency: smack-java7 4.3.4^]
* https://repo.maven.apache.org/maven2/org/igniterealtime/smack/smack-tcp/4.3.4/smack-tcp-4.3.4.jar[Dependency: smack-tcp 4.3.4^]
* https://repo.maven.apache.org/maven2/org/igniterealtime/smack/smack-extensions/4.3.4/smack-extensions-4.3.4.jar[Dependency: smack-extensions 4.3.4^]
* https://repo.maven.apache.org/maven2/org/igniterealtime/smack/smack-im/4.3.4/smack-im-4.3.4.jar[Dependency: smack-im 4.1.9^]
* https://repo1.maven.org/maven2/org/apache/servicemix/bundles/org.apache.servicemix.bundles.xpp3/1.1.4c_7/org.apache.servicemix.bundles.xpp3-1.1.4c_7.jar[Dependency: XPP3 1.1.4c_7^]
* https://search.maven.org/remotecontent?filepath=org/jxmpp/jxmpp-jid/0.6.4/jxmpp-jid-0.6.4.jar[Dependency: jxmpp-jid 0.6.4^]
* https://search.maven.org/remotecontent?filepath=org/jxmpp/jxmpp-core/0.6.4/jxmpp-core-0.6.4.jar[Dependency: jxmpp-core 0.6.4^]
* https://search.maven.org/remotecontent?filepath=org/jxmpp/jxmpp-util-cache/0.6.4/jxmpp-util-cache-0.6.4.jar[Dependency: jxmpp-util-cache 0.6.4^]
* https://search.maven.org/remotecontent?filepath=org/minidns/minidns-core/0.3.4/minidns-core-0.3.4.jar[Dependency: minidns-core 0.3.4^]
...
+
image:docs::notification-service/xmpp/openfire-install-1.png[alt="OpenFire Language Select Screen",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-install-2.png[alt="OpenFire Server Settings Screen",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-install-3.png[alt="OpenFire Database Select Screen",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-install-4.png[alt="OpenFire Profile Screen",width=600px]

. Finally, configure the credentials for the *admin* user:
+
image:docs::notification-service/xmpp/openfire-install-5.png[alt="OpenFire Admin User Screen",width=600px]

. With the server installation complete, login to the admin console with the credentials of the administrator user:
+
image:docs::notification-service/xmpp/openfire-login.png[alt="OpenFire Login",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-users-1.png[alt="OpenFire User Summary",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-users-2.png[alt="OpenFire New User",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-create-room-1.png[alt="OpenFire Room Summary",width=600px]

. Now, click on the *Create New Room* option in the sidebar. Be sure to input the room's *ID*, *Name* and *Description* as requested:
+
image:docs::notification-service/xmpp/openfire-create-room-2.png[alt="OpenFire New Room",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-room-details.png[alt="OpenFire Room Details",width=600px]
...
+
image:docs::notification-service/xmpp/openfire-room-permissions.png[alt="OpenFire Room Permissions",width=600px]
...
image:docs::notification-service/xmpp/xmpp-admin-console-configuration.png[alt="XMPP Notifier in Admin Console",width=600px]
...
image:docs::notification-service/xmpp/spark-chat.png[alt="Spark Chat Room",width=600px]
...
+
image:docs::notification-service/newrelic/agent-setup-1.png[alt="New Relic agent setup welcome screen",width=600px]

. Select the *Java* option and the agent installation procedure will be shown:
+
image:docs::notification-service/newrelic/agent-setup-2.png[alt="New Relic Java agent setup procedure",width=600px]
+
...
+
image:docs::notification-service/newrelic/apm-dashboard.png[alt="New Relic APM Dashboard",width=600px]
+
You can also access the latest monitoring statistics:
+
image:docs::notification-service/newrelic/apm-application-details.png[alt="New Relic Application Details",width=600px]
...
image:docs::notification-service/newrelic/insights-dashboard.png[alt="New Relic Insights Dashboard",width=600px]

Access the _Manage Data_ option on the side menu, you will be presented the following screen:

image:docs::notification-service/newrelic/insights-api-keys-screen.png[alt="New Relic Insights API Keys",width=600px]
...
image:docs::notification-service/newrelic/insights-insert-api-key.png[alt="New Relic Insights Insert API Keys",width=600px]
...
image:docs::notification-service/newrelic/new-relic-admin-console-configuration.png[alt="New Relic Configuration on Admin Console",width=600px]
...
image:docs::notification-service/newrelic/insights-data-explorer-results.png[alt="New Relic Insights Data Explorer",width=600px]
...
+
image:docs::notification-service/datadog/side-menu.png[alt="Datadog Admin Panel Side Menu",width=600px]

. On the API Keys tab you will observe the default API Key available for integration:
+
image:docs::notification-service/datadog/apikey-panel.png[alt="Datadog API Key Panel",width=600px]
+
...
+
image:docs::notification-service/datadog/apikey-name-dialog.png[alt="Datadog API Key Name",width=600px]
...
image:docs::notification-service/datadog/datadog-admin-console-configuration.png[alt="Datadog Configuration on Admin Console",width=600px]
...
image:docs::notification-service/datadog/event-sample.png[alt="Datadog Events Sample",width=600px]
...
image:docs::notification-service/teams/teams-admin-console-configuration.png[alt="Notification Service in Admin Console",width=600px]
...
+
image:docs::notification-service/slack/application-portal.png[alt="Slack Application Portal",width=600px]

. Now, proceed to select the channel that the WebHook will use to direct the notification events to:
+
image:docs::notification-service/slack/channel-selection.png[alt="Incoming WebHook Channel Selection",width=600px]
+
...
+
image:docs::notification-service/slack/webhook-url.png[alt="WebHook URL Sample",width=600px]
+
...
+
image:docs::notification-service/slack/webhook-additional-settings.png[alt="WebHook Additional Settings",width=600px]
...
image:docs::notification-service/slack/slack-admin-console-configuration.png[alt="Slack Configuration on Admin Console",width=600px]
...
image:docs::notification-service/slack/notifications-sample.png[alt="Slack Notifications Sample",width=600px]
...
image:docs::notification-service/discord/discord-admin-console-configuration.png[alt="Notification Service in Admin Console",width=600px]
