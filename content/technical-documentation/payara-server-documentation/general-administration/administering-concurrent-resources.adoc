...
image:concurrency/new_context_service.png[alt="New Context Service",width=600px]
...
image:concurrency/new_managed_thread_factory.png[alt="New Managed Thread Factory",width=600px]
...
image:concurrency/new_managed_executor_service.png[alt="New Managed Executor Service",width=600px]
...
image:concurrency/new_managed_scheduled_executor_service.png[alt="New Managed Exector Service",width=600px]
