...
image:logging/write_to_system_log.jpg[Write to System Log enabled]
...
image:logging/system_log_host.jpg[System Log Host]
...
image:logging/system_log_facility.png[System Log Facility]
