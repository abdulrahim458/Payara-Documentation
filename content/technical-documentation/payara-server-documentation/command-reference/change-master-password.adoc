...
[--savemasterpassword={false|true}] [--masterpasswordlocation filepath]
...
*`--masterpasswordlocation`*:
  This is the absolute filepath that the master password will be written to. This parameter is only active when
  `--savemasterpassword` is active. +
  If this parameter is unused, then the master password will be saved to the default location.
