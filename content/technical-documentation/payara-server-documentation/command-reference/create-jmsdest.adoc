...
To modify the value of these properties, you can use the  `as-install/mq/bin/imqcmd` command. See the *Physical Destination Property Reference* in the Open Message Queue Administration Guide for more information.
*`--target`*:
