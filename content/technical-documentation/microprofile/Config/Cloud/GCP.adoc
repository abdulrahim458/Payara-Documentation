...
image:microprofile/config/cloud/gcp/new-service-account.png[alt="GCP new Service Account",width=600px]

After this you'll need to add roles to your service account

image:microprofile/config/cloud/gcp/service-account-roles.png[alt="GCP Service Account roles",width=600px]
...
image:microprofile/config/cloud/gcp/service-account-key.png[alt="GCP Service Account Access Key",width=600px]
...
image:microprofile/config/cloud/gcp/json-key-type.png[alt="JSON Access Key",width=600px]
...
image:microprofile/config/cloud/gcp/admin-console-config.png[alt="Payara Server Administration Console configuration route",width=600px]
