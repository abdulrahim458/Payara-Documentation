...
This is supported by Payara Platform Community/Enterprise starting from releases *6.2023.11*/*6.8.0* onwards respectively
...
This is supported by the Payara Platform Community starting from release *6.2023.3*
