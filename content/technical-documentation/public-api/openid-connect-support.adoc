...
The client secret can be input directly, or for added security it can be aliased using xref:technical-documentation/microprofile/config/overview.adoc[Microprofile Config]
