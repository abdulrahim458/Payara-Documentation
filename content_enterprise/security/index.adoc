= Overview
:page-description: Azul Payara security advisories — CVE fixes, security patches, and vulnerability disclosures for Payara Server and Payara Micro enterprise distributions.
...
Once a security vulnerability is fixed and published in an official release of Azul Payara, the following will occur:
