...
== Payara Server 6.6.0 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.6.0 (Web Profile)^]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.6.0/Jakarta%20EE%20Certification/6.6.0/6.6.0%20(Web%20Profile)%20Core%20TCK%20Results.html[6.6.0 Core TCK Results^]
