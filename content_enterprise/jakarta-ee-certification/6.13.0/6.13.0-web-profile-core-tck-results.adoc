...
== Payara Server 6.13.0 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
+
https://docs.payara.fish/enterprise/docs/6.13.0/Jakarta%20EE%20Certification/6.13.0/6.13.0%20(Web%20Profile)%20Core%20TCK%20Results.html[6.13.0 Core TCK Results^]
