= Web TCK Results
:page-description: Jakarta EE 11 Web Profile TCK results for Azul Payara 7.1.0 — official certification test results confirming Jakarta EE Web Profile compliance.
...
== Payara Server 7.1.0 (Web Profile) Jakarta EE 11 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-enterprise-edition[Payara Server 7.1.0 (Web Profile)^]
...
+
https://docs.azul.com/payara/version/7/jakarta-ee-certification/7.1.0/7.1.0-web-profile-web-tck-results[7.1.0 Web TCK Results^]
