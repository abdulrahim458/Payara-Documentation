...
== Payara Server (Web Profile) 6.0.0 Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.0.0 (Web Profile)^]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.0.0/Jakarta%20EE%20Certification/6.0.0/6.0.0%20Web%20TCK%20Results.html[6.0.0 Web TCK Results^]
