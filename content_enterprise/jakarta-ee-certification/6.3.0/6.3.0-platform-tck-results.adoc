...
== Payara Server 6.3.0 Jakarta EE 10 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.3.0^]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.3.0/Jakarta%20EE%20Certification/6.3.0/6.3.0%20Platform%20TCK%20Results.html[6.3.0 Platform TCK Results^]
...
```
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.09 sec
```
...
```
   ...
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 815
