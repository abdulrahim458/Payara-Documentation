...
:page-description: Jakarta EE 11 Platform TCK results for Azul Payara 7.0.0 — official certification test results confirming full Jakarta EE Platform compliance.
...
== Payara Server 7.0.0 Jakarta EE 11 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-enterprise-edition[Payara Server 7.0.0^]
...
+
https://docs.azul.com/payara/jakarta-ee-certification/7.0.0/7.0.0-platform-tck-results[7.0.0 Platform TCK Results^]
