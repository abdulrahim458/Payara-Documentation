...
**Payara Server 6.37.0 Web Profile Certification Summary**
...
+
https://docs.payara.fish/enterprise/docs/6.37.0/Eclipse%20MicroProfile%20Certification/6.37.0/Server%20Web%20TCK%20Results.html
