...
**Payara Server 6.33.0 Full Profile Certification Summary**
...
+
https://docs.payara.fish/enterprise/docs/6.33.0/Eclipse%20MicroProfile%20Certification/6.33.0/Server%20TCK%20Results.html
