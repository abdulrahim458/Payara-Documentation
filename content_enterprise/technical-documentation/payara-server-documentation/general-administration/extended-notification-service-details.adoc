...
----
  ...
  common: &default_settings
    ...
    # ...
    app_name: Payara Server {version}
...
* Backed up start script to /opt/{version}/glassfish/domains/domain1/config/domain.xml.20170613_180108
* Added agent switch to start script /opt/{version}/glassfish/domains/domain1/config/domain.xml

* No need to create New Relic configuration file because:
 A config file already exists: /opt/{version}/glassfish/domains/domain1/newrelic/newrelic.yml
...
[source, log, subs=attributes+]
----
INFO: New Relic Agent: Loading configuration file "/opt/{version}/glassfish/domains/domain1/newrelic/newrelic.yml"
INFO: New Relic Agent: Writing to log file: /opt/{version}/glassfish/domains/domain1/newrelic/logs/newrelic_agent.log
----
