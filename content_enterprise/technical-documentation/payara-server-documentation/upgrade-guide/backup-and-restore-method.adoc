...
:page-description: Upgrade Payara Server using the backup and restore method — safely migrate server domains by backing up configuration, installing the new version, and restoring.
:ordinal: 2
