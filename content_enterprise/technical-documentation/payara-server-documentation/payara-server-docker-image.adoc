...
[source,text]
----
docker run -p 8080:8080 nexus.payara.fish:5000/payara/server-full:{version}
----
...
[source, shell, subs=attributes+]
----
docker run -p 4848:4848 -p 8080:8080 nexus.payara.fish:5000/payara/server-full:{version}
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v ~/payara/apps:/opt/payara/deployments nexus.payara.fish:5000/payara/server-full:{version}
----
...
----
FROM nexus.payara.fish:5000/payara/server-full:{version}
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v /local/path/with/boot/file:/config -e POSTBOOT_COMMANDS=/config/post-boot-commands.asadmin nexus.payara.fish:5000/payara/server-full:{version}
----
...
docker run -p 8080:8080 nexus.payara.fish:5000/payara/server-full:{version} > payara-logs.txt 2>&1
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -it nexus.payara.fish:5000/payara/server-full:{version} bash
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -p 4848:4848 --read-only --rm -v /opt/payara -v /tmp nexus.payara.fish:5000/payara/server-full:{version}
----
