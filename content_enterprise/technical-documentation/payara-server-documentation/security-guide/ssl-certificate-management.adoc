...
**Alternatively**:
You can find the detailed steps of adding a self-signed certificate into Payara Server for testing purposes using `keytool` and `openssl` https://blog.payara.fish/securing-payara-server-with-custom-ssl-certificate[here^].
