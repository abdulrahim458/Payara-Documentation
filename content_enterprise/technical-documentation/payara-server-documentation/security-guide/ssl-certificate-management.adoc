...
:page-description: SSL certificate management in Azul Payara Server — generate self-signed certificates, add CA certificates, configure keystores and truststores using asadmin commands.
:ordinal: 9
...
You can generate a self-signed certificate using the xref:../command-reference/generate-self-signed-certificate.adoc[`generate-self-signed-certificate`] command:
...
**Alternatively**:
You can find the detailed steps of adding a self-signed certificate into Payara Server for testing purposes using `keytool` and `openssl` https://www.azul.com/blog/securing-payara-server-with-custom-ssl-certificate/[here^].
...
You can use the xref:../command-reference/add-to-keystore.adoc[`add-to-keystore`] command:
...
image:certificate-management/CertificateManagementAddButton.png[alt="Certificate Management Add Button",width=100%]

You can then enter the alias name and the path to the certificate bundle:

image:certificate-management/CertificateManagementAddKeystoreEntry.png[alt="Add Keystore Entry",width=100%]
...
You can use the xref:../command-reference/add-to-truststore.adoc[`add-to-truststore`] command:
...
image:certificate-management/CertificateManagementAddButton2.png[alt="Certificate Management Add Button",width=100%]

And then specifying the `mycert.crt` file.

image:certificate-management/CertificateManagementAddTruststoreEntry.png[alt="Add Truststore Entry",width=100%]
...
image:docs::ssl/add-additional-keystores-admin-console.png[alt="Configure Additional keystores and truststores in Admin Console",width=600px]
...
* xref:../command-reference/remove-expired-certificates.adoc#remove-expired-certificates[`remove-expired-certificates`],
* xref:../command-reference/remove-from-keystore.adoc#remove-from-keystore[`remove-from-keystore`], and
* xref:../command-reference/remove-from-truststore.adoc#remove-from-truststore[`remove-from-truststore`] respectively.
...
image:certificate-management/CertificateManagementDeleteButton.png[alt="Certificate Management Delete Button",width=100%]
