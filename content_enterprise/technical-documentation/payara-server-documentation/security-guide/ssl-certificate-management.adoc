...
image:certificate-management/CertificateManagementAddButton.png[alt="Certificate Management Add Button",width=600px]

You can then enter the alias name and the path to the certificate bundle:

image:certificate-management/CertificateManagementAddKeystoreEntry.png[alt="Add Keystore Entry",width=600px]
...
image:certificate-management/CertificateManagementAddButton2.png[alt="Certificate Management Add Button",width=600px]

And then specifying the `mycert.crt` file.

image:certificate-management/CertificateManagementAddTruststoreEntry.png[alt="Add Truststore Entry",width=600px]
...
image:certificate-management/CertificateManagementDeleteButton.png[alt="Certificate Management Delete Button",width=600px]
