...
lack link:https://docs.azul.com/crac/usage/integrating-crac#implementing-crac[CRaC implementation^].
...
See xref:../../../payara-micro-docker-image.adoc#custom-crac-image[Payara Micro Docker Image] for details.