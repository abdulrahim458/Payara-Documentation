...
[source,text]
----
docker run -p 8080:8080 nexus.payara.fish:5000/payara/micro:{version}
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version}
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version} --deploy /opt/payara/deployments/myapplication.war
----
...
----
FROM nexus.payara.fish:5000/payara/micro:{version}
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 nexus.payara.fish:5000/payara/micro:{version} --deployFromGAV "fish.payara.examples:my-application:1.0-SNAPSHOT" --additionalRepository https://172.17.0.10/content/repositories/snapshots
----
...
[source,text]
----
docker run -p 8080:8080 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version} --deploymentDir /opt/payara/deployments --contextroot myRoot
----
...
docker run -p 8080:8080 \
 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version} --deploy /opt/payara/deployments/myapplication.war --contextroot ROOT
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version} --noHazelcast
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version} --noCluster
----
...
[source, shell, subs=attributes+]
----
docker run -p 8080:8080 --read-only --rm -v /opt/payara -v /tmp -v ~/payara-micro/applications:/opt/payara/deployments nexus.payara.fish:5000/payara/micro:{version}
----