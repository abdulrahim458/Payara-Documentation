= Security Connectors
:page-description: Security Connectors for Azul Payara — pre-built Jakarta Security authentication mechanisms including OAuth2, OpenID Connect, and enterprise identity provider integrations.
