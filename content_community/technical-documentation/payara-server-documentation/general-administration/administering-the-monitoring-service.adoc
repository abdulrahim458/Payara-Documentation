...
a|`cachehits`
|RangeStatistic
a|The number of times a user request found
...
a|`numpassivations`
|CountStatistic
a|Number of passivated beans. Applies
...
a|`counttimeouts`
|CountStatistic
a|Number of keep-alive connections that
timed out.
...
a|`counttotalqueued`
|CountStatistic
a|Total number of connections that have been queued
