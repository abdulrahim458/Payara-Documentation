...
:page-description: Administer the Monitoring Service in Azul Payara Community Server — configure JMX monitoring, MBean statistics, and monitoring levels for server components and applications.
:ordinal: 8
