...
:page-description: Install gRPC Server Support for Azul Payara Community Server — steps to add and activate the gRPC server module in a Payara Community Server domain.
