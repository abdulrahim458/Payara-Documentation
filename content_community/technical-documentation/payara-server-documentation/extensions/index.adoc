= Server Extensions
:page-description: Azul Payara Community Server extensions — add-on modules including gRPC support and extended notification service available in Payara Community.
