...
:page-description: SSL certificate management in Azul Payara Community Server — generate self-signed certificates, add CA certificates, and configure keystores using asadmin commands.
:ordinal: 9
...
You can find detailed steps of adding a self-signed certificate https://www.azul.com/blog/securing-payara-server-with-custom-ssl-certificate/[here^].
