...
:page-description: Upgrade Payara Community Server using the backup and restore method — migrate domains by backing up configuration, installing the new release, and restoring.
:ordinal: 1
...
Backed up domain1 at Wed Nov 12 13:48:54 GMT 2025.

Description               : domain1 backup created on 2025_11_12 by user james
GlassFish Version         : Payara Server 7.2025.1
Backup User               : james
Backup Date               : Wed Nov 12 13:48:54 GMT 2025
Domain Name               : domain1
Backup Type               : full
Backup Config Name        :
Backup Filename (origin)  : /home/james/payarabackup/domain1/domain1_2025_11_12_v00001.zip
Domain Directory          : /home/james/7.2025.1/payara7/glassfish/domains/domain1

Command backup-domain executed successfully.
----

Read more about the
xref:../command-reference/backup-domain.adoc[Backup Domain Command]
...
[source, text]
----
asadmin> restore-domain --filename /home/james/payarabackup/domain1/domain1_2025_11_12_v00001.zip --long domain1

Restored the domain (domain1) to /home/james/7.2025.1/payara7/glassfish/domains/domain1
...
Read more about the
xref:../command-reference/restore-domain.adoc[Restore Domain Command]
...
For example:
`payara7/glassfish/nodes/localhost-example/myInstance`
...
Read more about the
xref:../command-reference/start-local-instance.adoc[Start Local Instance Command]
