= Security Connectors
:page-description: Security Connectors for Azul Payara Community — pre-built Jakarta Security authentication mechanisms including OAuth2, OpenID Connect, and enterprise identity provider integrations.
...
== xref:../../public-api/openid-connect-support.adoc[OpenId Connect Client]
...
== xref:../../public-api/oauth-support.adoc[OAuth 2.0 Client:]
