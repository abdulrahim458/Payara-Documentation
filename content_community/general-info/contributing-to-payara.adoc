...
:page-description: Contributing to Azul Payara — how to report issues, submit pull requests, write documentation, and participate in the Payara open-source community.
:ordinal: 4
...
image:forkingpayarafromgit.png[alt="Forking GitHub repository",width=100%]
...
Bug reports should always contain a simple to follow scenario how to reproduce the bug on the latest release of Payara Community. A reproducer should follow the SSCCE rules: http://www.sscce.org/
