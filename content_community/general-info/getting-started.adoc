= Getting Started
:page-description: Get started with Azul Payara Community — download, install, and run your first Jakarta EE application on Payara Server or Payara Micro with the community distribution.
:ordinal: 1
...
Payara Server can be downloaded from http://www.payara.fish/downloads[the Azul Payara official website^]. Download the ZIP bundle to a directory of your choosing and then unzip. On Linux based systems you can use the following command:

[source, shell, subs=attributes+]
----
unzip payara-{release-id}.zip
----

By default, this will unzip the archive into `{CURRENT_DIR}/payara7`.
