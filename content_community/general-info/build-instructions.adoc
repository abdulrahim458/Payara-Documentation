= Build Instructions
:page-description: Build instructions for Azul Payara Community — clone the source repository, set up the build environment, and compile Payara Server and Payara Micro from source.
:ordinal: 3
...
* JDK 21 Update 5 or later.
* Maven 3.3.9 or above
* Git
* A `JAVA_HOME` environment variable pointing to the JDK install location (e.g. _/home/user/jdk21.0.5_)
