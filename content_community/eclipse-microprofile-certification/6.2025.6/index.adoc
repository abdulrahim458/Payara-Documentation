...
The following distributions of Payara 6.2025.6 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.2025.6/server-tck-results.adoc[Payara Server 6.2025.6]
* xref:eclipse-microprofile-certification/6.2025.6/server-web-tck-results.adoc[Payara Server 6.2025.6 - Web Profile]
