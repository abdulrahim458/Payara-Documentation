...
The following distributions of Payara 6.2024.1 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.2024.1/server-tck-results.adoc[Payara Server 6.2024.1]
* xref:eclipse-microprofile-certification/6.2024.1/server-web-tck-results.adoc[Payara Server 6.2024.1 - Web profile]
