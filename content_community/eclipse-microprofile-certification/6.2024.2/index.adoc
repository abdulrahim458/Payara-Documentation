...
The following distributions of Payara 6.2024.2 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.2024.2/server-tck-results.adoc[Payara Server 6.2024.2]
* xref:eclipse-microprofile-certification/6.2024.2/server-web-tck-results.adoc[Payara Server 6.2024.2 - Web profile]
