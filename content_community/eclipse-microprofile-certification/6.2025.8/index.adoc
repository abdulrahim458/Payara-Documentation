...
The following distributions of Payara 6.2025.8 are certified, with results for each listed below:

* xref:eclipse-microprofile-certification/6.2025.8/server-tck-results.adoc[Payara Server 6.2025.8]
* xref:eclipse-microprofile-certification/6.2025.8/server-web-tck-results.adoc[Payara Server 6.2025.8 - Web Profile]
