...
**Payara Server 6.2023.12 Full Profile Certification Summary**
...
+
https://docs.payara.fish/community/docs/6.2023.12/Eclipse%20MicroProfile%20Certification/6.2023.12/Server%20TCK%20Results.html
