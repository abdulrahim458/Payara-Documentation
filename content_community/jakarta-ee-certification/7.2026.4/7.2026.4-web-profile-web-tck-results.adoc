= Web TCK Results
:page-description: Jakarta EE Web Profile TCK results for Azul Payara Community 7.2026.4 — official certification test results confirming Jakarta EE Web Profile compliance.

As required by the https://www.eclipse.org/legal/tck.php[Eclipse Foundation Technology Compatibility Kit License^], following is a summary of the TCK results for Payara Server releases for Jakarta EE Web Profile 11.

[#payara-server-web-results]
== Payara Server 7.2026.4 (Web Profile) Jakarta EE 11 Web Profile Certification Summary

- Product Name, Version and download URL (if applicable):
+
[cols="1,2",grid=none,frame=none]
|===
|image:JakartaEE_Logo_compatible-color.png[alt="JakartaEE_Logo_compatible-color",width=100%]
|
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 7.2026.4 (Web Profile)^]
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.4/7.2026.4-web-profile-web-tck-results[7.2026.4 Web TCK Results^]
...
SHA-256:  `6ab2e52127de2beabb396879d9d57a8e34bfd23114369b8960d87dd9afec296b`
