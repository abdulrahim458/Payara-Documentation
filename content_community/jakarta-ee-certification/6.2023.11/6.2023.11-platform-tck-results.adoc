...
== Payara Server 6.2023.11 Jakarta EE 10 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2023.11^]
|===
...
+
https://docs.payara.fish/community/docs/6.2023.11/Jakarta%20EE%20Certification/6.2023.11/6.2023.11%20Platform%20TCK%20Results.html[6.2023.11 Platform TCK Results^]
...
```
   ...
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 1657
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 136
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
...
```
   ...
   [runcts] OUT => [javatest.batch] Aug 7, 2023, 5:49:23 PM Finished executing all tests, wait for cleanup...Number of Tests Passed      = 178
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
