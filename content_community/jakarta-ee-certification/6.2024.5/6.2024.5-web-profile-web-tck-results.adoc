...
== Payara Server 6.2024.5 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2024.5 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/6.2024.5/Jakarta%20EE%20Certification/6.2024.5/6.2024.5%20Web%20TCK%20Results.html[6.2024.5 Web TCK Results^]
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.96 sec
```
