...
== Payara Server (Web Profile) 6.2023.2 Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2023.2 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/6.2023.2/Jakarta%20EE%20Certification/6.2023.2/6.2023.2%20Web%20TCK%20Results.html[6.2023.2 Web TCK Results^]
