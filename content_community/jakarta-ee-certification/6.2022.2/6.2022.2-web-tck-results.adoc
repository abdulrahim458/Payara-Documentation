...
== Payara Server (Web Profile) 6.2022.2 Jakarta EE 10 Web Profile Certification Summary
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/6.2022.2/6.2022.2%20Web%20TCK%20Results.html[6.2022.2 Web TCK Results^]
