= Web TCK Results
:page-description: Jakarta EE Web Profile TCK results for Azul Payara Community 7.2026.5 — official certification test results confirming Jakarta EE Web Profile compliance.
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 7.2026.5 (Web Profile)^]
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.5/7.2026.5-web-profile-web-tck-results[7.2026.5 Web TCK Results^]
