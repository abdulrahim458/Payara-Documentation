...
:page-description: Jakarta EE Platform TCK results for Azul Payara Community 7.2026.5 — official certification test results confirming full Jakarta EE Platform compliance.
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 7.2026.5^]
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.5/7.2026.5-platform-tck-results[7.2026.5 Platform TCK Results^]
