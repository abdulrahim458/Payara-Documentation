...
:page-description: Jakarta EE Platform TCK results for Azul Payara Community 7.2026.7 — official certification test results confirming full Jakarta EE Platform compliance.
...
== Payara Server 7.2026.7 Jakarta EE 11 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 7.2026.7^]
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.7/7.2026.7-platform-tck-results[7.2026.7 Platform TCK Results^]
