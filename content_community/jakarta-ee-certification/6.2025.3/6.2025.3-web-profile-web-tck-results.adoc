...
== Payara Server 6.2025.3 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
+
https://docs.payara.fish/community/docs/6.2025.3/Jakarta%20EE%20Certification/6.2025.3/6.2025.3%20Web%20TCK%20Results.html[6.2025.3 Web TCK Results^]
