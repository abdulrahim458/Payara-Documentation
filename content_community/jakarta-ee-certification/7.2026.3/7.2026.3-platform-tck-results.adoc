...
:page-description: Jakarta EE Platform TCK results for Azul Payara Community 7.2026.3 — official certification test results confirming full Jakarta EE Platform compliance.
...
== Payara Server 7.2026.3 Jakarta EE 11 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 7.2026.3^]
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.3/7.2026.3-platform-tck-results[7.2026.3 Platform TCK Results^]
