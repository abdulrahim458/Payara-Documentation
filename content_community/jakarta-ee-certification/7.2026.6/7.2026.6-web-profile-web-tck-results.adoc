= Web TCK Results
:page-description: Jakarta EE Web Profile TCK results for Azul Payara Community 7.2026.6 — official certification test results confirming Jakarta EE Web Profile compliance.
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2026.6/7.2026.6-web-profile-web-tck-results[7.2026.6 Web TCK Results^]
