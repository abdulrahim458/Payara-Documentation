...
== Payara Server 6.2023.1 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
+
https://docs.payara.fish/community/docs/6.2023.1/Jakarta%20EE%20Certification/6.2023.1/6.2023.1%20(Web%20Profile)%20Core%20TCK%20Results.html[6.2023.1 Core TCK Results^]
