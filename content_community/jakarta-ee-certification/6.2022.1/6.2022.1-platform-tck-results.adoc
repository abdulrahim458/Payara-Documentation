...
== Payara Server 6.2022.1 Jakarta EE 10 Platform Certification Summary
...
|===
|image:JakartaEE_Logo_compatible-color.png[alt="JakartaEE_Logo_compatible-color",width=600px]
|
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2022.1^]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/6.2022.1/6.2022.1%20Platform%20TCK%20Results.html[6.2022.1 Platform TCK Results^]
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.131 sec
```
...
```
   [runcts] OUT => [javatest.batch] Completed running 412 tests.
...
```
   [runcts] OUT => [javatest.batch] Completed running 312 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 312
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
...
```
   [runcts] OUT => [javatest.batch] Completed running 91 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 91
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
...
```
   [runcts] OUT => [javatest.batch] Completed running 350 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 350
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
...
```
   [runcts] OUT => [javatest.batch] Completed running 390 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 390
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
...
```
   [runcts] OUT => [javatest.batch] Completed running 801 tests.
...
### ejb32/relaxedclientview

```
   [runcts] OUT => [javatest.batch] Completed running 21 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 21
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
