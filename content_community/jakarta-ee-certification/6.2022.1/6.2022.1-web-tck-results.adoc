...
== Payara Server (Web Profile) 6.2022.1 Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2022.1 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/6.2022.1/6.2022.1%20Web%20TCK%20Results.html[6.2022.1 Web TCK Results^]
