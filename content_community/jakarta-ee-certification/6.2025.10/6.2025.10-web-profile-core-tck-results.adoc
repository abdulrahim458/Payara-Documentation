...
== Payara Server 6.2025.10 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2025.10 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/6.2025.10/Jakarta%20EE%20Certification/6.2025.10/6.2025.10%20(Web%20Profile)%20Core%20TCK%20Results.html[6.2025.10 Core TCK Results^]
