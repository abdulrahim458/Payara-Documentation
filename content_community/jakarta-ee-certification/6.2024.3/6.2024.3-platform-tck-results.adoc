...
== Payara Server 6.2024.3 Jakarta EE 10 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2024.3^]
|===
...
+
https://docs.payara.fish/community/docs/6.2024.3/Jakarta%20EE%20Certification/6.2024.3/6.2024.3%20Platform%20TCK%20Results.html[6.2024.3 Platform TCK Results^]
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.088 sec
```
