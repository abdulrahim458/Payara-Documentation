...
:page-description: Jakarta EE Platform TCK results for Azul Payara Community 7.2025.2 — official certification test results confirming full Jakarta EE Platform compliance.
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2025.2/7.2025.2-platform-tck-results[7.2025.1 Platform TCK Results^]
