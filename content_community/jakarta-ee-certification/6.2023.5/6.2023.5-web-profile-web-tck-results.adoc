...
== Payara Server 6.2023.5 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2023.5 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/6.2023.5/Jakarta%20EE%20Certification/6.2023.5/6.2023.5%20Web%20TCK%20Results.html[6.2023.5 Web TCK Results^]
