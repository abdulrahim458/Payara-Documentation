...
== Payara Server 6.2023.5 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
+
https://docs.payara.fish/community/docs/6.2023.5/Jakarta%20EE%20Certification/6.2023.5/6.2023.5%20(Web%20Profile)%20Core%20TCK%20Results.html[6.2023.5 Core TCK Results^]
