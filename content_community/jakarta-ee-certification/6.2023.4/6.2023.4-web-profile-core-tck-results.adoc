...
== Payara Server 6.2023.4 (Web Profile) Jakarta EE 10 Core Profile Certification Summary
...
+
https://docs.payara.fish/community/docs/6.2023.4/Jakarta%20EE%20Certification/6.2023.4/6.2023.4%20(Web%20Profile)%20Core%20TCK%20Results.html[6.2023.4 Core TCK Results^]
