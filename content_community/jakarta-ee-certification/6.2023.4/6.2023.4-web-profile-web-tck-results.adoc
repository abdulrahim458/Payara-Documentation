...
== Payara Server 6.2023.4 (Web Profile) Jakarta EE 10 Web Profile Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 6.2023.4 (Web Profile)^]
|===
...
+
https://docs.payara.fish/community/docs/6.2023.4/Jakarta%20EE%20Certification/6.2023.4/6.2023.4%20Web%20TCK%20Results.html[6.2023.4 Web TCK Results^]
