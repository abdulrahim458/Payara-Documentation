= Core TCK Results
:page-description: Jakarta EE Core TCK results for Azul Payara Community 7.2024.1.Alpha3 — official certification test results for the Jakarta EE Core Profile.
...
+
https://docs.azul.com/payara-community/jakarta-ee-certification/7.2024.1.alpha3/7.2024.1.alpha3-core-tck-results[7.2024.1.Alpha3 Core TCK Results^]
