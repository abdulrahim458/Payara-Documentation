...
This is the documentation for Azul Payara Community, consisting of Azul Payara Server Community and Azul Payara Micro Community. Azul Payara Community is targeted for developers looking to play with the latest features and APIs during development before potentially moving to Payara Enterprise in production.
